#!/usr/bin/env python3
"""Synchronize reusable root methodology into the installed CAPRMADIO copy.

Usage:
    python scripts/sync_caprmadio.py [ROOT]
    python scripts/sync_caprmadio.py [ROOT] --apply
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--apply",
        action="store_true",
        help="copy root methodology into .caprmadio and verify zero drift",
    )
    return parser
