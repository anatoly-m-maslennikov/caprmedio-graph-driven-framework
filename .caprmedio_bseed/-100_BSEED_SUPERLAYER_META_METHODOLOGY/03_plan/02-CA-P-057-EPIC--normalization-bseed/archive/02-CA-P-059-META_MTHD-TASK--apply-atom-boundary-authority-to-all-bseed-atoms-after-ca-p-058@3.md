...
subjects:
  ...
  - atom-boundary
version: 3
updated_at: 2026-08-23 12:34:00
autonomous_confidence_threshold: 98
---
# Apply Atom-boundary authority to all BSEED Atoms after CA-P-058

WHEN CA-P-058 is Done, THE Agent MUST make every Atom in Task Scope comply with the current one-Atom, one-Claim, and one-Claim-Scope authority.
