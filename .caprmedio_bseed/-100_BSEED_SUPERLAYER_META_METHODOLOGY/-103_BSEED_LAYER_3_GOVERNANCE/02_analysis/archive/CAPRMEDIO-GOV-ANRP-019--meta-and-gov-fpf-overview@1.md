...
relations:
  - type: replacement_of
    targets:
      - "CAPRMEDIO-META-ANRP-015--meta-completion-and-fpf-review"
  - type: analysis_of
    targets:
      ...
      - "CAPRMEDIO-GOV-METH-011--artifact-classes-compilation-and-provenance"
...
authority and evaluation roles are separated, and its maintained views remain
