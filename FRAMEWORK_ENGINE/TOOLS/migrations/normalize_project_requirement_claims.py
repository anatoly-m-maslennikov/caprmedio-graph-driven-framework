...
Usage:
    python3 FRAMEWORK_ENGINE/TOOLS/migrations/normalize_project_requirement_claims.py
    python3 FRAMEWORK_ENGINE/TOOLS/migrations/normalize_project_requirement_claims.py --apply
