...
Usage:
    python3 FRAMEWORK_ENGINE/TOOLS/migrations/consolidate_spec_behavior_cores.py
    python3 FRAMEWORK_ENGINE/TOOLS/migrations/consolidate_spec_behavior_cores.py --apply
