...
Usage:
    python3 FRAMEWORK_ENGINE/TOOLS/migrations/split_layer_scope_contract_atoms.py
    python3 FRAMEWORK_ENGINE/TOOLS/migrations/split_layer_scope_contract_atoms.py --apply
