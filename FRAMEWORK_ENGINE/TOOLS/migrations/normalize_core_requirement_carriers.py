...
Usage:
    python3 FRAMEWORK_ENGINE/TOOLS/migrations/normalize_core_requirement_carriers.py
    python3 FRAMEWORK_ENGINE/TOOLS/migrations/normalize_core_requirement_carriers.py --apply
