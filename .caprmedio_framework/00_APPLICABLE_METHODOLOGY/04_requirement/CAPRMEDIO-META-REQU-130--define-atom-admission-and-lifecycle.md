...
projection:
  source_carrier_path: ../000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/CAPRMEDIO-META-REQU-130--define-atom-admission-and-lifecycle.md
---
...
Admission, acceptance, commitment, activation, completion, and archival remain distinct transitions. Admission alone does not assign identity. Operator acceptance of a role-classified draft assigns its Atom ID by definition; the other transitions do not imply one another unless a governed rule explicitly requires the combination. Archival preserves any assigned Atom ID, Revisions, relations, provenance, and historical dependents without preserving current authority.
