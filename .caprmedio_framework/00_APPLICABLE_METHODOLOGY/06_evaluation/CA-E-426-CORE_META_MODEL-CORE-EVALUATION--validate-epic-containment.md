...
subjects:
  ...
  depends_on:
    continuant:
      ...
      - Artifact/Carrier Placement/Status Subdirectory
version: 5
...
relations:
  evaluation_for:
    ...
    - CA-D-352
projection:
  source_carrier_path: ../000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/06_evaluation/CA-E-426-CORE_META_MODEL-CORE-EVALUATION--validate-epic-containment.md
---
