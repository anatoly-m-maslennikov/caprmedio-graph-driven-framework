...
relations:
  replacement_of:
    - CAPRMEDIO-GOV-EVAL-012--typed-artifact-relations-evaluation-case
  check_of:
    - CAPRMEDIO-GOV-METH-006--canonical-artifact-relations
  child_of:
    - CA-R-1054
projection:
  source_carrier_path: ../000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/06_evaluation/CAPRMEDIO-GOV-EVAL-001--relation-vocabulary-interpretability.md
---
# Relation-vocabulary interpretability
