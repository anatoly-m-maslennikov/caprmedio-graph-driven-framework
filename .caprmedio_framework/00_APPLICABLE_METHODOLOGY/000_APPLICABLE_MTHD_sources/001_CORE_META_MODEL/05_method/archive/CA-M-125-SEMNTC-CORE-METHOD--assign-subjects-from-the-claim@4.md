...
4. Keep at most one declared continuant Subject and at most one declared occurrent Subject in the Atom.
5. Split the Atom before assignment when its Claim contains more than one independently replaceable declared Subject with the same Claim Participant Temporal Form.
6. Use the exact canonical reference for an identified governed entity and a lowercase kebab-case term for any other Subject.
7. Declare each distinct Subject exactly once under its matching Claim Role and Claim Participant Temporal Form.
