...
relations:
  - type: replacement_of
    targets:
      - CAPRMEDIO-GOV-METH-015--semantic-artifact-types-and-open-conflicts
---
...
- **Replaces claims:** the standalone Conflict-Type claim and the classification
  of Risk as a Problem in `CAPRMEDIO-GOV-METH-013--immutable-atoms-and-role-aware-conflict-handling`; its immutability, priority,
...
existing. QA changes evaluation, not authority. Supportability is a cross-cutting
