...
cce_form: evaluation
subjects:
  governs: "Entities Graph/validation"
  depends_on:
    - "Entities Graph"
    - "Entity"
    - "Dependent Entity"
...
- a displayed node **or** edge lacks its exact governing source Claim **or** lacks its Artifact Revision; derived inverse navigation lacks traceability **to** the original source Relation.
