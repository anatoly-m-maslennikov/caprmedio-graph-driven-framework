...
An operator unfamiliar with the repository can configure reporting mode, artifact strictness, **and** one enabled artifact Type using **only** the Project Configuration Artifact **and** its in-file documentation, while recognizing the Project Scope Unit Graph as a read-only derived view.
