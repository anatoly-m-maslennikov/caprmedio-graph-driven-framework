...
---
# Register layer-of structural relation kind

GOV registers `layer_of` as the structural ownership relation stored by a layer-like child and directed to its immediate structural owner.
