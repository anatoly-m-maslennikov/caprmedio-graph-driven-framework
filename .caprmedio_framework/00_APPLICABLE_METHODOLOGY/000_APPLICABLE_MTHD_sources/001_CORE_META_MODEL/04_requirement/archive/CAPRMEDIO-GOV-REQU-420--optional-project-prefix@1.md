...
`caprmedio_settings.toml` records:
...
Each DSET project explicitly enables or disables a project prefix in caprmedio_settings.toml, and dset-init selects that setting while recommending no prefix for a single small project and a prefix where multiple project identities share a repository or artifact namespace.
