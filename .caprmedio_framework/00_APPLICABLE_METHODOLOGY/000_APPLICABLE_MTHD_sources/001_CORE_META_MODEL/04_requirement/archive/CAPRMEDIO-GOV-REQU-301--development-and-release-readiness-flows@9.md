...
The Project Configuration Artifact records `development` as the default workflow selection **and** `release_readiness` as the mandatory pre-release mode. Project Scope Unit Graph Projections **may** expose the effective mode but cannot select it.
