...
relations:
  - type: relates_to
    targets:
      ...
      - CAPRMEDIO-META-REQU-083--profile-applicability-boundary
---

# Requirement — Activate governance surfaces progressively

A CAPRMEDIO project begins with atomic authority. Requirements are sufficient for
...
overview is mandatory merely because CAPRMEDIO is initialized. The operator may
...
CAPRMEDIO starts atomic-first without requiring evergreen or maintained governance surfaces, and named optional surfaces may be activated or deactivated later without changing atomic authority.
