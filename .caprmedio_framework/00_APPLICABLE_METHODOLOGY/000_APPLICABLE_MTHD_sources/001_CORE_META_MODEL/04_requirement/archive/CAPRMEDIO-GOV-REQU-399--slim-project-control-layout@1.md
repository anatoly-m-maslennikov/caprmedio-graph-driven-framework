...
- `dset/caprmedio_settings.toml` — the only writable settings and project-manifest
  carrier;
...
A current DSET project uses one documented dset/caprmedio_settings.toml for settings and manifest facts, dset/project for project-wide truth and records, dset/versions for Version lifecycle artifacts, and direct dset/<layer> roots for layer-owned truth.
