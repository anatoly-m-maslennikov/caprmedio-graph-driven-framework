...
subjects:
  governs:
    continuant:
      - Atom/Carrier/Current Scope Unit/Filename Token
  depends_on:
    continuant:
      - Atom/Scope
      - Scope Unit
...
relations: {}
projection:
  source_carrier_path: ../000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/07_delivery/CA-D-291-CORE_META_MODEL-CORE-DELIVERY--serialize-the-current-scope-unit-in-atom-filenames.md
---
