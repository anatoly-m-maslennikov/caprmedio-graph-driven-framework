...
- Correlation and incident IDs; deployed version, PR, and CAPRMADIO-change identity; structured logs, traces, metrics/events, diagnostics, and runbooks where applicable.
