...
| Deterministic supportability proof | Pass: `CARMADIO-TEST-CASE-META-002`, `CARMADIO-TEST-CASE-OPS-002..006`, and `CARMADIO-TEST-CASE-GOV-005` results remain recorded in [deterministic-checks-2026-07-14.md](deterministic-checks-2026-07-14.md) |
| Independent supportability evals | Pass: two reviewers independently passed `CARMADIO-EVALUATION-CASE-OPS-001..004` and `CARMADIO-EVALUATION-CASE-META-001` after the synthetic-fixture correction; see [supportability-evals-2026-07-14.md](supportability-evals-2026-07-14.md) |
