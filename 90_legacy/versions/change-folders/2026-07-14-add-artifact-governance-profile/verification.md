...
- **Accepted-truth reconciliation: Pass** — METH-REQUIREMENT-020–025, METH-TEST-CASE-021–026, METH-EVALUATION-CASE-011–014, domain entities/invariants, contracts, package IDs, and methodology cross-links are current.
...
| Root and area navigation | CAPRMADIO-E123 unit cases plus live registry validation | Pass at `c8e1e71` | [Deterministic verification](proofs/deterministic-verification-2026-07-14.md) |
...
| Applicable evals | `CAPRMADIO-EVALUATION-CASE-GOV-007..008`, `CAPRMADIO-EVALUATION-CASE-META-002..003` | Pass at corrected pushed head `174c10b` | [Qualitative evaluations](proofs/qualitative-evals-2026-07-14.md) |
