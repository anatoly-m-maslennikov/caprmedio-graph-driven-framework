...
3. The first post-move aggregate correctly rejected six now-invalid relative links with `CAPRMADIO-E113`. The links were adjusted for the additional `archive/` path level.
