...
class CarrierTransitionTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.atom = self._write(
            "dset/scopes/gov/CAPRMADIO-ATOMIC-RECORD-999-carrier.md",
            "---\n"
            "artifact_type: atomic_record\n"
            "artifact_id: CAPRMADIO-ATOMIC-RECORD-999\n"
            "type: decision\n"
            "semantic_id: CAPRMADIO-DECISION-GOV-999\n"
            "status: accepted\n"
            "priority: high\n"
    ...
    def test_apply_preserves_semantics_git_return_and_is_a_noop(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                "schema_version": "1.0",
                "items": [{"id": "CAPRMADIO-ITEM-001", "decision": None}],
            },
        )
        ...
        diagnostics = validation._validate_retention_identities(
            ...
            [],
            current_path=retained["current_path"],
            transition_id="CAPRMADIO-CARRIER-TRANSITION-0000000000000000",
        )
    ...
    def test_registered_target_follows_relocation_chain(self) -> None:
        ...
        ledger["transitions"].append(
            {
                "id": "CAPRMADIO-CARRIER-TRANSITION-RELOCATION",
