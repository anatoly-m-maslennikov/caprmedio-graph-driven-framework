...
Usage:
    python3 02_TOOLS/migrations/normalize_project_requirement_claims.py
    python3 02_TOOLS/migrations/normalize_project_requirement_claims.py --apply
...
REQUIREMENTS = Path(".caprmadio/04_requirement")
...
CHANGES = (
    ...
    Change(
        "CAPRMADIO-REQUIREMENT-182-*",
        1,
        "2026-08-17 17:24:09",
        "Every CAPRMADIO governance operation reads or changes the typed graph of governed authority, realization bindings, and their direct relations.",
        "Every CAPRMADIO governance operation must read or change the typed graph of governed authority, realization bindings, and their direct relations.",
    ),
    Change(
        "CAPRMADIO-REQUIREMENT-183-*",
        2,
        "2026-08-17 16:39:43",
        "CAPRMADIO adds or enables a Content role, applicability tier, structural level, scope, automation, or other mechanism only when it is necessary to preserve a material governed distinction or required outcome; otherwise the simpler model remains active.",
        "CAPRMADIO may add or enable a Content role, applicability tier, structural level, scope, automation, or other mechanism only when it is necessary to preserve a material governed distinction or required outcome.",
    ),
    Change(
        "CAPRMADIO-REQUIREMENT-185-*",
        2,
        "2026-08-17 16:41:30",
        "The minimum CAPRMADIO project model is project-scope Requirement authority plus its real Implementation; it requires no Implementation Atom and enables other Atom roles, applicability tiers, structural levels, descendant scopes, or automation only when necessary, including in the framework's self-hosting repository.",
        "CAPRMADIO must use project-scope Requirement authority plus its real Implementation as the minimum project model, must not require an Implementation Atom, and may enable other Atom roles, applicability tiers, structural levels, descendant scopes, or automation only when necessary.",
    ),
    Change(
        "CAPRMADIO-REQUIREMENT-186-*",
        None,
        None,
        "CAPRMADIO records all and only the direct typed relations necessary to trace each governed authority to its real Implementation and material dependents; inverse, transitive, and aggregate relations are derived.",
        "CAPRMADIO must record all and only the direct typed relations necessary to trace each governed authority to its real Implementation and material dependents; inverse, transitive, and aggregate relations must be derived.",
    ),
    Change(
        "CAPRMADIO-REQUIREMENT-187-*",
        2,
        "2026-08-17 16:30:52",
    ...
    Change(
        "CAPRMADIO-REQUIREMENT-188-*",
        2,
        "2026-08-17 15:56:56",
        "CAPRMADIO admits independently evolvable Extensions that add or specialize governed capabilities through explicit extension points without copying or silently redefining canonical authority.",
        "CAPRMADIO must admit independently evolvable Extensions only through explicit extension points that add or specialize governed capabilities without copying or silently redefining canonical authority.",
    ),
    Change(
        "CAPRMADIO-REQUIREMENT-189-*",
        2,
        "2026-08-17 15:56:56",
        "CAPRMADIO lets project-owned configuration select, combine, parameterize, or disable available optional canonical and Extension capabilities without changing their governed meanings.",
        "CAPRMADIO must permit project-owned configuration to select, combine, parameterize, or disable available optional canonical and Extension capabilities without changing their governed meanings.",
    ),
    Change(
        "CAPRMADIO-REQUIREMENT-190-*",
        2,
        "2026-08-17 15:54:46",
        "CAPRMADIO supplies an LLM only the guidance necessary to meet the operator-defined adequacy threshold under the currently observed model, host, task, and risk conditions.",
        "CAPRMADIO must supply an LLM only the guidance necessary to meet the operator-defined adequacy threshold under the currently observed model, host, task, and risk conditions.",
    ),
    Change(
        "CAPRMADIO-REQUIREMENT-198-*",
        None,
        None,
        "CAPRMADIO authority and semantics do not depend on a particular operating system, operator language, programming language, LLM provider or model, or agent host.",
        "CAPRMADIO must keep its authority and semantics independent of any particular operating system, operator language, programming language, LLM provider or model, or agent host.",
    ),
    Change(
        "CAPRMADIO-REQUIREMENT-204-*",
        None,
        None,
        "CAPRMADIO preserves its canonical semantic model across disciplines while Profiles and Extensions adapt terminology, artifact subtypes, Methods, Assurance, and Implementation to a particular discipline.",
        "CAPRMADIO must preserve its canonical semantic model across disciplines while Profiles and Extensions adapt terminology, artifact subtypes, Methods, Assurance, and Implementation to a particular discipline.",
    ),
    Change(
        "CAPRMADIO-REQUIREMENT-206-*",
        2,
        "2026-08-17 16:30:52",
        "CAPRMADIO supports either repository-level scope or declared repository-relative Work Areas containing code, services, libraries, documentation, methodology, data, or mixed content without requiring a particular architecture or deployability model.",
        "CAPRMADIO must support repository-level scope and declared repository-relative Work Areas containing code, services, libraries, documentation, methodology, data, or mixed content without requiring a particular architecture or deployability model.",
    ),
    Change(
        "CAPRMADIO-REQUIREMENT-208-*",
        2,
        "2026-08-17 16:30:52",
    ...
    Change(
        "CAPRMADIO-REQUIREMENT-238-*",
        1,
        "2026-08-17 19:11:46",
        "An imprecise fallback relation is permitted only within a scope whose effective `authority_mode` is `casual`.",
        "CAPRMADIO may permit an imprecise fallback relation only within a scope whose effective `authority_mode` is `casual`.",
    ),
)
