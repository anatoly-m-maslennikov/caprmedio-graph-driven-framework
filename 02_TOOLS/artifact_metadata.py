#!/usr/bin/env python3
"""Update CAPRMADIO Atom or Projection revision metadata.
...
`.caprmadio/caprmadio_settings.toml`, fails closed on malformed or duplicate
...
SETTINGS_PATH = Path(".caprmadio/caprmadio_settings.toml")
