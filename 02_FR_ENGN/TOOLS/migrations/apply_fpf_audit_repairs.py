...
def apply(*, updated_at: str | None = None, session_id: str | None = None) -> None:
    ...
    subprocess.run(
        [
            sys.executable,
            str(ROOT / "02_FRAMEWORK_ENGINE/TOOLS/framework_settings_revision.py"),
            "--apply",
            "--session-id",
            session,
            str(ROOT),
    ...
    subprocess.run(
        [
            sys.executable,
            str(ROOT / "02_FRAMEWORK_ENGINE/TOOLS/generate_project_settings.py"),
            "--apply",
            "--session-id",
            session,
            str(ROOT),
