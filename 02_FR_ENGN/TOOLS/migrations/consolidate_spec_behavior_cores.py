...
Usage:
    python3 02_FRAMEWORK_ENGINE/TOOLS/migrations/consolidate_spec_behavior_cores.py
    python3 02_FRAMEWORK_ENGINE/TOOLS/migrations/consolidate_spec_behavior_cores.py --apply
