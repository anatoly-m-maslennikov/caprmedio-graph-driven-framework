...
Usage:
    python3 02_FRAMEWORK_ENGINE/TOOLS/migrations/normalize_core_requirement_carriers.py
    python3 02_FRAMEWORK_ENGINE/TOOLS/migrations/normalize_core_requirement_carriers.py --apply
