...
Usage:
    python3 02_FRAMEWORK_ENGINE/TOOLS/migrations/split_layer_scope_contract_atoms.py
    python3 02_FRAMEWORK_ENGINE/TOOLS/migrations/split_layer_scope_contract_atoms.py --apply
