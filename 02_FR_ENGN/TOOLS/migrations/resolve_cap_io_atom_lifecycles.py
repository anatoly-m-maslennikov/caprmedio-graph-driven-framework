...
Usage:
    python3 02_FRAMEWORK_ENGINE/TOOLS/migrations/resolve_cap_io_atom_lifecycles.py
    python3 02_FRAMEWORK_ENGINE/TOOLS/migrations/resolve_cap_io_atom_lifecycles.py --apply
...
NORMALIZER = Path("02_FRAMEWORK_ENGINE/TOOLS/migrations/normalize_core_requirement_carriers.py")
TOUCHED_EXISTING = (
...
def normalize_touched(root: Path, paths: list[Path]) -> None:
    module = runpy.run_path(str(root / NORMALIZER), run_name="carrier_normalizer")
    for path in paths:
