---
name: ca-configure
description: Inspect, recommend, activate, or deactivate optional CARMADIO governance surfaces. Use when an operator wants to start atomic-first, add a specification, plan, overview, or architecture surface later, or remove its currentness obligations without deleting history.
---
