---
name: ca-landscape
description: Build or refresh a CARMADIO Solution Landscape for consequential choices among libraries, frameworks, architectures, languages, protocols, or implementation approaches. Use when comparable eligible evidence is missing or stale; stop before selecting an option or implementing it.
---
