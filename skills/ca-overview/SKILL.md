---
name: ca-overview
description: Summarize the current CAPRMADIO project or Work Area from its generated health view. Use when an operator wants artifact counts, authority-to-proof and implementation coverage, freshness, open obligations, or a read-only helicopter view before choosing the next workflow.
---
