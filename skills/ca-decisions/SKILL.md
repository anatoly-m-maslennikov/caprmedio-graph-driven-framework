---
name: ca-decisions
description: Reconcile available operator/session intent and repository evidence into missing accepted atomic CAPRMADIO records. Use when a desired outcome may rely on directives not yet captured; expose unclear acceptance and stop before semantic compilation or implementation.
---
