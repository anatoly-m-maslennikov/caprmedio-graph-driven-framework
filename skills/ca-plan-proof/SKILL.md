---
name: ca-plan-proof
description: Create or refresh separate CARMADIO deterministic test and qualitative evaluation cases for accepted behavior. Use when requirements, contracts, decisions, scenarios, or implementation changes lack complete proof obligations; stop before implementation or proof execution.
---
