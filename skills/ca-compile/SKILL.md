---
name: ca-compile
description: Semantically reconcile accepted atomic CARMADIO artifacts into affected evergreen specifications and plans under the target repository's local governance. Use when the operator requests compilation, pending atoms must become current project truth, or implementation, verification, or release entry criteria require current evergreen artifacts; do not run merely because one new atom exists.
---
