---
name: ca-triage
description: Classify and route durable CARMADIO Questions, including Conflicts and Opportunities, and Problems without defining type from workflow. Use when an artifact is unclassified, lacks priority/owner/Change linkage, or needs the next governed route; stop before diagnosis, decision, or implementation.
---
