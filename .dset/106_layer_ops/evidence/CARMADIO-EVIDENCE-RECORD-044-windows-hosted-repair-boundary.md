...
artifact_id = "CARMADIO-EVIDENCE-RECORD-044"
priority = "high"
...
evidence_location = "dset/scopes/skill/changes/make-dset-self-hosting-and-skills-thin/proofs/CARMADIO-EVIDENCE-RECORD-044-windows-hosted-repair-boundary.md"
...
[[relations]]
type = "evidence_for"
target = "CARMADIO-TEST-CASE-OPS-021"
+++
...
`CARMADIO-PROBLEM-OPS-001` remains open. It may be resolved only after a published
