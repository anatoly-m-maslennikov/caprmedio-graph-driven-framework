...
artifact_id: DSET-REQUIREMENT-META-076
...
Every DSET-governed project must use Git as its canonical engine for the
...
DSET must not maintain a second lifecycle ledger as a competing history
...
Git is the canonical history engine for persisted DSET-governed repository
state.
