...
artifact_id: CARMADIO-REQUIREMENT-META-003
...
CARMADIO selects recovery semantics by runtime risk and durable authority by topology, write volume, and concurrency rather than imposing one durability mechanism on every project.
