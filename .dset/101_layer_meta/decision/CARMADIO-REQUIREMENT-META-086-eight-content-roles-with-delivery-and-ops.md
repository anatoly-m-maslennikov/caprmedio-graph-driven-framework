...
artifact_id: CARMADIO-REQUIREMENT-META-086
...
CARMADIO classifies the primary semantic contribution of every governed artifact through exactly eight `content_role` values:
...
CARMADIO uses Concern, Analysis, Requirement, Method, Assurance, Delivery, Implementation, and Ops as its eight Content roles, with Delivery governing the path to end users and Ops governing enacted operation and factual results.
