...
artifact_id: DSET-REQUIREMENT-META-080
...
DSET classifies every governed artifact as exactly one Atom, Journal, or Projection according to what the artifact is, independently of its creation mechanism and semantic role.
