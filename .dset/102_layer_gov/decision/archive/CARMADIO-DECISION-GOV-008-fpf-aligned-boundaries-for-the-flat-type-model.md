...
artifact_id: CARMADIO-DECISION-GOV-008
...
`CARMADIO-PROBLEM-GOV-007` and `CARMADIO-TASK-GOV-049` remain open. Their schema and
runtime migration must now enforce both the flat model and these recognition
boundaries without editing legacy atoms. Existing `CARMADIO-DECISION-GOV-007`
