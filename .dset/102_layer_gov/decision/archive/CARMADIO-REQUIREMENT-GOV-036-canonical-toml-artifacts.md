...
artifact_id: CARMADIO-REQUIREMENT-GOV-036
...
CARMADIO-owned structured artifact files must use TOML. Markdown artifacts remain
...
TOML is the canonical encoding for CARMADIO-owned structured artifacts and DSET Markdown frontmatter, with explicit generated or host-mandated format boundaries.

## Rationale

TOML makes configuration and artifact metadata easier to scan and removes indentation-dependent authority from CARMADIO-owned structured files.
