...
|---|---|---|
| `.dset/` | Governed Atoms and Projections, installed methodology, settings, tools, skill instructions, schemas, and templates | Atom revisions are Git-bound; Projections and configuration update through Git |
