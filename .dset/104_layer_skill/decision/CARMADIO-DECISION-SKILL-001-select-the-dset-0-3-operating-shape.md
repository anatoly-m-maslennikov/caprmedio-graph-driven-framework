...
- **Decision ID:** `CARMADIO-DECISION-SKILL-001`
- **Status:** accepted
- **Decision date:** 2026-07-15
- **Resolves Question:** `CARMADIO-QUESTION-SKILL-001`
- **Supersedes:** none
- **Superseded by:** none
- **LLM session IDs:**
...
`CARMADIO-CHANGE-SKILL-001` across the repository. Fixed Contracts include local
