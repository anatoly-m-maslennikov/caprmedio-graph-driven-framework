...
- `CARMADIO-CONTRACT-META-001` — repository/Work Area scope declaration.
- `CARMADIO-CONTRACT-SKILL-001` — host-native skill distribution.
- `CARMADIO-CONTRACT-SKILL-002` — target-project local-governance resolution.
- `CARMADIO-CONTRACT-TOOL-001` — declared platform compatibility.
- `CARMADIO-CONTRACT-TOOL-002` — dependency provenance and exceptions.
- `CARMADIO-CONTRACT-OPS-001` — hosted protected-delivery evidence.
...
## ADDED — CARMADIO-CONTRACT-OPS-002 Integration-first delivery topology
