...
artifact_id = "CARMADIO-EVIDENCE-RECORD-005"
...
- **Intended use:** Support `CARMADIO-REQUIREMENT-SKILL-011`,
  `CARMADIO-TEST-CASE-SKILL-013`, and `CARMADIO-TASK-SKILL-057`.
...
- **Unsupported uses:** this proof does not claim a real authenticated
  Codex/Claude inference, qualitative `CARMADIO-EVALUATION-CASE-SKILL-011`, or successful
...
remain separately owned by `CARMADIO-TASK-SKILL-020` and
`CARMADIO-TASK-TOOL-036`; they are not inferred from these deterministic fixtures.
