...
artifact_id = "CARMADIO-EVIDENCE-RECORD-008"
...
- **Intended use:** Support `CARMADIO-DECISION-GOV-003`,
  `CARMADIO-DECISION-GOV-010`, `CARMADIO-REQUIREMENT-GOV-020`,
  `CARMADIO-REQUIREMENT-GOV-026`, `CARMADIO-REQUIREMENT-TOOL-019`,
  `CARMADIO-TEST-CASE-GOV-026`, and `CARMADIO-TEST-CASE-TOOL-019`.
