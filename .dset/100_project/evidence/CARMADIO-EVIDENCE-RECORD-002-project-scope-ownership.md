...
artifact_id = "CARMADIO-EVIDENCE-RECORD-002"
...
- **Claim:** DSET defines and recursively applies narrowest-common-scope
  ...
  child-owned detail.
- **Intended use:** Support `CARMADIO-REQUIREMENT-GOV-032`,
  `CARMADIO-INVARIANT-GOV-022`, `CARMADIO-TEST-CASE-GOV-032`, and
  `CARMADIO-TASK-GOV-054`.
...
|---|---|---|
| Atomic authority | Immutable `CARMADIO-ATOMIC-RECORD-003` owns accepted `CARMADIO-REQUIREMENT-GOV-032` with session provenance and rationale | Pass |
...
`CARMADIO-EVALUATION-CASE-GOV-022` reviewer-placement run also remains pending.
