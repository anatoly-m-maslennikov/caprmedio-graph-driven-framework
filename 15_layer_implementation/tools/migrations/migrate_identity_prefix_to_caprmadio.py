...
Invocation:
    python migrate_identity_prefix_to_caprmadio.py [ROOT]
    python migrate_identity_prefix_to_caprmadio.py [ROOT] --apply \
        --expect-plan-digest SHA256
    python migrate_identity_prefix_to_caprmadio.py [ROOT] --check
