...
Usage:
    python3 002_FRAMEWORK_ENGINE/PROGRAMMATIC/TOOLS/migrations/resolve_cap_io_atom_lifecycles.py
    python3 002_FRAMEWORK_ENGINE/PROGRAMMATIC/TOOLS/migrations/resolve_cap_io_atom_lifecycles.py --apply
