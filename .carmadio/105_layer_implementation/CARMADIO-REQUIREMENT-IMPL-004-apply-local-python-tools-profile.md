+++
artifact_id = "CARMADIO-ATOMIC-RECORD-184"
semantic_id = "CARMADIO-REQUIREMENT-IMPL-004"
...
claim = "Every Python tool, library module, runner, and Test distributed inside .carmadio conforms to the selected Local Python Tools profile through its authoritative root source and explicit installed-methodology synchronization."
...
[[relations]]
type = "child_of"
target = "CARMADIO-REQUIREMENT-IMPL-001"

[[relations]]
type = "resolution_of"
target = "CARMADIO-QUESTION-IMPL-001"
+++

# Requirement — Apply the Local Python Tools profile recursively

All Python carriers distributed below `.carmadio` must derive from authoritative
