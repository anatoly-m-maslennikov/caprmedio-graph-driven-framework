...
|---|---|---|---|
| **CARMADIO-EVALUATION-CASE-IMPL-001** | `CARMADIO-REQUIREMENT-IMPL-005`, `CARMADIO-REQUIREMENT-001` | `CARMADIO-EVALUATION-CASE-IMPL-001-agent-skills-profile.md`; `030_dset-implementation-evaluations-skill-cases.toml` | Run every affected skill's trigger, non-trigger, ambiguous-routing, and applicable adversarial cases independently for each provider/host/model matrix cell actually claimed; reconcile only matching identities and preserve unsupported or inconclusive cells. |
