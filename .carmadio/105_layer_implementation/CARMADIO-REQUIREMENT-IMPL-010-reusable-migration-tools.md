...
artifact_id: CARMADIO-REQUIREMENT-IMPL-010
...
relations:
  - type: child_of
    targets:
      - CARMADIO-REQUIREMENT-IMPL-001
  - type: relates_to
    targets:
      - CARMADIO-REQUIREMENT-IMPL-002
      - CARMADIO-REQUIREMENT-IMPL-003
      - CARMADIO-REQUIREMENT-IMPL-004
...
Temporary transaction state belongs to `.carmadio_runtime`; optional redacted
append-only execution logs belong to `.carmadio_logs`. Neither location becomes
project authority.
