...
artifact_id: CARMADIO-REQUIREMENT-META-076
...
Every CARMADIO-governed project must use Git as its canonical engine for the
...
CARMADIO must not maintain a second lifecycle ledger as a competing history
...
Git is the canonical history engine for persisted CARMADIO-governed repository
state.
