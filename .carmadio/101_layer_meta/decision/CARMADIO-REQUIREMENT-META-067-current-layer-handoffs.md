...
artifact_id: CARMADIO-REQUIREMENT-META-067
...
CARMADIO does not create placeholder artifacts merely to simulate an unnecessary
handoff.

## Primary claim

Every adjacent boundary in the current CARMADIO topology declares its accepted
