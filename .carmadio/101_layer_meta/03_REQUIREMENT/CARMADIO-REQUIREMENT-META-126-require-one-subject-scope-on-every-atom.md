...
artifact_id: CARMADIO-REQUIREMENT-META-126
...
relations:
  ...
  - type: relates_to
    targets:
      ...
      - CARMADIO-REQUIREMENT-META-117
      - CARMADIO-REQUIREMENT-META-120
      - CARMADIO-REQUIREMENT-META-124
---

# Requirement — Require one Subject scope on every Atom

Every CARMADIO Atom declares exactly one singular `subject_scope`, including
...
Every CARMADIO Atom has exactly one governed `subject_scope`, regardless of its
