...
artifact_id: CARMADIO-REQUIREMENT-META-135
...
- Analysis develops understanding but does not commit work;
- Plan commits and coordinates intended change but does not modify the
  specification or realize it;
...
Separating planned work from analysis, specification, and performed realization
prevents a plan or record from standing in for the change it describes.
