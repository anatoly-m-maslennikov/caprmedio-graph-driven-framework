...
artifact_id: CARMADIO-REQUIREMENT-META-137
...
A replaceable current-state view can summarize native realization without
being confused with the project files it describes or with immutable normative
claims.
