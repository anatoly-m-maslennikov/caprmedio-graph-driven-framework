...
- **Decision ID:** `CARMADIO-DECISION-OPS-002`
- **Status:** accepted
- **Decision date:** 2026-07-20
- **Resolves Question:** follow-up operator clarification of
  `CARMADIO-QUESTION-GOV-003`
- **Absorbs:** `CARMADIO-DECISION-OPS-001` in full
...
`CARMADIO-DECISION-OPS-001`, now as Version Scopes:
...
- **Known counter-evidence:** schema, initializer, validator, overview, and
  release CLI enforcement remain open under `CARMADIO-PROBLEM-OPS-002`
