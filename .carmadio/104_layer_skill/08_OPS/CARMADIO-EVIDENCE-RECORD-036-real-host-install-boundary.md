...
artifact_id = "CARMADIO-EVIDENCE-RECORD-036"
priority = "high"
...
evidence_location = "dset/scopes/skill/changes/make-dset-self-hosting-and-skills-thin/proofs/CARMADIO-EVIDENCE-RECORD-036-real-host-install-boundary.md"
polarity = "mixed"
currentness = "current"
...
environment. `CARMADIO-TASK-SKILL-020` therefore remains open.
