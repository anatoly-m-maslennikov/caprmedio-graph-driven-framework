+++
artifact_id = "CARMADIO-ATOMIC-RECORD-081"
semantic_id = "CARMADIO-DECISION-SKILL-003"
...
[[relations]]
type = "replacement_of"
target = "CARMADIO-DECISION-SKILL-002"
+++
...
forward from `CARMADIO-DECISION-SKILL-002`: the catch-all `dset`, two bounded
...
of `CARMADIO-DECISION-SKILL-002` while retaining its sixteen lifecycle entrypoints.
