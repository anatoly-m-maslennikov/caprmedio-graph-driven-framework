+++
artifact_id = "CARMADIO-ATOMIC-RECORD-006"
semantic_id = "CARMADIO-REQUIREMENT-SKILL-010"
...
limit from `CARMADIO-DECISION-SKILL-002` with `dset-decisions` and a finite
