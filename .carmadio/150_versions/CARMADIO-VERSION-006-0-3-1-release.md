...
artifact_id = "CARMADIO-VERSION-006"
version_scope_ref = "CARMADIO-VERSION-001"
...
- **Release-owning Change:** `CARMADIO-CHANGE-SKILL-001`
- **Participating Changes:** `CARMADIO-CHANGE-SKILL-001`

## Included scope

Deliver the DSET 0.3 foundation represented by `CARMADIO-VERSION-001` and
