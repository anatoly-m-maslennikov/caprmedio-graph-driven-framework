...
artifact_id = "CARMADIO-EVIDENCE-RECORD-001"
...
- **Intended use:** Support `CARMADIO-DECISION-GOV-009`,
  `CARMADIO-DECISION-OPS-004`, `CARMADIO-REQUIREMENT-GOV-029..031`,
  `CARMADIO-REQUIREMENT-OPS-013`, and `CARMADIO-TASK-GOV-051..053`.
...
The qualitative `CARMADIO-EVALUATION-CASE-GOV-019..021` and `CARMADIO-EVALUATION-CASE-OPS-010` runs remain
...
event. `CARMADIO-TASK-GOV-049` remains open for the broader four-Type runtime and
