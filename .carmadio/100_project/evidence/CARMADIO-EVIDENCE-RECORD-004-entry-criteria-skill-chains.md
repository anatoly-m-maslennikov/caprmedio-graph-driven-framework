...
artifact_id = "CARMADIO-EVIDENCE-RECORD-004"
...
- **Intended use:** Support `CARMADIO-REQUIREMENT-SKILL-010`,
  `CARMADIO-INVARIANT-SKILL-009`, `CARMADIO-TEST-CASE-SKILL-012`, and
  `CARMADIO-TASK-SKILL-024`.
...
- **Unsupported uses:** this proof does not claim that every host exposes full
  ...
  `CARMADIO-EVALUATION-CASE-SKILL-010` has run.
...
The prior `CARMADIO-DECISION-SKILL-002` remains immutable historical authority for
the public 16-skill topology. `CARMADIO-REQUIREMENT-SKILL-010` explicitly replaces
