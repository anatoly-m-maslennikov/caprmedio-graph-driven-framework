...
artifact_id = "CARMADIO-EVIDENCE-RECORD-006"
child_of = ["CARMADIO-REQUIREMENT-GOV-035"]
...
- **Intended use:** Support `CARMADIO-REQUIREMENT-GOV-035`,
  `CARMADIO-TEST-CASE-GOV-035`, and `CARMADIO-TASK-GOV-058`.
...
- **Unsupported uses:** this proof does not claim the independent qualitative
  `CARMADIO-EVALUATION-CASE-GOV-025`, operator acceptance of any proposed promotion, or that a
