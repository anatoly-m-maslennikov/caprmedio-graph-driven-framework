...
artifact_id = "CARMADIO-EVIDENCE-RECORD-003"
child_of = ["CARMADIO-REQUIREMENT-GOV-034"]
...
- **Intended use:** Support `CARMADIO-REQUIREMENT-GOV-034`,
  `CARMADIO-INVARIANT-GOV-024`, `CARMADIO-TEST-CASE-GOV-034`, and
  `CARMADIO-TASK-GOV-056`.
...
- **Unsupported uses:** this proof does not claim that every historical DSET
  ...
  rendered as graph nodes, or that qualitative `CARMADIO-EVALUATION-CASE-GOV-024` has run.
...
| Immutability | `CARMADIO-REQUIREMENT-GOV-033` was not edited to register its new child | Pass |
| Failure matrix | Scalar, empty, duplicate, unresolved, self, cyclic, and authored-reverse relations fail | Pass |
| Recursive application | `CARMADIO-REQUIREMENT-GOV-034` is a child of `CARMADIO-REQUIREMENT-GOV-033`; the generated reverse edge is current | Pass |
