...
artifact_id = "CARMADIO-EVIDENCE-RECORD-009"
...
- **Claim:** DSET executes one flat four-Type semantic model for native atoms
  ...
  carriers.
- **Intended use:** Support `CARMADIO-DECISION-GOV-008`,
  `CARMADIO-REQUIREMENT-GOV-027`, `CARMADIO-INVARIANT-GOV-004`,
  `CARMADIO-INVARIANT-GOV-017`, `CARMADIO-TEST-CASE-GOV-027`, and
...
| Fail closed | `CARMADIO-E166` rejects ID-kind/carrier mismatch; nested, invalid, and QA-without-subtype native atoms remain rejected | Pass |
