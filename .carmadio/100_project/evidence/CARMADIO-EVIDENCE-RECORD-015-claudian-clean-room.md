...
artifact_id = "CARMADIO-EVIDENCE-RECORD-015"
priority = "high"
child_of = ["CARMADIO-EVALUATION-CASE-TOOL-003"]
...
`CARMADIO-EVALUATION-CASE-TOOL-003`; it does not promote the candidate.
...
2. Ran `dset init` as a no-write preview, then executed it only in a disposable
   copy. The first executable attempt exposed `CARMADIO-PROBLEM-TOOL-006`; after
...
fields. See
[`CARMADIO-ANALYSIS-REPORT-001`](../CARMADIO-ANALYSIS-REPORT-001-clean-upstream-typescript-boundary.md).
