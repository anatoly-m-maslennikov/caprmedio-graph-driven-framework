...
| Repository legal files outside `.carmadio`, with deterministic legal-only provenance resolution | `CARMADIO-DECISION-GOV-029` |
...
evergreen package fragments under `.carmadio/101_layer_meta/` through
`.carmadio/106_layer_ops/`. This Change
