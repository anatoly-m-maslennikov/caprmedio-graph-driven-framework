...
artifact_id = "CARMADIO-EVIDENCE-RECORD-018"
priority = "high"
...
tests the real Codex installation boundary for `CARMADIO-CONTRACT-SKILL-001` and
`CARMADIO-TEST-CASE-SKILL-011`. It may support only the current blocked disposition; it
