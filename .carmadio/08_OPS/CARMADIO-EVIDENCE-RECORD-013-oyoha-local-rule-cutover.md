...
artifact_id = "CARMADIO-EVIDENCE-RECORD-013"
priority = "high"
...
evidence for `CARMADIO-REQUIREMENT-SKILL-011`; the accepted compatibility Test
mappings remain `CARMADIO-TEST-CASE-SKILL-010` and `CARMADIO-TEST-CASE-GOV-017`.
