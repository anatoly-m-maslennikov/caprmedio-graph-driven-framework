...
def _stage_project(
    ...
    *,
    ...
    _write_combined_settings(
        source_layout.find_template("carmadio_settings.toml"), manifest_path, manifest
    )
    ...
    (carmadio_root / APPLIED_PROJECT_ROOT / f"{project_key}-PROJECT-HUB.md").write_text(
    ...
    (carmadio_root / APPLIED_VERSIONS_ROOT / f"{project_key}-VERSIONS-HUB.md").write_text(
        "# Version lifecycle\n\n"
