...
class ProjectSettingsTests(unittest.TestCase):
    ...
    def test_published_priority_schemas_defer_vocabulary_to_settings(self) -> None:
        paths = {
            "atom": ROOT / ".carmadio/02_layer_gov/schemas/atom.schema.json",
            "change": ROOT / ".carmadio/02_layer_gov/schemas/change.schema.json",
            "review": ROOT / ".carmadio/02_layer_gov/schemas/review-report.schema.json",
            "conflict": (
                ROOT / ".carmadio/02_layer_gov/schemas/conflict-candidate.schema.json"
            ),
            "lifecycle": ROOT / ".carmadio/02_layer_gov/schemas/lifecycle.schema.json",
            "traceability": (
                ROOT / ".carmadio/03_layer_tool/schemas/traceability.schema.json"
            ),
        }
        schemas = {
