...
2. Read `.carmadio/dset_settings.toml`, then the enabled type/subtype whitelist.
...
into `.carmadio/000_dset_methodology/` only by an explicit one-way synchronization
