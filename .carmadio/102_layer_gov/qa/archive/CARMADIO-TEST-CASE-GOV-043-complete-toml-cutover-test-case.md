...
artifact_id: CARMADIO-TEST-CASE-GOV-043
...
relations:
  ...
  - type: replacement_of
    targets:
      - CARMADIO-TEST-CASE-GOV-038
      - CARMADIO-TEST-CASE-GOV-040
      - CARMADIO-TEST-CASE-GOV-041
---
...
Deterministic tests prove complete lossless TOML cutover of every CARMADIO-owned YAML artifact and Markdown YAML-frontmatter carrier with reference closure, rollback parity, and second-run idempotency.
