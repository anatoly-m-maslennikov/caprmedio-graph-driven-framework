...
artifact_id: CARMADIO-EVIDENCE-RECORD-023
...
`CARMADIO-DECISION-GOV-013` and deterministic Test `CARMADIO-TEST-CASE-GOV-036`.
This evidence supports the local executable relation contract only. It does
not satisfy qualitative Evaluation `CARMADIO-EVALUATION-CASE-GOV-026`, hosted CI,
...
`CARMADIO-SPECIFICATION-001`: Decision authority through atom carrier 035,
