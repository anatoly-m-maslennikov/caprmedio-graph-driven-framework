...
artifact_id: CARMADIO-EVIDENCE-RECORD-024
...
`CARMADIO-DECISION-GOV-013`, resolved Problem `CARMADIO-DEFECT-TOOL-002`, and
deterministic Test `CARMADIO-TEST-CASE-GOV-036`.
...
qualitative Evaluation `CARMADIO-EVALUATION-CASE-GOV-026`, hosted CI, release
