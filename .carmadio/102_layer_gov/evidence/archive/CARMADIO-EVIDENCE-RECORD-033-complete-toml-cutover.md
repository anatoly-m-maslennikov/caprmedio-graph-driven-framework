...
artifact_id: CARMADIO-EVIDENCE-RECORD-033
...
polarity: "supports"
currentness: "current"
reopen_when: "A CARMADIO-owned YAML carrier or YAML frontmatter is added, a migrated carrier/reference/generated view changes, the migration implementation changes, or the subject revision changes."
subject:
  id: "CARMADIO-TEST-CASE-GOV-043"
  revision: "483ea2af321505f40713a73a51b3b68f327ba7f3"
  intended_use: "Support the bounded claim that all CARMADIO-owned artifact carriers use TOML and the completed migration is idempotent and repository-valid."
producer:
