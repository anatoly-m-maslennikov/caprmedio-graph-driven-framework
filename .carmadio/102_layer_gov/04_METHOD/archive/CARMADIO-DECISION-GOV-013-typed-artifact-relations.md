...
artifact_id: CARMADIO-DECISION-GOV-013
...
This Decision completely replaces `CARMADIO-REQUIREMENT-GOV-033` and
`CARMADIO-REQUIREMENT-GOV-034`, and resolves `CARMADIO-QUESTION-GOV-004`.
