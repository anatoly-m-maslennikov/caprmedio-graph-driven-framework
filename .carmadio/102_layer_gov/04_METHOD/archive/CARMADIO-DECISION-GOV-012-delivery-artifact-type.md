...
artifact_id: CARMADIO-DECISION-GOV-012
...
This Decision absorbs `CARMADIO-DECISION-GOV-011` in full and, transitively, its
absorbed `CARMADIO-DECISION-GOV-009` predecessor. It preserves the complete catalog
and all consequences of `CARMADIO-DECISION-GOV-011` while removing the invalid
