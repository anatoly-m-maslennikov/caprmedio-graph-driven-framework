...
artifact_id: CARMADIO-REQUIREMENT-GOV-135
...
Every production-relevant component has a safe, structured, severity-aware
Logging Policy that makes real operation diagnosable without exposing secrets
or producing unbounded noise.
