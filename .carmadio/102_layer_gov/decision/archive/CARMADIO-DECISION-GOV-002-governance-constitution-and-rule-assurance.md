...
artifact_id: CARMADIO-DECISION-GOV-002
...
- **Selected option:** strengthen `CARMADIO-RULE-ARCHITECTURE` as the sole governance constitution and separate rule authority, dependency, precedence, and assurance
...
candidate review considered a new `CARMADIO-RULE-RULE-AUTHORITY`, a new
`CARMADIO-RULE-GOVERNANCE-OF-GOVERNANCE`, and an extension of the existing
...
- a new sibling root would duplicate `CARMADIO-RULE-ARCHITECTURE` and complicate
...
- `CARMADIO-REQUIREMENT-GOV-023` and `CARMADIO-INVARIANT-GOV-012`;
- `CARMADIO-TEST-CASE-GOV-023` and `CARMADIO-EVALUATION-CASE-GOV-013`;
