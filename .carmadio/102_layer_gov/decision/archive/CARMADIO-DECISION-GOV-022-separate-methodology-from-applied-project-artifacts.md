...
artifact_id: CARMADIO-DECISION-GOV-022
...
relations:
  - type: replacement_of
    targets:
      - CARMADIO-REQUIREMENT-GOV-051
      - CARMADIO-REQUIREMENT-GOV-046
---
...
.carmadio/103_layer_tool/         applied TOOL artifacts
.carmadio/104_layer_skill/        applied SKILL artifacts
.carmadio/105_layer_ops/          applied OPS artifacts
.carmadio/150_versions/           applied Version artifacts
```
