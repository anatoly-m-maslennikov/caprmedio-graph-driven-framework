...
artifact_id: CARMADIO-REQUIREMENT-GOV-132
...
```text
CARMADIO-GOV-REQU-001--artifact-form-is-explicit.md
CARMADIO-GOV-ASSU-002-QA-CASE--projection-interpretability.md
CARMADIO-OPS-ASSU-003-ASSURANCE-CONTROL--queue-stall-detection.md
CARMADIO-TOOL-IMPL-001--resolve-project-local-governance.md
CARMADIO-META-CATL-001--requirement-atom-catalog.md
```
