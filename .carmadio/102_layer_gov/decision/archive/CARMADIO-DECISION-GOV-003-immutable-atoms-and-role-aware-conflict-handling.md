...
artifact_id: CARMADIO-DECISION-GOV-003
...
- **Replaces claims:** the `CARMADIO-DECISION-GOV-001` claim that evergreen files
  own current truth and the `CARMADIO-DECISION-GOV-002` claim that governing
...
- `CARMADIO-REQUIREMENT-GOV-020..021` and `CARMADIO-INVARIANT-GOV-016` for atomic
  sources, compiled projections, immutability, absorption, and retirement;
- `CARMADIO-REQUIREMENT-GOV-024..026` and `CARMADIO-INVARIANT-GOV-013..015` for health,
  external review, universal priority, and conflict governance;
- `CARMADIO-REQUIREMENT-TOOL-018..019` and
  `CARMADIO-INVARIANT-TOOL-004..005` for planned deterministic rendering and
  pairwise conflict disposition;
- the accepted GOV/TOOL test and evaluation cases;
- `CARMADIO-RULE-ARCHITECTURE` and `CARMADIO-RULE-ARTIFACT-MAINTENANCE`; and
