...
artifact_id: CARMADIO-DECISION-GOV-001
...
- `dset/scopes/gov/specs/packages/methodology/spec.md`
  - `CARMADIO-REQUIREMENT-GOV-020`
  - `CARMADIO-REQUIREMENT-GOV-021`
  - `CARMADIO-REQUIREMENT-GOV-022`
...
- **Confirmation evidence:** this Change adds the Decision, compiles its
  ...
  commit with `Implements: CARMADIO-DECISION-GOV-001`.
