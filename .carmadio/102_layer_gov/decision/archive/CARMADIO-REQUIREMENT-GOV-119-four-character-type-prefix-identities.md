...
artifact_id: CARMADIO-REQUIREMENT-GOV-119
...
relations:
  - type: relates_to
    targets:
      ...
      - CARMADIO-REQUIREMENT-GOV-113
      - CARMADIO-REQUIREMENT-GOV-114
      - CARMADIO-REQUIREMENT-GOV-118
---
...
```text
CARMADIO-GOV-REQU-001--github-compatible-artifacts.md
CARMADIO-GOV-QACS-002-EVAL-CASE--relation-interpretability.md
CARMADIO-TOOL-TDEC-001--use-project-local-resolver.md
CARMADIO-TOOL-IDEC-001--connect-cli-to-governance.md
CARMADIO-GOV-EVRC-001--structural-validation-result.md
CARMADIO-META-SPEC-001--atomic-artifact-domain.md
```

The corresponding stable IDs are `CARMADIO-GOV-REQU-001`,
`CARMADIO-GOV-QACS-002`, `CARMADIO-TOOL-TDEC-001`, `CARMADIO-TOOL-IDEC-001`, and
`CARMADIO-GOV-EVRC-001`. The maintained Specification identity is
`CARMADIO-META-SPEC-001`.
