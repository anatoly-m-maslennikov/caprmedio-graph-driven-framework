...
artifact_id: CARMADIO-REQUIREMENT-GOV-044
...
1. `.carmadio/01_layer_meta/` — framework identity, semantic foundations, and
   authoring contracts;
2. `.carmadio/02_layer_gov/` — governance, schemas, registries, and templates;
3. `.carmadio/03_layer_tool/` — executable toolchain and validation behavior;
4. `.carmadio/04_layer_skill/` — agent-facing wrappers and orchestration; and
5. `.carmadio/05_layer_ops/` — delivery, release, and supportability.
