...
artifact_id: CARMADIO-DECISION-GOV-019
...
This Decision completely replaces `CARMADIO-DECISION-GOV-012` and is the
classification sibling of `CARMADIO-DECISION-OPS-007`, which owns the unchanged
