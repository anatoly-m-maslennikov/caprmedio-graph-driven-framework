...
artifact_id: CARMADIO-REQUIREMENT-GOV-040
...
relations:
  ...
  - type: child_of
    targets:
      - CARMADIO-DECISION-GOV-018
  - type: resolution_of
    targets:
      - CARMADIO-DEFECT-TOOL-007
---
...
All CARMADIO-owned structured artifact files and DSET Markdown frontmatter use
...
No CARMADIO-owned `.yaml` or `.yml` artifact and no DSET Markdown YAML frontmatter
