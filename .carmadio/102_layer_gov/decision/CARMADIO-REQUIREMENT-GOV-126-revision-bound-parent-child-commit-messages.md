...
artifact_id: CARMADIO-REQUIREMENT-GOV-126
...
A governed commit records exact Atomic Artifact parent revisions and separates
new from updated children, with all children owned by one scope.
