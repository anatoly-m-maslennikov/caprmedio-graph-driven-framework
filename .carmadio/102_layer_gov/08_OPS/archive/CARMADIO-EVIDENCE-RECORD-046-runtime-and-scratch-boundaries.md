...
artifact_id: CARMADIO-EVIDENCE-RECORD-046
...
- committed governance and control truth under `.carmadio/`;
- ignored resumable machine-local state under `.carmadio_runtime/`;
...
interpretation remains separate under `CARMADIO-EVALUATION-CASE-GOV-032`.
...
polarity: "supports"
currentness: "current"
reopen_when: "The .carmadio control boundary, .carmadio_runtime storage boundary, temporary-directory helper, bootstrap/self-host lifecycle, atomic-publication mechanism, migration, ignore rules, or configured verification commands change."
subject:
  id: "CARMADIO-TEST-CASE-GOV-048"
