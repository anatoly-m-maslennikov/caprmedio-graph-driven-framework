...
artifact_id: CARMADIO-EVIDENCE-RECORD-037
...
`CARMADIO-REVIEW-PACKET-004` binds the current DSET `0.4` framework review to
...
schema_version: "1.0"
context:
  - "packet=CARMADIO-REVIEW-PACKET-004"
