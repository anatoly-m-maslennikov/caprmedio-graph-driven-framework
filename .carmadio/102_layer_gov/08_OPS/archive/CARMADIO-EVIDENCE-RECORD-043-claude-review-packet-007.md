...
artifact_id: CARMADIO-EVIDENCE-RECORD-043
...
`CARMADIO-REVIEW-PACKET-007` binds the repaired pull-request fixed-point candidate
...
`CARMADIO-TASK-GOV-044` remains open.
...
schema_version: "1.0"
context:
  - "packet=CARMADIO-REVIEW-PACKET-007"
