...
artifact_id: CARMADIO-REQUIREMENT-GOV-154
...
deterministic, lossless migration must replace the former `CARMADIO` project
...
from `CARMADIO` to `CAPRMADIO` with no active compatibility aliases.
