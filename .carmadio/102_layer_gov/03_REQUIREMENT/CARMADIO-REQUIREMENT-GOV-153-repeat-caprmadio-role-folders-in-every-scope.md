...
artifact_id: CARMADIO-REQUIREMENT-GOV-153
...
The `.carmadio/` root is the implicit project scope. Every project scope and
...
remain in their prescribed project locations outside `.carmadio/` and are not
