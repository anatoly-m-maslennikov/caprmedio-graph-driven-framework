...
artifact_id: CARMADIO-REQUIREMENT-GOV-065
...
Git is mandatory for every CARMADIO-managed project.
...
Every CARMADIO-managed project uses Git, dset-init requires an existing enclosing repository or initializes one, and every implemented Decision or resolved Problem has at least one committed change that names the governed artifact.
