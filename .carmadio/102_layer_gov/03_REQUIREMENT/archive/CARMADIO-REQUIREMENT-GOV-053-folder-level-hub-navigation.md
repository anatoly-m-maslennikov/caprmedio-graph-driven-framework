...
artifact_id: CARMADIO-REQUIREMENT-GOV-053
...
also never lists or links any file or directory below `.carmadio_runtime/`; runtime
state is transient and outside durable navigation.

## Primary claim

Hubs represent atomic artifacts only through their containing folders, list evergreen settings and other long-lived non-atomic carriers, and never list or link a .carmadio_runtime descendant.
