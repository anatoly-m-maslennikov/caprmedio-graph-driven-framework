...
artifact_id: CARMADIO-REQUIREMENT-GOV-051
...
`05_layer_ops` names below `.carmadio/`. The numeric prefixes keep project scope,
...
Recursive DSET project scope uses 00_project, 01_layer_meta, 02_layer_gov, 03_layer_tool, 04_layer_skill, 05_layer_ops, and 10_versions, with the same numbered framework layer names below .carmadio.
