...
artifact_id: CARMADIO-REQUIREMENT-GOV-151
...
relations:
  - type: replacement_of
    targets:
      - CARMADIO-REQUIREMENT-GOV-148
  - type: child_of
    targets:
      - CARMADIO-REQUIREMENT-META-137
  - type: relates_to
    targets:
...
# Requirement — Register the Implementation Record Projection
...
`implementation_record` is the registered Implementation-role Projection Type
for the current derived view of native project realization.
