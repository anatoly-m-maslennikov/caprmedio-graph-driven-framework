...
semantic_id = "CAPRMEDIO-SPEC-TOOLS-CONC-062--windows-python-placeholder-parsing"
...
sequence on native Windows and then stopped with `CAPRMEDIO-E900: [WinError 2]`.
