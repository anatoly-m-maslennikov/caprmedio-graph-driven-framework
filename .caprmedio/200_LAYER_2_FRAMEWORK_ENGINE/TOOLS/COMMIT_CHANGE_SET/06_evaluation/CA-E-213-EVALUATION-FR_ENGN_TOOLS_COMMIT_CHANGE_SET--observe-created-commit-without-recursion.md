...
Create one valid governed commit and one ordinary non-governed commit while the runtime-owned Git Hooks are registered. Inspect the post-commit result and runtime observation log after each commit.
