+++
semantic_id = "CAPRMEDIO-SPEC-SKILLS-REQU-567--entry-criteria-skill-chains"
...
invokes `dset-plan-proof` when separate Test or Evaluation cases are incomplete
...
limit from `CAPRMEDIO-SPEC-SKILLS-METH-056--expose-every-dset-lifecycle-mode-as-a-public-skill` with `dset-decisions` and a finite
