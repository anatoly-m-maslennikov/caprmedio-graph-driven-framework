...
evidence_location = "dset/scopes/skill/changes/make-dset-self-hosting-and-skills-thin/proofs/CAPRMEDIO-SPEC-SKILLS-OPER-020--real-host-install-boundary.md"
polarity = "mixed"
currentness = "current"
...
environment. `CAPRMEDIO-TASK-SKILL-020` therefore remains open.
