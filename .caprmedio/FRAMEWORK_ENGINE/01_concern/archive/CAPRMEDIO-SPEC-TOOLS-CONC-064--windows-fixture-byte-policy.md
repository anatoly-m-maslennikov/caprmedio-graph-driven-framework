...
semantic_id = "CAPRMEDIO-SPEC-TOOLS-CONC-064--windows-fixture-byte-policy"
...
claim = "Byte-sensitive temporary Git fixtures inherit host newline and autocrlf policy, so native Windows can compare CRLF working bytes with normalized LF Git blobs and produce platform-dependent evaluation failures."
version = 1
