+++
semantic_id = "CAPRMEDIO-SPEC-SKILLS-METH-057--overview-public-entrypoint"
...
[[relations]]
type = "replacement_of"
target = "CAPRMEDIO-SPEC-SKILLS-METH-056--expose-every-dset-lifecycle-mode-as-a-public-skill"
+++
...
forward from `CAPRMEDIO-SPEC-SKILLS-METH-056--expose-every-dset-lifecycle-mode-as-a-public-skill`: the catch-all `dset`, two bounded
...
of `CAPRMEDIO-SPEC-SKILLS-METH-056--expose-every-dset-lifecycle-mode-as-a-public-skill` while retaining its sixteen lifecycle entrypoints.
