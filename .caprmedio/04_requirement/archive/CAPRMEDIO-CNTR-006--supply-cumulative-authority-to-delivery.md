...
endpoints:
  ...
  - role: consumer
    ...
    origin: internal
---
# Supply cumulative authority to delivery

DELIVERY consumes the complete applicable upstream normative authority set from PROJECT, META, GOV, and SPEC through the `authority_input` Contract.
