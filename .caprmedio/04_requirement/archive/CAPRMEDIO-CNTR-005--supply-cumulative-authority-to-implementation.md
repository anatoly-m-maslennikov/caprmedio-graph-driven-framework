...
endpoints:
  ...
  - role: consumer
    ...
    origin: internal
---
# Supply cumulative authority to implementation

IMPLEMENTATION consumes the complete applicable upstream authority set from PROJECT, META, GOV, SPEC through the authority_input Contract.
