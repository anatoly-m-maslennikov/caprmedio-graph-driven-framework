...
Every canonical CAPRMEDIO Content-role name is a noun naming the primary kind
...
Evaluation, Delivery, Implementation, and Ops. Grammatical variants such as
...
CAPRMEDIO Content-role names are nouns that classify contributions rather than
