...
`CAPRMEDIO-REVIEW-PACKET-007` binds the repaired pull-request fixed-point candidate
...
`CAPRMEDIO-TASK-GOV-044` remains open.
...
schema_version: "1.0"
context:
  - "packet=CAPRMEDIO-REVIEW-PACKET-007"
