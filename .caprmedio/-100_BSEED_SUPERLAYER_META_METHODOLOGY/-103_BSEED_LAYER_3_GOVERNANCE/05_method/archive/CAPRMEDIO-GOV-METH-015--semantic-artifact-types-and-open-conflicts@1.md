...
relations:
  - type: replacement_of
    targets:
      - CAPRMEDIO-GOV-METH-014--problems-questions-and-conflicts-are-distinct
---
...
- **Replaces claims:** all claims of `CAPRMEDIO-GOV-METH-014--problems-questions-and-conflicts-are-distinct`, carried forward
...
- failing proof changes evaluation;
