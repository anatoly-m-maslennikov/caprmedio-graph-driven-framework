...
`((all active and draft Atoms, configurations, manifests, and provenance records in the frozen CA-P-102 source frontier that govern current Project identity, Extension activation, selected Extension version, Project Customization, replacement, priority, compatibility resolution, local Tool, MCP, and App modes, and Applicable Methodology source selection) union (their exact accepted successors produced by CA-P-103 through CA-P-105 and CA-P-112))`
