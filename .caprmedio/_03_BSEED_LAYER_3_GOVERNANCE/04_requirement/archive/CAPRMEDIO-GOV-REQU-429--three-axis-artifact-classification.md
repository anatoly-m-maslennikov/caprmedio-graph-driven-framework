...
relations:
  - type: resolution_of
    targets:
      - CAPRMEDIO-GOV-CONC-049--should-artifact-classification-use-three-simple-axes
  - type: replacement_of
    targets:
      - CAPRMEDIO-GOV-REQU-405--three-active-carrier-roles
---
...
Revision semantics, lifecycle meaning, and authority origin are independent concerns; classifying realized code as current state and evaluation implementations as checking mechanisms removes the overlapping phase-role, answer-to, and special Implementation-class model.
