...
relations:
  - type: replacement_of
    targets:
      - CAPRMEDIO-GOV-METH-016--canonical-semantic-types-and-subtypes
---
...
- **Replaces claims:** the incomplete Decision-subtype list in
  `CAPRMEDIO-GOV-METH-016--canonical-semantic-types-and-subtypes`; every other Type, lifecycle, authority, compilation,
...
evaluation definitions. Supportability is a cross-cutting concern over evergreen
