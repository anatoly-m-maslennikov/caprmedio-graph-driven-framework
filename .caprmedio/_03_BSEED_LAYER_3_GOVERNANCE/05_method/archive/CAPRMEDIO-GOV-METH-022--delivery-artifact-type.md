...
This Decision absorbs `CAPRMEDIO-GOV-METH-021--delivery-artifact-type` in full and, transitively, its
absorbed `CAPRMEDIO-GOV-METH-019--classify-artifact-role-separately-from-semantic-type` predecessor. It preserves the complete catalog
and all consequences of `CAPRMEDIO-GOV-METH-021--delivery-artifact-type` while removing the invalid
