...
Every committed file and directory below .caprmedio/000_caprmedio_methodology uses a stable numeric prefix within its parent, including hubs, schemas, templates, fixtures, guides, and supportability material.
