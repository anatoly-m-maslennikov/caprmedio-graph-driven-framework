...
- `dset/scopes/gov/specs/packages/methodology/spec.md`
  - `CAPRMEDIO-REQUIREMENT-GOV-020`
  - `CAPRMEDIO-REQUIREMENT-GOV-021`
  - `CAPRMEDIO-REQUIREMENT-GOV-022`
...
- **Confirmation evidence:** this Change adds the Decision, compiles its
  ...
  commit with `Implements: CAPRMEDIO-GOV-METH-011--artifact-classes-compilation-and-provenance`.
