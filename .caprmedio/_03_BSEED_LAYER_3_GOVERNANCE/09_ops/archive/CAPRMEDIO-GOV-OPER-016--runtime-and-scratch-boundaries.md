...
- committed governance and control truth under `.caprmedio/`;
- ignored resumable machine-local state under `.caprmedio_runtime/`;
...
interpretation remains separate under `CAPRMEDIO-GOV-EVAL-018--runtime-boundary-interpretability`.
...
polarity: "supports"
currentness: "current"
reopen_when: "The .caprmedio control boundary, .caprmedio_runtime storage boundary, temporary-directory helper, bootstrap/self-host lifecycle, atomic-publication mechanism, migration, ignore rules, or configured verification commands change."
subject:
  id: "CAPRMEDIO-GOV-EVAL-036--control-runtime-and-scratch-boundaries-test-case"
