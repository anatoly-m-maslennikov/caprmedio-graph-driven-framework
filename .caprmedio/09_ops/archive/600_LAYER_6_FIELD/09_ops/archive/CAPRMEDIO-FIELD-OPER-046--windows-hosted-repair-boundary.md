...
evidence_location = "dset/scopes/skill/changes/make-dset-self-hosting-and-skills-thin/proofs/CAPRMEDIO-FIELD-OPER-046--windows-hosted-repair-boundary.md"
...
[subject]
id = "CAPRMEDIO-FIELD-EVAL-064--deterministic-git-fixture-bytes-test-case"
...
[[relations]]
type = "evidence_for"
target = "CAPRMEDIO-FIELD-EVAL-064--deterministic-git-fixture-bytes-test-case"
+++
...
`CAPRMEDIO-FIELD-CONC-089--current-exact-head-hosted-proof-is-missing` remains open. It may be resolved only after a published
