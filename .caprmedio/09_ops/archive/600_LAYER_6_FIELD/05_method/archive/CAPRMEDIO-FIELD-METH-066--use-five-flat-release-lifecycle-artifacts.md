...
- **Decision ID:** `CAPRMEDIO-FIELD-METH-066--use-five-flat-release-lifecycle-artifacts`
- **Status:** accepted
- **Decision date:** 2026-07-20
- **Absorbs:** `CAPRMEDIO-FIELD-METH-065--keep-release-lifecycle-artifacts-flat` in full
