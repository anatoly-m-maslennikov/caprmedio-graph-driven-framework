...
CA-M-193 realizes the current direct contract of CA-R-1096 without unowned behavior.
...
The valid path produces only the declared outcome for CA-R-1096, and the invalid or stale path fails explicitly without an unauthorized mutation, widened scope, or invented provenance.
