...
CA-M-191 realizes the current direct contract of CA-R-1094 without unowned behavior.
...
The valid path produces only the declared outcome for CA-R-1094, and the invalid or stale path fails explicitly without an unauthorized mutation, widened scope, or invented provenance.
