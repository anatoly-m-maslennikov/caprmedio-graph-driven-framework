+++
semantic_id = "CAPRMEDIO-SPEC-SKILLS-REQU-572--atomize-every-operator-input"
...
claim = "Every operator input in a CAPRMEDIO-governed project is classified and emitted as one or more typed atomic artifacts before its requested consequences are implemented."
version = 1
...
[[relations]]
type = "child_of"
target = "CAPRMEDIO-GOV-REQU-408--atomized-transactional-state"
+++
