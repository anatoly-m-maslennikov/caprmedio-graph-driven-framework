...
relations:
  method_for:
    - CAPRMEDIO-FRAMEWORK-ENGINE-REQU-525--generate-active-requirement-subject-catalog
...
6. Emit one `Orphans` section after every Subject group, retain the same tier and numeric ordering inside it, and include the orphan reason without adding a fourth table column.
