...
- **Decision ID:** `CAPRMEDIO-SPEC-SKILLS-METH-055--select-the-dset-0-3-operating-shape`
- **Status:** accepted
- **Decision date:** 2026-07-15
- **Resolves Question:** `CAPRMEDIO-SPEC-SKILLS-CONC-082--which-operating-shape-should-dset-0-3-adopt`
- **Supersedes:** none
- **Superseded by:** none
- **LLM session IDs:**
...
`CAPRMEDIO-CHANGE-SKILL-001` across the repository. Fixed Contracts include local
