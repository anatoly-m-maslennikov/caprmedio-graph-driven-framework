...
relations:
  - type: evidence_for
    targets:
      - CAPRMEDIO-GOV-EVAL-032--version-artifact-classification-test-case
---
...
`CAPRMEDIO-GOV-EVAL-015--version-name-interpretability-evaluation-case` remains pending because reader interpretation is a
...
subject:
  id: "CAPRMEDIO-GOV-EVAL-032--version-artifact-classification-test-case"
