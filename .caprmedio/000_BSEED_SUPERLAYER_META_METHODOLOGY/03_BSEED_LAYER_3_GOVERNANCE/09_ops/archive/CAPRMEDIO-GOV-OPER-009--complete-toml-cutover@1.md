...
relations:
  - type: evidence_for
    targets:
      - CAPRMEDIO-GOV-EVAL-031--complete-toml-cutover-test-case
---
...
polarity: "supports"
currentness: "current"
reopen_when: "A CAPRMEDIO-owned YAML carrier or YAML frontmatter is added, a migrated carrier/reference/generated view changes, the migration implementation changes, or the subject revision changes."
subject:
  id: "CAPRMEDIO-GOV-EVAL-031--complete-toml-cutover-test-case"
  revision: "483ea2af321505f40713a73a51b3b68f327ba7f3"
  intended_use: "Support the bounded claim that all CAPRMEDIO-owned artifact carriers use TOML and the completed migration is idempotent and repository-valid."
producer:
