...
`CAPRMEDIO-REVIEW-PACKET-004` binds the current DSET `0.4` framework review to
...
schema_version: "1.0"
context:
  - "packet=CAPRMEDIO-REVIEW-PACKET-004"
...
subject:
  id: "CAPRMEDIO-GOV-METH-012--governance-constitution-and-rule-evaluation"
