...
CAPRMEDIO-controlled frontmatter keys and string values are designed for
unambiguous YAML plain-scalar storage. CAPRMEDIO-authored Markdown therefore emits
