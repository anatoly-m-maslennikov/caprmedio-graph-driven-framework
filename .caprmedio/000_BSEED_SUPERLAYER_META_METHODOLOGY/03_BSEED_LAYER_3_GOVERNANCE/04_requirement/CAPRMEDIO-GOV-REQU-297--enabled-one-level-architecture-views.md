...
Project or structural-scope view shows only its immediate enabled child scopes. Each scope view shows the functions, capabilities, or components directly beneath it.
