...
1. Accept stored priority only on Concern and action-point Plan Atoms and reject it on tier-classified `action_policy` Plan Atoms and every other Content role.
