...
Usage:
    python3 002_FRAMEWORK_ENGINE/TOOLS/migrations/normalize_project_requirement_claims.py
    python3 002_FRAMEWORK_ENGINE/TOOLS/migrations/normalize_project_requirement_claims.py --apply
