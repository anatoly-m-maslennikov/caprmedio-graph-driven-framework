...
class CommitContextTests(unittest.TestCase):
    ...
    def test_unrelated_duplicate_identity_does_not_block_logging(self) -> None:
        ...
        self.write_atom(
            ".caprmedio/000_BSEED_SUPERLAYER_META_METHODOLOGY/03_BSEED_LAYER_3_GOVERNANCE/04_requirement/CA-R-999-REQUIREMENT-BSEED_GOVERNANCE--second.md",
            version=1,
            relations={},
        )
        path = ".caprmedio/04_requirement/CA-R-002-REQUIREMENT--child.md"
    ...
    def test_relation_frontier_binds_target_content_version_and_path(self) -> None:
        ...
        moved_parent = ".caprmedio/101_PROJECT_LAYER_1_FRAMEWORK_METHODOLOGY/04_requirement/CA-R-001-REQUIREMENT--parent.md"
    ...
    def test_action_classification_matrix(self) -> None:
        ...
        moved = ".caprmedio/101_PROJECT_LAYER_1_FRAMEWORK_METHODOLOGY/04_requirement/CA-R-002-REQUIREMENT--subject.md"
        ...
        moved_updated = ".caprmedio/101_PROJECT_LAYER_1_FRAMEWORK_METHODOLOGY/04_requirement/CA-R-002-REQUIREMENT--changed.md"
