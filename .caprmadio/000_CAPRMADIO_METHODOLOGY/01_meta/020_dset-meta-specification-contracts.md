...
Atomic source: `CAPRMADIO-REQUIREMENT-META-041`.
Route-uniqueness source: `CAPRMADIO-REQUIREMENT-META-060`.
...
without explicit acceptance. Atomic source: `CAPRMADIO-REQUIREMENT-META-058`.
...
Atomic sources: `CAPRMADIO-REQUIREMENT-META-022`,
`CAPRMADIO-REQUIREMENT-META-023`, `CAPRMADIO-REQUIREMENT-META-024`, and
...
changes atomic authority. Atomic source: `CAPRMADIO-REQUIREMENT-META-054`.
...
## CAPRMADIO-CONTRACT-META-001 — Repository Work Area declaration

Atomic source: `CAPRMADIO-CONTRACT-META-001`.

| Field | Declared value |
|---|---|
| Authority | `CAPRMADIO-CONTRACT-META-001`; each adopting repository owner supplies that repository's conforming declaration |
| Source | `CAPRMADIO-REQUIREMENT-META-011` and `CAPRMADIO-CONTRACT-META-001` |
| Record version | `1.0` |
