...
`.caprmadio/caprmadio_settings.toml` selects `workflows.implement.mode = "lazy"` or `"strict"`.
...
`CAPRMADIO-RULE-SKILL-RUNS` continuity state. After host context compaction, resume
