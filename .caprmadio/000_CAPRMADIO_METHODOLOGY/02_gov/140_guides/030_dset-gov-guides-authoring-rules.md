...
12. Name new artifact IDs and files with their primary artifact type by
    ...
    `artifacts.subtype_in_names` setting in `.caprmadio/caprmadio_settings.toml`; never
...
- Never list individual atomic artifacts or anything below `.caprmadio_runtime/`.
