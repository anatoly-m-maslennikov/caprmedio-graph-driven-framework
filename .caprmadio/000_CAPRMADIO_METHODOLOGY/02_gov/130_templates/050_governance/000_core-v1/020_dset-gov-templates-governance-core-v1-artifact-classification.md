...
**Rule ID:** `CAPRMADIO-RULE-ARTIFACT-CLASSIFICATION`
...
behavior. `caprmadio_settings.toml` enables a project whitelist without repeating
route definitions. Unknown, disabled, multiply mapped, or ambiguous
classifications fail closed. Atomic sources: `CAPRMADIO-REQUIREMENT-GOV-070` and
...
`CAPRMADIO-REQUIREMENT-META-060`.
...
`CAPRMADIO-PROBLEM-GOV-008` is resolved.
...
according to meaning. Atomic source: `CAPRMADIO-REQUIREMENT-GOV-057`.
...
commits and pull requests. Atomic sources: `CAPRMADIO-REQUIREMENT-GOV-078`,
`CAPRMADIO-REQUIREMENT-GOV-080`, and `CAPRMADIO-REQUIREMENT-GOV-103`.
...
`CAPRMADIO-REQUIREMENT-META-047` and `CAPRMADIO-REQUIREMENT-META-048`.
...
without accepted aliases. Atomic sources: `CAPRMADIO-REQUIREMENT-GOV-113`,
`CAPRMADIO-REQUIREMENT-GOV-114`, and `CAPRMADIO-IMPL-GOV-009`.
...
external origin. Atomic source: `CAPRMADIO-REQUIREMENT-GOV-101`.
