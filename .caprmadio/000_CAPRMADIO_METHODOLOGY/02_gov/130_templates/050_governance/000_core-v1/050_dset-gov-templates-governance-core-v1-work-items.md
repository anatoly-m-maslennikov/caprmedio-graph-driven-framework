...
**Rule ID:** `CAPRMADIO-RULE-WORK-ITEMS`
...
Atomic sources: `CAPRMADIO-REQUIREMENT-GOV-057`,
`CAPRMADIO-REQUIREMENT-GOV-101`, and `CAPRMADIO-IMPL-GOV-009`.
...
Inquiry. Sources: `CAPRMADIO-REQUIREMENT-META-047` and
...
`CAPRMADIO-REQUIREMENT-GOV-108`, `CAPRMADIO-REQUIREMENT-GOV-113`,
...
`CAPRMADIO-DECISION-GOV-035` and `CAPRMADIO-REQUIREMENT-GOV-096`.
...
`CAPRMADIO-REQUIREMENT-GOV-065`, `CAPRMADIO-REQUIREMENT-GOV-080`, and
