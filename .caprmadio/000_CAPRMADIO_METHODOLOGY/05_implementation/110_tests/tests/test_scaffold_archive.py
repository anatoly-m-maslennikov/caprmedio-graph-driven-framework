...
class ScaffoldArchiveTests(unittest.TestCase):
    ...
    def test_new_creates_profile_without_overwrite(self) -> None:
        with temporary_directory() as raw:
            ...
            self.assertIn("CAPRMADIO-REQUIREMENT-001", manifest)
            self.assertIn("CAPRMADIO-CONTRACT-001", manifest)
    ...
    def test_new_uses_only_registered_optional_layers(self) -> None:
        with temporary_directory() as raw:
            ...
            self.assertIn("CAPRMADIO-REQUIREMENT-GOV-001", manifest)
            self.assertIn("CAPRMADIO-CONTRACT-GOV-001", manifest)
