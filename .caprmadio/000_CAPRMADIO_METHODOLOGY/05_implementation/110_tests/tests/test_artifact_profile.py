...
class ArtifactProfileTests(unittest.TestCase):
    ...
    def test_missing_hub_is_rejected(self) -> None:
        ...
        self.assertIn("CAPRMADIO-E121", self._codes(self._validate(data)))
    ...
    def test_missing_parent_is_rejected(self) -> None:
        ...
        self.assertIn("CAPRMADIO-E122", self._codes(self._validate(data)))
    ...
    def test_root_must_link_every_top_level_area(self) -> None:
        ...
        self.assertIn("CAPRMADIO-E123", self._codes(self._validate(self.registry)))
