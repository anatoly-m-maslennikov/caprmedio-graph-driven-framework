    ...
    def test_carrier_and_id_kind_mismatch_fails_closed(self) -> None:
        with temporary_directory() as raw:
            ...
            carrier = (
                ...
                / "question"
                / "CAPRMADIO-PROBLEM-GOV-001-mismatched-kind.md"
            )
            carrier.parent.mkdir(parents=True, exist_ok=True)
            carrier.write_text(
                """+++
artifact_type = "atomic_record"
artifact_id = "CAPRMADIO-ATOMIC-RECORD-TEST"
type = "question"
subtype = "opportunity"
semantic_id = "CAPRMADIO-PROBLEM-GOV-001"
status = "open"
+++
