...
TEMPLATES = ROOT / ".caprmadio/05_layer_ops/templates/release"
...
class ReleaseArtifactTests(unittest.TestCase):
    ...
    def test_dset_self_applies_type_first_release_names(self) -> None:
        expected = {
            "CAPRMADIO-VERSION-001-0-3-foundation.md": (
                "CAPRMADIO-VERSION-001",
                "version_scope",
            ),
            "CAPRMADIO-VERSION-002-0-4-self-hosted-core.md": (
                "CAPRMADIO-VERSION-002",
                "version_scope",
            ),
            "CAPRMADIO-VERSION-003-0-5-adopter-ready.md": (
                "CAPRMADIO-VERSION-003",
                "version_scope",
            ),
            "CAPRMADIO-VERSION-004-1-0-stable.md": (
                "CAPRMADIO-VERSION-004",
                "version_scope",
            ),
            "CAPRMADIO-VERSION-005-0-4-core-vertical-cut.md": (
                "CAPRMADIO-VERSION-005",
                "roadmap",
            ),
        }
        actual = {path.name for path in PLANNING.glob("CAPRMADIO-VERSION-00[1-5]-*.md")}
    ...
    def test_dset_version_sequence_covers_current_release_carriers(self) -> None:
        expected = {
            PLANNING / "CAPRMADIO-VERSION-006-0-3-1-release.md": (
                "CAPRMADIO-VERSION-006",
                "release_plan",
            ),
            PLANNING / "CAPRMADIO-VERSION-007-0-3-1-readiness.md": (
                "CAPRMADIO-VERSION-007",
                "readiness_record",
            ),
        }
        ...
        all_version_ids = [
            ...
            for path in sorted(PLANNING.glob("CAPRMADIO-VERSION-*.md"))
        ]
        self.assertEqual(
            all_version_ids,
            [f"CAPRMADIO-VERSION-{sequence:03d}" for sequence in range(1, 8)],
        )
    ...
    def test_live_release_rule_matches_distributed_template(self) -> None:
        live = ROOT / ".caprmadio/05_layer_ops/procedure-release.md"
        template = ROOT / ".caprmadio/05_layer_ops/templates/governance/core-v1/release.md"
        self.assertEqual(
