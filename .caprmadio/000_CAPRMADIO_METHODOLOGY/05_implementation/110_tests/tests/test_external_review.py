...
class ExternalReviewTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        create_review_packet(
            ROOT,
            self.packet,
            packet_id="CAPRMADIO-REVIEW-PACKET-001",
            artifacts=["README.md"],
    ...
    def test_report_envelope_accepts_free_form_body_and_stable_findings(self) -> None:
        ...
        self.assertEqual(result["finding_ids"], ["CAPRMADIO-REVIEW-FINDING-001"])
    ...
    def test_reconciliation_is_complete_explicit_and_never_authorizes_repair(
        ...
        self.assertEqual(result["reopen_proof"], ["CAPRMADIO-TEST-CASE-GOV-025"])
        self.assertFalse(result["implementation_authorized"])
    ...
    def _write_report(
        ...
        *,
        ...
        metadata = {
            ...
            "findings": [
                {
                    "id": "CAPRMADIO-REVIEW-FINDING-001",
                    "priority": priority,
