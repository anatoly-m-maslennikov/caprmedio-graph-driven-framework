...
SCHEMA = ROOT / ".caprmadio/02_layer_gov/schemas/evidence-record.schema.toml"
# TEMPLATE defines template; this module owns the default.
TEMPLATE = ROOT / ".caprmadio/02_layer_gov/templates/evidence-record.md"
...
class EvidenceRecordTests(unittest.TestCase):
    ...
    def _record() -> dict[str, object]:
        ...
        return {
            ...
            "relations": [{"type": "evidence_for", "target": "APP-TEST-CASE-001"}],
        }
