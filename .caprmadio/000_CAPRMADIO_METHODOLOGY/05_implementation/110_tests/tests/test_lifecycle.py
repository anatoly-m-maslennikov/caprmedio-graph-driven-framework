...
class LifecycleClosureTests(unittest.TestCase):
    ...
    def test_unknown_criteria_stop_until_authoritative_observation(self) -> None:
        ...
        self.assertEqual(closure["reason_code"], "CAPRMADIO-RUNTIME-CRITERIA-UNKNOWN")
    ...
    def test_mismatch_failure_and_no_progress_fail_closed(self) -> None:
        ...
        self.assertEqual(failed["reason_code"], "CAPRMADIO-RUNTIME-CHILD-FAILED")
        ...
        self.assertEqual(stopped["reason_code"], "CAPRMADIO-RUNTIME-NO-PROGRESS")
    ...
    def test_strict_implementation_allows_only_implementation_or_exact_stop(
        ...
        self.assertEqual(
            insufficient["reason_code"], "CAPRMADIO-RUNTIME-STRICT-INPUTS-INSUFFICIENT"
        )
        ...
        self.assertEqual(
            authorization["reason_code"], "CAPRMADIO-RUNTIME-AUTHORIZATION-REQUIRED"
        )
