...
## CAPRMADIO-DECISION-IMPL-001 — Model IMPL as selectable profile features
...
## CAPRMADIO-REQUIREMENT-IMPL-001 — Provide the Local Python Tools profile
...
## CAPRMADIO-REQUIREMENT-IMPL-002 — Require portable, simulatable, diagnosable tools
...
## CAPRMADIO-REQUIREMENT-IMPL-003 — Place and explain settings and constants
...
## CAPRMADIO-REQUIREMENT-IMPL-007 — Promote runtime configuration deliberately
...
## CAPRMADIO-REQUIREMENT-IMPL-008 — Implement project-wide secret exclusion
...
secrets from an ignored `.env` outside `.caprmadio`; CI and production use platform
...
## CAPRMADIO-REQUIREMENT-IMPL-009 — Resolve runtime identities and secrets by key
...
## CAPRMADIO-REQUIREMENT-IMPL-005 — Apply the Agent Skills profile
...
## CAPRMADIO-REQUIREMENT-IMPL-006 — Apply the LLM Evaluations profile
...
## CAPRMADIO-DECISION-IMPL-002 — Canonical project-health path ordering
...
bytes. This replaces `CAPRMADIO-DECISION-OPS-009`; TOOL continues to own the
observable health contract.

## CAPRMADIO-DECISION-IMPL-003 — Platform-native verification placeholders
...
`CAPRMADIO-DECISION-OPS-010`.

## CAPRMADIO-DECISION-IMPL-004 — Canonical filesystem path boundaries
...
replaces `CAPRMADIO-DECISION-OPS-011`.

## CAPRMADIO-DECISION-IMPL-005 — Deterministic temporary Git bytes
...
asserting preservation. This replaces `CAPRMADIO-DECISION-OPS-012`.
