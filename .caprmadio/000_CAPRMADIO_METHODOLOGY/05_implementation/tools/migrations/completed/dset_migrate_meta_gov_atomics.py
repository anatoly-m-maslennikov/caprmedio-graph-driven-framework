...
classifies and normalizes only ``.caprmadio/101_layer_meta`` and
``.caprmadio/102_layer_gov``. ``--check`` validates without writing; ``--apply``
...
SUBJECT_OVERRIDES = {
    **{
        f"CAPRMADIO-REQUIREMENT-META-{k:03d}": v
        for k, v in {
            3: "profile",
            4: "lifecycle",
            5: "artifact-model",
    ...
    **{
        f"CAPRMADIO-QUESTION-META-{k:03d}": v
        for k, v in {1: "profile", 2: "profile", 3: "profile", 5: "scope"}.items()
    },
    "CAPRMADIO-DECISION-GOV-004": "artifact-catalog",
    "CAPRMADIO-REQUIREMENT-GOV-031": "layout",
    "CAPRMADIO-REQUIREMENT-GOV-033": "relation-model",
    "CAPRMADIO-REQUIREMENT-GOV-046": "layout",
    "CAPRMADIO-REQUIREMENT-GOV-048": "lifecycle",
    "CAPRMADIO-REQUIREMENT-GOV-050": "lifecycle",
    "CAPRMADIO-DEFECT-GOV-002": "lifecycle",
    "CAPRMADIO-DEFECT-GOV-003": "lifecycle",
    "CAPRMADIO-GAP-GOV-001": "lifecycle",
    "CAPRMADIO-PROBLEM-GOV-001": "artifact-catalog",
    "CAPRMADIO-PROBLEM-GOV-004": "external-boundary",
    "CAPRMADIO-OPPORTUNITY-GOV-001": "assurance",
    "CAPRMADIO-QUESTION-GOV-001": "artifact-catalog",
    "CAPRMADIO-QUESTION-GOV-003": "lifecycle",
    "CAPRMADIO-QUESTION-GOV-006": "relation-model",
}
...
TITLE_OVERRIDES = {
    "CAPRMADIO-ANALYSIS-REPORT-003": ["artifact-model"],
    "CAPRMADIO-ANALYSIS-REPORT-004": ["carrier-format"],
    "CAPRMADIO-REQUIREMENT-META-028": ["authority"],
    "CAPRMADIO-REQUIREMENT-META-029": ["profile"],
    "CAPRMADIO-REQUIREMENT-META-065": ["topology"],
    "CAPRMADIO-REQUIREMENT-META-067": ["topology"],
    "CAPRMADIO-REQUIREMENT-META-069": ["artifact-model"],
    "CAPRMADIO-REQUIREMENT-META-071": ["scope"],
    "CAPRMADIO-REQUIREMENT-META-072": ["governance-surface"],
    "CAPRMADIO-CONTRACT-META-001": ["scope"],
    "CAPRMADIO-QUESTION-META-004": ["scope"],
    "CAPRMADIO-QUESTION-META-005": ["scope"],
    "CAPRMADIO-DECISION-GOV-027": ["carrier-format"],
    "CAPRMADIO-DECISION-GOV-029": ["layout"],
    "CAPRMADIO-DECISION-GOV-035": ["lifecycle"],
    "CAPRMADIO-IMPL-GOV-004": ["relation-model"],
    "CAPRMADIO-IMPL-GOV-005": ["methodology"],
    "CAPRMADIO-IMPL-GOV-006": ["provenance"],
    "CAPRMADIO-IMPL-GOV-008": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-052": ["methodology"],
    "CAPRMADIO-REQUIREMENT-GOV-057": ["external-boundary"],
    "CAPRMADIO-REQUIREMENT-GOV-070": ["lifecycle"],
    "CAPRMADIO-REQUIREMENT-GOV-078": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-096": ["provenance"],
    "CAPRMADIO-REQUIREMENT-GOV-098": ["interaction"],
    "CAPRMADIO-REQUIREMENT-GOV-101": ["relation-model"],
    "CAPRMADIO-REQUIREMENT-GOV-102": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-103": ["provenance"],
    "CAPRMADIO-REQUIREMENT-GOV-104": ["layout"],
    "CAPRMADIO-REQUIREMENT-GOV-106": ["layout"],
    "CAPRMADIO-REQUIREMENT-GOV-107": ["priority"],
    "CAPRMADIO-REQUIREMENT-GOV-108": ["lifecycle"],
    "CAPRMADIO-REQUIREMENT-GOV-109": ["interaction"],
    "CAPRMADIO-REQUIREMENT-GOV-111": ["runtime"],
    "CAPRMADIO-REQUIREMENT-GOV-112": ["lifecycle"],
    "CAPRMADIO-REQUIREMENT-GOV-114": ["subject-scope"],
    "CAPRMADIO-REQUIREMENT-GOV-116": ["carrier-format"],
    "CAPRMADIO-REQUIREMENT-GOV-120": ["lifecycle"],
    "CAPRMADIO-REQUIREMENT-GOV-121": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-122": ["subject-scope"],
    "CAPRMADIO-REQUIREMENT-GOV-123": ["carrier-format"],
    "CAPRMADIO-REQUIREMENT-GOV-124": ["subject-scope"],
    "CAPRMADIO-PROBLEM-GOV-009": ["artifact-catalog"],
    "CAPRMADIO-PROBLEM-GOV-010": ["layout"],
    "CAPRMADIO-PROBLEM-GOV-011": ["carrier-format"],
    "CAPRMADIO-PROBLEM-GOV-012": ["artifact-catalog"],
    "CAPRMADIO-QUESTION-GOV-015": ["external-boundary"],
    "CAPRMADIO-QUESTION-GOV-016": ["provenance"],
    "CAPRMADIO-QUESTION-GOV-017": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-META-041": ["artifact-model"],
    "CAPRMADIO-REQUIREMENT-META-070": ["artifact-model"],
    "CAPRMADIO-REQUIREMENT-META-001": ["artifact-model"],
    "CAPRMADIO-REQUIREMENT-META-008": ["external-boundary"],
    "CAPRMADIO-REQUIREMENT-META-017": ["artifact-model"],
    "CAPRMADIO-REQUIREMENT-META-039": ["artifact-model"],
    "CAPRMADIO-REQUIREMENT-META-040": ["artifact-model"],
    "CAPRMADIO-IMPL-GOV-001": ["methodology"],
    "CAPRMADIO-IMPL-GOV-002": ["methodology"],
    "CAPRMADIO-REQUIREMENT-GOV-105": ["subject-scope"],
    "CAPRMADIO-REQUIREMENT-GOV-113": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-115": ["settings"],
    "CAPRMADIO-DECISION-GOV-001": ["provenance"],
    "CAPRMADIO-DECISION-GOV-006": ["artifact-catalog"],
    "CAPRMADIO-DECISION-GOV-007": ["artifact-catalog"],
    "CAPRMADIO-DECISION-GOV-008": ["artifact-catalog"],
    "CAPRMADIO-DECISION-GOV-009": ["artifact-catalog"],
    "CAPRMADIO-DECISION-GOV-016": ["settings"],
    "CAPRMADIO-DECISION-GOV-017": ["settings"],
    "CAPRMADIO-DECISION-GOV-018": ["carrier-format"],
    "CAPRMADIO-DECISION-GOV-022": ["methodology"],
    "CAPRMADIO-DECISION-GOV-024": ["methodology"],
    "CAPRMADIO-DECISION-GOV-030": ["methodology"],
    "CAPRMADIO-DECISION-GOV-031": ["methodology"],
    "CAPRMADIO-DECISION-GOV-032": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-032": ["subject-scope"],
    "CAPRMADIO-REQUIREMENT-GOV-044": ["layout"],
    "CAPRMADIO-REQUIREMENT-GOV-045": ["layout"],
    "CAPRMADIO-REQUIREMENT-GOV-049": ["settings"],
    "CAPRMADIO-REQUIREMENT-GOV-054": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-055": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-064": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-071": ["subject-scope"],
    "CAPRMADIO-REQUIREMENT-GOV-072": ["lifecycle"],
    "CAPRMADIO-REQUIREMENT-GOV-087": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-089": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-090": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-091": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-092": ["settings"],
    "CAPRMADIO-REQUIREMENT-GOV-094": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-GOV-117": ["assurance"],
    "CAPRMADIO-DEFECT-GOV-006": ["assurance"],
    "CAPRMADIO-DEFECT-GOV-007": ["provenance"],
    "CAPRMADIO-PROBLEM-GOV-002": ["assurance"],
    "CAPRMADIO-PROBLEM-GOV-003": ["assurance"],
    "CAPRMADIO-QUESTION-GOV-013": ["artifact-catalog"],
    "CAPRMADIO-QUESTION-GOV-005": ["lifecycle"],
    "CAPRMADIO-QUESTION-GOV-008": ["artifact-catalog"],
    "CAPRMADIO-QUESTION-GOV-009": ["artifact-catalog"],
    "CAPRMADIO-QUESTION-GOV-011": ["artifact-catalog"],
    "CAPRMADIO-REQUIREMENT-META-048": ["artifact-model"],
    "CAPRMADIO-REQUIREMENT-META-053": ["governance-surface"],
    "CAPRMADIO-REQUIREMENT-META-032": ["governance-surface"],
    "CAPRMADIO-REQUIREMENT-GOV-077": ["artifact-catalog"],
    "CAPRMADIO-DECISION-GOV-033": ["artifact-catalog"],
}
...
def _roots(root: Path) -> tuple[tuple[str, Path], ...]:
    return (
        ("meta", root / ".caprmadio/101_layer_meta"),
        ("gov", root / ".caprmadio/102_layer_gov"),
    )
