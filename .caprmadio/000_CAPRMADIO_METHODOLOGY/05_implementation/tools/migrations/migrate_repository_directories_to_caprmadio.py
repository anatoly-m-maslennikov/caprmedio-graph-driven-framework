#!/usr/bin/env python3
"""Rename framework-owned repository paths and identifiers to CAPRMADIO.

Invocation:
    python migrate_repository_directories_to_caprmadio.py [ROOT]
    python migrate_repository_directories_to_caprmadio.py [ROOT] --apply \
        --expect-plan-digest SHA256
    python migrate_repository_directories_to_caprmadio.py [ROOT] --check
...
TARGET_GOVERNED_DIRECTORY = ".caprmadio"
TARGET_RUNTIME_DIRECTORY = ".caprmadio_runtime"
SOURCE_METHODOLOGY_DIRECTORY = "000_" + "dset" + "_methodology"
TARGET_METHODOLOGY_DIRECTORY = "000_caprmadio_methodology"
SOURCE_SETTINGS_STEM = "dset" + "_settings"
TARGET_SETTINGS_STEM = "caprmadio_settings"
...
IDENTIFIER_REPLACEMENTS = (
    (("dset" + "_root").encode(), b"caprmadio_root"),
)
...
def render_summary(plan: MigrationPlan) -> str:
    ...
    lines = [
        "CAPRMADIO repository-directory migration plan",
        f"root: {plan.root}",
