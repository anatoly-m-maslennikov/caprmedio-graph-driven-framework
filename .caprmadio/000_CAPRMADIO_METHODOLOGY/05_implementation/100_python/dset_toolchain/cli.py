    ...
    try:
        ...
        if args.command == "trace":
            ...
            if args.check:
                ...
                print(f"CAPRMADIO-E111 {path}: traceability is stale")
                return 1
            if args.write:
        ...
        if args.command == "conflict":
            ...
            if args.check_result is not None:
                ...
                if conflict_result_is_fresh(root, candidate, recorded):
                    ...
                    return 0
                print("CAPRMADIO-E165 recorded conflict result is stale")
                return 1
        ...
        if args.command == "health":
            ...
            if args.check:
                ...
                print(f"CAPRMADIO-E162 {path}: project health is stale")
                return 1
            if args.write:
        ...
        if args.command == "compile":
            ...
            if args.check:
                ...
                print(f"CAPRMADIO-E164 {path}: compilation is stale or incomplete")
                return 1
            if args.write:
        ...
        print(f"CAPRMADIO-E900: {error}", file=sys.stderr)
        return 2
    return 2
