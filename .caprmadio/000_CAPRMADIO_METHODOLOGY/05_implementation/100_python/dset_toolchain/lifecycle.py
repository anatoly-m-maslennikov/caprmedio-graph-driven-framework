    ...
    *,
    ...
    if public_entrypoint != "ca-implement":
        return {
            ...
            "reason_code": "CAPRMADIO-RUNTIME-DIRECT",
            "history": [],
            "visited_states": [],
        }
    ...
    closure = {
        ...
        "reason_code": "CAPRMADIO-RUNTIME-DECISIONS-FIRST",
        "history": [],
        "visited_states": [],
    }
...
def advance_closure(
    ...
    *,
    ...
    if workflow_id is not None and child_status != "succeeded":
        ...
        closure["reason_code"] = {
            "failed": "CAPRMADIO-RUNTIME-CHILD-FAILED",
            "stopped": "CAPRMADIO-RUNTIME-CHILD-STOPPED",
            "ambiguous": "CAPRMADIO-RUNTIME-AMBIGUOUS",
        }[child_status]
    ...
    if not progress:
        closure["status"] = "stopped"
        closure["next_workflow"] = None
        closure["reason_code"] = "CAPRMADIO-RUNTIME-NO-PROGRESS"
    else:
    ...
    if fingerprint in closure["visited_states"]:
        closure["status"] = "stopped"
        closure["next_workflow"] = None
        closure["reason_code"] = "CAPRMADIO-RUNTIME-REPEATED-STATE"
    else:
...
def _select_next(closure: dict[str, Any]) -> None:
    ...
    if criteria["decisions_reconciled"] is not True:
        _set_next(closure, "active", "decisions", "CAPRMADIO-RUNTIME-DECISIONS-FIRST")
    elif criteria["evergreen_current"] is None:
        _set_next(closure, "blocked", None, "CAPRMADIO-RUNTIME-CRITERIA-UNKNOWN")
    elif criteria["evergreen_current"] is False:
        _set_next(closure, "active", "compile", "CAPRMADIO-RUNTIME-COMPILE")
    elif criteria["proof_plan_complete"] is None:
        _set_next(closure, "blocked", None, "CAPRMADIO-RUNTIME-CRITERIA-UNKNOWN")
    elif criteria["proof_plan_complete"] is False:
        _set_next(closure, "active", "plan-proof", "CAPRMADIO-RUNTIME-PROOF-PLAN")
        ...
        _set_next(
            ...
            "active",
            "plan-implementation",
            "CAPRMADIO-RUNTIME-IMPLEMENTATION-PLAN",
        )
        ...
        _set_next(
            ...
            None,
            "CAPRMADIO-RUNTIME-AUTHORIZATION-REQUIRED",
        )
    elif criteria["implementation_complete"] is not True:
        _set_next(closure, "ready", "implement", "CAPRMADIO-RUNTIME-IMPLEMENT")
    else:
        _set_next(closure, "completed", None, "CAPRMADIO-RUNTIME-COMPLETE")
...
def _strict_closure() -> dict[str, Any]:
    ...
    closure = {
        ...
        "reason_code": "CAPRMADIO-RUNTIME-STRICT-IMPLEMENT",
        "history": [],
        "visited_states": [],
    }
    closure["visited_states"] = [_state_fingerprint(closure)]
    ...
    *,
    ...
    if _strict_inputs_insufficient(closure["criteria"]):
        _set_next(
            ...
            "stopped",
            None,
            "CAPRMADIO-RUNTIME-STRICT-INPUTS-INSUFFICIENT",
        )
        ...
        _set_next(
            ...
            "ready",
            "implement",
            "CAPRMADIO-RUNTIME-STRICT-IMPLEMENT",
        )
    else:
        raise LifecycleClosureError("an observation or completed workflow is required")
