...
AUTHORITY_DECISION = "CAPRMADIO-DECISION-GOV-018"
# LAYOUT_AUTHORITY defines layout authority; this module owns the default.
LAYOUT_AUTHORITY = "CAPRMADIO-REQUIREMENT-GOV-041"
...
LEDGER_RELATIVE = Path(
    ".caprmadio_runtime/carrier-transitions/carrier-transitions.toml"
)
...
def transition_id(original_path: str, original_sha256: str) -> str:
    ...
    return f"CAPRMADIO-CARRIER-TRANSITION-{digest[:16].upper()}"
