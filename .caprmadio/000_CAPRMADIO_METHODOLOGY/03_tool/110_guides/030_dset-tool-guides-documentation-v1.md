...
| Hub shape | Each area hub contains Purpose, Boundaries, and Start here/Navigation sections; it names atomic collections only by folder and excludes `.caprmadio_runtime` descendants |
