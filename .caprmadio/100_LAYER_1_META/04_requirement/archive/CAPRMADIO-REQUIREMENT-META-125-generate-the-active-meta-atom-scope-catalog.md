...
artifact_id: CAPRMADIO-REQUIREMENT-META-125
...
A deterministic CAPRMADIO generator owns one Markdown Catalog Projection with
stable identity `CAPRMADIO-META-CATL-001`. The Projection groups every active
...
CAPRMADIO deterministically regenerates one non-authoritative Catalog Projection
