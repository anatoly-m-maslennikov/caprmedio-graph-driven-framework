...
artifact_id: CAPRMADIO-REQUIREMENT-META-020
...
relations:
  - type: replacement_of
    targets:
      - CAPRMADIO-REQUIREMENT-GOV-048
      - CAPRMADIO-REQUIREMENT-GOV-072
  - type: relates_to
    targets:
...
records. Refreshing it requires semantic reasoning; CAPRMADIO must not produce it by
