...
artifact_id: CAPRMADIO-REQUIREMENT-META-068
...
CAPRMADIO proposes remodeling the coupled owners as horizontal scopes or features.
The operator must accept that structural change.

## Primary claim

CAPRMADIO layer dependencies form an acyclic graph in which authority and
