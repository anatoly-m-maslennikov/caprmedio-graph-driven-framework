...
artifact_id: CAPRMADIO-REQUIREMENT-META-032
...
The durable CAPRMADIO control plane contains accepted current project truth only.

- Passwords, API keys, tokens, private keys, and comparable secrets never enter
  CAPRMADIO artifacts, settings, logs, evidence, generated views, or commits.
...
The durable CAPRMADIO control plane admits only accepted current project truth, excludes secrets, remains LLM-provider agnostic, and keeps future intentions and unaccepted exploration outside current authority.
