...
artifact_id: CAPRMADIO-REQUIREMENT-META-015
...
The repository already identifies the current project. Repeating that identity in every artifact adds no scope information and implies a cross-project address that CAPRMADIO does not support.
