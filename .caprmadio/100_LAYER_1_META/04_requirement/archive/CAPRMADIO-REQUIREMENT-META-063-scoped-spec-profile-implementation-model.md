...
artifact_id: CAPRMADIO-REQUIREMENT-META-063
...
relations:
  - type: replacement_of
    targets:
      - CAPRMADIO-REQUIREMENT-META-062
  - type: relates_to
    targets:
...
CAPRMADIO classifies artifact meaning through seven Content roles:
...
For the CAPRMADIO project, the initial canonical scopes are:
...
## CAPRMADIO scope boundaries

The `tools` scope specifies CAPRMADIO toolchain capabilities, selects profiles such
...
TOOLS, SKILLS, and QA are scopes of the CAPRMADIO project rather than universal
