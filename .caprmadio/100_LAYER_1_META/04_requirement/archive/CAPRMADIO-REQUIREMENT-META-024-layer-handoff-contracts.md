...
artifact_id: CAPRMADIO-REQUIREMENT-META-024
...
CAPRMADIO must not create placeholder artifacts merely to simulate an unnecessary
handoff.

## Primary claim

Every adjacent CAPRMADIO layer boundary declares the accepted input, produced output, entry criteria, exit criteria, and failure behavior of its handoff.
