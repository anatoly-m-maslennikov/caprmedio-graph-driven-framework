...
GOV may register generated Projection vocabularies. Correct interpretation of
an Atom must never depend on wording present only in a Projection, and a
candidate displayed in a generated planning view must never be interpreted as
an Atom merely because it appears there.

Concern and Analysis Atoms inform normative work, the native Implementation
realizes it, and the future Ops Atom vocabulary may record enacted operation or
factual results once governed. These roles may appear in role-appropriate
Projections but do not become normative merely because a Projection groups them
with the distributed specification.
