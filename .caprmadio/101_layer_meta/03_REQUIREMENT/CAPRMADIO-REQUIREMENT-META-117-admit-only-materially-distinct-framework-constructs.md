...
artifact_id: CAPRMADIO-REQUIREMENT-META-117
...
Before CAPRMADIO admits a new Artifact Type, subtype, relation kind, semantic
...
CAPRMADIO admits a durable framework construct only when existing composition
causes material semantic loss and the addition has a sharp, action-facing
boundary.

## Rationale

This adapts FPF Ontological Parsimony to CAPRMADIO's artifact, relation, scope,
