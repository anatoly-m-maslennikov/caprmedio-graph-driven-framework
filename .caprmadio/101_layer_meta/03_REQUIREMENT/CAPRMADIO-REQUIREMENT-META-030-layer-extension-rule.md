...
A proposed CAPRMADIO layer is admitted only when it has one non-overlapping responsibility, explicit predecessor and successor handoffs, and preserves the acyclic layer graph.
