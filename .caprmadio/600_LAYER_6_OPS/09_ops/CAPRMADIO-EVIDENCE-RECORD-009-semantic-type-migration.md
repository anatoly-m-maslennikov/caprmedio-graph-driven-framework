...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-009"
...
- **Claim:** DSET executes one flat four-Type semantic model for native atoms
  ...
  carriers.
- **Intended use:** Support `CAPRMADIO-DECISION-GOV-008`,
  `CAPRMADIO-REQUIREMENT-GOV-027`, `CAPRMADIO-INVARIANT-GOV-004`,
  `CAPRMADIO-INVARIANT-GOV-017`, `CAPRMADIO-TEST-CASE-GOV-027`, and
  `CAPRMADIO-TASK-GOV-049`.
...
| Fail closed | `CAPRMADIO-E166` rejects ID-kind/carrier mismatch; nested, invalid, and QA-without-subtype native atoms remain rejected | Pass |
