...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-004"
...
- **Intended use:** Support `CAPRMADIO-REQUIREMENT-SKILL-010`,
  `CAPRMADIO-INVARIANT-SKILL-009`, `CAPRMADIO-TEST-CASE-SKILL-012`, and
  `CAPRMADIO-TASK-SKILL-024`.
...
- **Unsupported uses:** this proof does not claim that every host exposes full
  ...
  `CAPRMADIO-EVALUATION-CASE-SKILL-010` has run.
...
The prior `CAPRMADIO-DECISION-SKILL-002` remains immutable historical authority for
the public 16-skill topology. `CAPRMADIO-REQUIREMENT-SKILL-010` explicitly replaces
