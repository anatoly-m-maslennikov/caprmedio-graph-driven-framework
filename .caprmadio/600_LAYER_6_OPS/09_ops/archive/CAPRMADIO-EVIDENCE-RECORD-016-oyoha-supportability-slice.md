...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-016"
priority = "high"
version = 1
...
`OYOHA-DECISION-OPS-001`, and `OYOHA-TEST-CASE-OPS-002`; compiled them into its OPS
...
Roadmap task `CAPRMADIO-TASK-OPS-017` is complete as a contract-and-first-slice
