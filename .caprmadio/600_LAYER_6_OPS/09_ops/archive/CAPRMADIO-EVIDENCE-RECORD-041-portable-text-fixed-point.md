...
evidence_location = "dset/scopes/skill/changes/make-dset-self-hosting-and-skills-thin/proofs/CAPRMADIO-EVIDENCE-RECORD-041-portable-text-fixed-point.md"
polarity = "supports"
currentness = "current"
...
[subject]
id = "CAPRMADIO-TEST-CASE-OPS-017"
...
[[relations]]
type = "evidence_for"
target = "CAPRMADIO-TEST-CASE-OPS-017"
+++
...
point. It does not close `CAPRMADIO-TASK-TOOL-036`: fresh hosted Linux, macOS, native
