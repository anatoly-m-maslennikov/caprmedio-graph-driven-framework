...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-015"
priority = "high"
child_of = ["CAPRMADIO-EVALUATION-CASE-TOOL-003"]
version = 1
...
`CAPRMADIO-EVALUATION-CASE-TOOL-003`; it does not promote the candidate.
...
2. Ran `dset init` as a no-write preview, then executed it only in a disposable
   copy. The first executable attempt exposed `CAPRMADIO-PROBLEM-TOOL-006`; after
...
fields. See
[`CAPRMADIO-ANALYSIS-REPORT-001`](../CAPRMADIO-ANALYSIS-REPORT-001-clean-upstream-typescript-boundary.md).
