...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-001"
...
- **Intended use:** Support `CAPRMADIO-DECISION-GOV-009`,
  `CAPRMADIO-DECISION-OPS-004`, `CAPRMADIO-REQUIREMENT-GOV-029..031`,
  `CAPRMADIO-REQUIREMENT-OPS-013`, and `CAPRMADIO-TASK-GOV-051..053`.
...
The qualitative `CAPRMADIO-EVALUATION-CASE-GOV-019..021` and `CAPRMADIO-EVALUATION-CASE-OPS-010` runs remain
...
event. `CAPRMADIO-TASK-GOV-049` remains open for the broader four-Type runtime and
