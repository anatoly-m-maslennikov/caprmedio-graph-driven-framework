...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-007"
child_of = ["CAPRMADIO-REQUIREMENT-SKILL-010"]
...
- **Intended use:** Replace the earlier static wrapper/rule evidence for
  `CAPRMADIO-REQUIREMENT-SKILL-010`, `CAPRMADIO-TEST-CASE-SKILL-012`, and
  `CAPRMADIO-TASK-SKILL-024` with executable runtime evidence.
...
- **Unsupported uses:** this proof does not claim native-host usefulness,
  qualitative `CAPRMADIO-EVALUATION-CASE-SKILL-010`, automatic judgment of plan completeness,
...
| Observable progress | Each successful workflow owns one criterion transition; an unchanged observation stops with `CAPRMADIO-RUNTIME-NO-PROGRESS` | Pass |
...
The older `CAPRMADIO-EVIDENCE-RECORD-004` remains immutable evidence of the static
