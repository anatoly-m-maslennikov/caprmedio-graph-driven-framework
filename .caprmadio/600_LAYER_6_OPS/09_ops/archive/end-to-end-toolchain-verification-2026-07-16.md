...
- **Intended use:** Support `CAPRMADIO-DECISION-SKILL-001`, close the local
  implementation portion of `CAPRMADIO-TASK-TOOL-010`, and bound the remaining
  evidence work under `CAPRMADIO-TASK-SKILL-020`, `CAPRMADIO-TASK-TOOL-036`, and
  `CAPRMADIO-TASK-OPS-025`.
- **LLM session IDs:**
