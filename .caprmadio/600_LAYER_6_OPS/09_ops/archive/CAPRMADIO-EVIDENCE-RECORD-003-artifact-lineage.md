...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-003"
child_of = ["CAPRMADIO-REQUIREMENT-GOV-034"]
version = 1
...
- **Intended use:** Support `CAPRMADIO-REQUIREMENT-GOV-034`,
  `CAPRMADIO-INVARIANT-GOV-024`, `CAPRMADIO-TEST-CASE-GOV-034`, and
  `CAPRMADIO-TASK-GOV-056`.
...
- **Unsupported uses:** this proof does not claim that every historical DSET
  ...
  rendered as graph nodes, or that qualitative `CAPRMADIO-EVALUATION-CASE-GOV-024` has run.
...
| Immutability | `CAPRMADIO-REQUIREMENT-GOV-033` was not edited to register its new child | Pass |
| Failure matrix | Scalar, empty, duplicate, unresolved, self, cyclic, and authored-reverse relations fail | Pass |
| Recursive application | `CAPRMADIO-REQUIREMENT-GOV-034` is a child of `CAPRMADIO-REQUIREMENT-GOV-033`; the generated reverse edge is current | Pass |
