...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-006"
child_of = ["CAPRMADIO-REQUIREMENT-GOV-035"]
version = 1
...
- **Intended use:** Support `CAPRMADIO-REQUIREMENT-GOV-035`,
  `CAPRMADIO-TEST-CASE-GOV-035`, and `CAPRMADIO-TASK-GOV-058`.
...
- **Unsupported uses:** this proof does not claim the independent qualitative
  `CAPRMADIO-EVALUATION-CASE-GOV-025`, operator acceptance of any proposed promotion, or that a
