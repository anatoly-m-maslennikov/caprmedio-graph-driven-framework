...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-008"
version = 1
...
- **Intended use:** Support `CAPRMADIO-DECISION-GOV-003`,
  `CAPRMADIO-DECISION-GOV-010`, `CAPRMADIO-REQUIREMENT-GOV-020`,
  `CAPRMADIO-REQUIREMENT-GOV-026`, `CAPRMADIO-REQUIREMENT-TOOL-019`,
  `CAPRMADIO-TEST-CASE-GOV-026`, and `CAPRMADIO-TEST-CASE-TOOL-019`.
