...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-002"
version = 1
...
- **Claim:** DSET defines and recursively applies narrowest-common-scope
  ...
  child-owned detail.
- **Intended use:** Support `CAPRMADIO-REQUIREMENT-GOV-032`,
  `CAPRMADIO-INVARIANT-GOV-022`, `CAPRMADIO-TEST-CASE-GOV-032`, and
  `CAPRMADIO-TASK-GOV-054`.
...
|---|---|---|
| Atomic authority | Immutable `CAPRMADIO-ATOMIC-RECORD-003` owns accepted `CAPRMADIO-REQUIREMENT-GOV-032` with session provenance and rationale | Pass |
...
`CAPRMADIO-EVALUATION-CASE-GOV-022` reviewer-placement run also remains pending.
