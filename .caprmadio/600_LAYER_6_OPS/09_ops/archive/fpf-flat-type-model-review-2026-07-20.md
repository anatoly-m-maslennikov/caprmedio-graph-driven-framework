...
- **Intended use:** Support `CAPRMADIO-DECISION-GOV-008` and the compiled
  `CAPRMADIO-REQUIREMENT-GOV-027`; not claim FPF conformance or completed runtime
  enforcement.
...
- **Unsupported uses:** this proof does not import FPF ontology, identifiers,
  ...
  prove semantic equivalence; or close `CAPRMADIO-PROBLEM-GOV-007` and
...
The qualitative `CAPRMADIO-EVALUATION-CASE-GOV-017` reviewer-agreement run remains a separate
