...
- **Producer/performed work:** One independent high-effort FPF comparison review
  plus main-thread reconciliation into CAPRMADIO-owned rules, templates, schemas, and
  provenance.
- **Method/setup:** Compare DSET governance and Change templates against the
  ...
  partial, distorted, missing, or overclaimed; correct only CAPRMADIO-owned artifacts.
...
## Adopted CAPRMADIO-native principles
...
`CAPRMADIO-QUESTION-META-004..005` and `CAPRMADIO-QUESTION-GOV-004..005` remain open in
