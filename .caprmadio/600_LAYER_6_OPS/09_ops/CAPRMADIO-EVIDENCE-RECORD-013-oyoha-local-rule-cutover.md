...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-013"
priority = "high"
...
evidence for `CAPRMADIO-REQUIREMENT-SKILL-011`; the accepted compatibility Test
mappings remain `CAPRMADIO-TEST-CASE-SKILL-010` and `CAPRMADIO-TEST-CASE-GOV-017`.
