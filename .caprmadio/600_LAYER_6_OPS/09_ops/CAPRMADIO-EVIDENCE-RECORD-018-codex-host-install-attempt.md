...
artifact_id = "CAPRMADIO-EVIDENCE-RECORD-018"
priority = "high"
...
tests the real Codex installation boundary for `CAPRMADIO-CONTRACT-SKILL-001` and
`CAPRMADIO-TEST-CASE-SKILL-011`. It may support only the current blocked disposition; it
