...
artifact_id = "CAPRMADIO-VERSION-006"
...
- **Release-owning Change:** `CAPRMADIO-CHANGE-SKILL-001`
- **Participating Changes:** `CAPRMADIO-CHANGE-SKILL-001`

## Included scope

Deliver the DSET 0.3 foundation represented by `CAPRMADIO-VERSION-001` and
