...
- **Resolves Question:** follow-up operator clarification of
  `CAPRMADIO-QUESTION-GOV-003`
- **Absorbs:** `CAPRMADIO-DECISION-OPS-001` in full
...
`CAPRMADIO-DECISION-OPS-001`, now as Version Scopes:
...
- **Known counter-evidence:** schema, initializer, validator, overview, and
  release CLI enforcement remain open under `CAPRMADIO-PROBLEM-OPS-002`
