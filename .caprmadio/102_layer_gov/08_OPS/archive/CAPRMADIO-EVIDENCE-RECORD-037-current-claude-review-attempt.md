...
artifact_id: CAPRMADIO-EVIDENCE-RECORD-037
...
`CAPRMADIO-REVIEW-PACKET-004` binds the current DSET `0.4` framework review to
...
schema_version: "1.0"
context:
  - "packet=CAPRMADIO-REVIEW-PACKET-004"
