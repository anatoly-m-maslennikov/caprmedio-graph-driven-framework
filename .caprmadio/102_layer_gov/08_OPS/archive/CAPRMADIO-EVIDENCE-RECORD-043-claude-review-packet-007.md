...
artifact_id: CAPRMADIO-EVIDENCE-RECORD-043
...
`CAPRMADIO-REVIEW-PACKET-007` binds the repaired pull-request fixed-point candidate
...
`CAPRMADIO-TASK-GOV-044` remains open.
...
schema_version: "1.0"
context:
  - "packet=CAPRMADIO-REVIEW-PACKET-007"
