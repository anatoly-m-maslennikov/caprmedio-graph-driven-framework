...
artifact_id: CAPRMADIO-REQUIREMENT-GOV-044
...
1. `.caprmadio/01_layer_meta/` — framework identity, semantic foundations, and
   authoring contracts;
2. `.caprmadio/02_layer_gov/` — governance, schemas, registries, and templates;
3. `.caprmadio/03_layer_tool/` — executable toolchain and validation behavior;
4. `.caprmadio/04_layer_skill/` — agent-facing wrappers and orchestration; and
5. `.caprmadio/05_layer_ops/` — delivery, release, and supportability.
