...
artifact_id: CAPRMADIO-IMPL-GOV-004
...
relations:
  - type: replacement_of
    targets:
      - CAPRMADIO-DECISION-GOV-013
  - type: resolution_of
    targets:
      - CAPRMADIO-DEFECT-TOOL-002
      - CAPRMADIO-DEFECT-TOOL-003
---

# Technical Decision — Use the canonical artifact relations

CAPRMADIO uses exactly these general forward artifact relations:
...
CAPRMADIO uses twelve precise forward relations with derived inverses, exclusive
