...
artifact_id: CAPRMADIO-DECISION-GOV-019
...
This Decision completely replaces `CAPRMADIO-DECISION-GOV-012` and is the
classification sibling of `CAPRMADIO-DECISION-OPS-007`, which owns the unchanged
