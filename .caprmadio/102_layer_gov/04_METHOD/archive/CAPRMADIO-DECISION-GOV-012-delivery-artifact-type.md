...
artifact_id: CAPRMADIO-DECISION-GOV-012
...
This Decision absorbs `CAPRMADIO-DECISION-GOV-011` in full and, transitively, its
absorbed `CAPRMADIO-DECISION-GOV-009` predecessor. It preserves the complete catalog
and all consequences of `CAPRMADIO-DECISION-GOV-011` while removing the invalid
