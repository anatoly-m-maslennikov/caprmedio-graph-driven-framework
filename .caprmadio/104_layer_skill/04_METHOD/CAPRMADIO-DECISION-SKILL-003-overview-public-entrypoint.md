+++
artifact_id = "CAPRMADIO-ATOMIC-RECORD-081"
semantic_id = "CAPRMADIO-DECISION-SKILL-003"
...
[[relations]]
type = "replacement_of"
target = "CAPRMADIO-DECISION-SKILL-002"
+++
...
forward from `CAPRMADIO-DECISION-SKILL-002`: the catch-all `dset`, two bounded
...
of `CAPRMADIO-DECISION-SKILL-002` while retaining its sixteen lifecycle entrypoints.
