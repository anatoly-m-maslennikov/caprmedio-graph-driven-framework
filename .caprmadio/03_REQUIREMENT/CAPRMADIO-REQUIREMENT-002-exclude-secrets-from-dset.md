+++
artifact_id = "CAPRMADIO-ATOMIC-RECORD-199"
semantic_id = "CAPRMADIO-REQUIREMENT-002"
...
`.env` file outside `.caprmadio`. Every real `.env` variant is ignored by Git and is
