...
artifact_id: CAPRMADIO-DECISION-GOV-008
...
`CAPRMADIO-PROBLEM-GOV-007` and `CAPRMADIO-TASK-GOV-049` remain open. Their schema and
runtime migration must now enforce both the flat model and these recognition
boundaries without editing legacy atoms. Existing `CAPRMADIO-DECISION-GOV-007`
