...
artifact_id: CAPRMADIO-DECISION-GOV-001
...
- `dset/scopes/gov/specs/packages/methodology/spec.md`
  - `CAPRMADIO-REQUIREMENT-GOV-020`
  - `CAPRMADIO-REQUIREMENT-GOV-021`
  - `CAPRMADIO-REQUIREMENT-GOV-022`
...
- **Confirmation evidence:** this Change adds the Decision, compiles its
  ...
  commit with `Implements: CAPRMADIO-DECISION-GOV-001`.
