...
artifact_id: CAPRMADIO-DECISION-GOV-003
...
- **Replaces claims:** the `CAPRMADIO-DECISION-GOV-001` claim that evergreen files
  own current truth and the `CAPRMADIO-DECISION-GOV-002` claim that governing
...
- `CAPRMADIO-REQUIREMENT-GOV-020..021` and `CAPRMADIO-INVARIANT-GOV-016` for atomic
  sources, compiled projections, immutability, absorption, and retirement;
- `CAPRMADIO-REQUIREMENT-GOV-024..026` and `CAPRMADIO-INVARIANT-GOV-013..015` for health,
  external review, universal priority, and conflict governance;
- `CAPRMADIO-REQUIREMENT-TOOL-018..019` and
  `CAPRMADIO-INVARIANT-TOOL-004..005` for planned deterministic rendering and
  pairwise conflict disposition;
- the accepted GOV/TOOL test and evaluation cases;
- `CAPRMADIO-RULE-ARCHITECTURE` and `CAPRMADIO-RULE-ARTIFACT-MAINTENANCE`; and
