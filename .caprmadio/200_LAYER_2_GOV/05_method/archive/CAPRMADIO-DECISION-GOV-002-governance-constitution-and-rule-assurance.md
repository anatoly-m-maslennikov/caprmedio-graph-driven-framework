...
artifact_id: CAPRMADIO-DECISION-GOV-002
...
- **Selected option:** strengthen `CAPRMADIO-RULE-ARCHITECTURE` as the sole governance constitution and separate rule authority, dependency, precedence, and assurance
...
candidate review considered a new `CAPRMADIO-RULE-RULE-AUTHORITY`, a new
`CAPRMADIO-RULE-GOVERNANCE-OF-GOVERNANCE`, and an extension of the existing
...
- a new sibling root would duplicate `CAPRMADIO-RULE-ARCHITECTURE` and complicate
...
- `CAPRMADIO-REQUIREMENT-GOV-023` and `CAPRMADIO-INVARIANT-GOV-012`;
- `CAPRMADIO-TEST-CASE-GOV-023` and `CAPRMADIO-EVALUATION-CASE-GOV-013`;
