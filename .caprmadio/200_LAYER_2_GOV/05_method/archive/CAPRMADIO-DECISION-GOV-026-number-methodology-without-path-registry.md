...
artifact_id: CAPRMADIO-DECISION-GOV-026
...
project's `.caprmadio` tree and require exactly one matching identity or unique
carrier name.
...
Every committed file and directory below .caprmadio/000_caprmadio_methodology uses a stable numeric prefix within its parent, and deterministic materialization derives those names without a durable source-to-carrier path registry.
