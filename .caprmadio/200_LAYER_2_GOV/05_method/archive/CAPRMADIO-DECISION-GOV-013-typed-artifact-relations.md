...
artifact_id: CAPRMADIO-DECISION-GOV-013
...
This Decision completely replaces `CAPRMADIO-REQUIREMENT-GOV-033` and
`CAPRMADIO-REQUIREMENT-GOV-034`, and resolves `CAPRMADIO-QUESTION-GOV-004`.
