...
artifact_id: CAPRMADIO-EVIDENCE-RECORD-024
...
relations:
  ...
  - type: relates_to
    targets:
      - CAPRMADIO-DEFECT-TOOL-002
      - CAPRMADIO-EVIDENCE-RECORD-023
---
...
`CAPRMADIO-DECISION-GOV-013`, resolved Problem `CAPRMADIO-DEFECT-TOOL-002`, and
deterministic Test `CAPRMADIO-TEST-CASE-GOV-036`.
...
qualitative Evaluation `CAPRMADIO-EVALUATION-CASE-GOV-026`, hosted CI, release
