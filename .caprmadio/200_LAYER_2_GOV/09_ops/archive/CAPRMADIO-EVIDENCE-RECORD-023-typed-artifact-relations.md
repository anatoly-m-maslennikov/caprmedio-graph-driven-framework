...
artifact_id: CAPRMADIO-EVIDENCE-RECORD-023
...
`CAPRMADIO-DECISION-GOV-013` and deterministic Test `CAPRMADIO-TEST-CASE-GOV-036`.
This evidence supports the local executable relation contract only. It does
not satisfy qualitative Evaluation `CAPRMADIO-EVALUATION-CASE-GOV-026`, hosted CI,
...
`CAPRMADIO-SPECIFICATION-001`: Decision authority through atom carrier 035,
