...
artifact_id: CAPRMADIO-EVIDENCE-RECORD-046
...
- committed governance and control truth under `.caprmadio/`;
- ignored resumable machine-local state under `.caprmadio_runtime/`;
...
interpretation remains separate under `CAPRMADIO-EVALUATION-CASE-GOV-032`.
...
polarity: "supports"
currentness: "current"
reopen_when: "The .caprmadio control boundary, .caprmadio_runtime storage boundary, temporary-directory helper, bootstrap/self-host lifecycle, atomic-publication mechanism, migration, ignore rules, or configured verification commands change."
subject:
  id: "CAPRMADIO-TEST-CASE-GOV-048"
