...
artifact_id: CAPRMADIO-TEST-CASE-GOV-039
...
relations:
  - type: check_of
    targets:
      - CAPRMADIO-REQUIREMENT-GOV-038
      - CAPRMADIO-REQUIREMENT-GOV-039
      - CAPRMADIO-REQUIREMENT-SKILL-013
---
...
`workflows.implement.mode` in root `caprmadio_settings.toml`.
