...
artifact_id: CAPRMADIO-TEST-CASE-GOV-046
...
# Test Case — Verify the slim project control layout
...
1. current discovery selects only `dset/caprmadio_settings.toml` and schema 1.3;
