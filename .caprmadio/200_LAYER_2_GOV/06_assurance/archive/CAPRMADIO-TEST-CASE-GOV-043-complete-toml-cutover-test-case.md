...
artifact_id: CAPRMADIO-TEST-CASE-GOV-043
...
Deterministic tests prove complete lossless TOML cutover of every CAPRMADIO-owned YAML artifact and Markdown YAML-frontmatter carrier with reference closure, rollback parity, and second-run idempotency.
