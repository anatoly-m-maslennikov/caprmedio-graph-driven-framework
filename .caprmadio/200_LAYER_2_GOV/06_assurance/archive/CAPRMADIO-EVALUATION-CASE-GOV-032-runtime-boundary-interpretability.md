...
artifact_id: CAPRMADIO-EVALUATION-CASE-GOV-032
...
relations:
  ...
  - type: replacement_of
    targets:
      - CAPRMADIO-EVALUATION-CASE-GOV-031
---
...
- `.caprmadio/` as committed project control truth;
- `.caprmadio_runtime/` as ignored but resumable project-local operational state;
