...
artifact_id: CAPRMADIO-REQUIREMENT-GOV-038
...
New artifact names use the primary artifact type by default and the optional subtype only when artifacts.subtype_in_names is enabled in caprmadio_settings.toml.
