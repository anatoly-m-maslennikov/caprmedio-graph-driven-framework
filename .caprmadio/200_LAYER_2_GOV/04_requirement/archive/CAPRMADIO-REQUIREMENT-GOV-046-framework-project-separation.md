...
artifact_id: CAPRMADIO-REQUIREMENT-GOV-046
...
`.caprmadio/` contains only current, distributable DSET framework material plus the
...
A DSET framework repository separates the distributable framework surface under .caprmadio from the repository's recursive self-hosting project artifacts at the repository root.
