...
artifact_id: CAPRMADIO-REQUIREMENT-GOV-041
...
- `dset/caprmadio_settings.toml` — the only writable settings and project-manifest
  carrier;
...
A current DSET project uses one documented dset/caprmadio_settings.toml for settings and manifest facts, dset/project for project-wide truth and records, dset/versions for Version lifecycle artifacts, and direct dset/<layer> roots for layer-owned truth.
