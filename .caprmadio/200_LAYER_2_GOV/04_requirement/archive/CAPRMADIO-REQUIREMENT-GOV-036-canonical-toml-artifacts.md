...
artifact_id: CAPRMADIO-REQUIREMENT-GOV-036
...
CAPRMADIO-owned structured artifact files must use TOML. Markdown artifacts remain
...
TOML is the canonical encoding for CAPRMADIO-owned structured artifacts and DSET Markdown frontmatter, with explicit generated or host-mandated format boundaries.

## Rationale

TOML makes configuration and artifact metadata easier to scan and removes indentation-dependent authority from CAPRMADIO-owned structured files.
