...
artifact_id: CAPRMADIO-REQUIREMENT-GOV-119
...
```text
CAPRMADIO-GOV-REQU-001--github-compatible-artifacts.md
CAPRMADIO-GOV-QACS-002-EVAL-CASE--relation-interpretability.md
CAPRMADIO-TOOL-TDEC-001--use-project-local-resolver.md
CAPRMADIO-TOOL-IDEC-001--connect-cli-to-governance.md
CAPRMADIO-GOV-EVRC-001--structural-validation-result.md
CAPRMADIO-META-SPEC-001--atomic-artifact-domain.md
```

The corresponding stable IDs are `CAPRMADIO-GOV-REQU-001`,
`CAPRMADIO-GOV-QACS-002`, `CAPRMADIO-TOOL-TDEC-001`, `CAPRMADIO-TOOL-IDEC-001`, and
`CAPRMADIO-GOV-EVRC-001`. The maintained Specification identity is
`CAPRMADIO-META-SPEC-001`.
