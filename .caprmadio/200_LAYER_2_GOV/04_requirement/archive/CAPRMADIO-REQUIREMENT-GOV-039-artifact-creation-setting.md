...
artifact_id: CAPRMADIO-REQUIREMENT-GOV-039
...
relations:
  ...
  - type: replacement_of
    targets:
      - CAPRMADIO-REQUIREMENT-GOV-035
---

# Requirement — Select artifact-creation strictness in canonical settings

Root `caprmadio_settings.toml` selects `medium` or `high` through
...
Atomic-artifact admission uses medium or high strictness selected by artifacts.creation_strictness in caprmadio_settings.toml.
