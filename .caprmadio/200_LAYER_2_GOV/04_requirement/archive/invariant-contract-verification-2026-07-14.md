...
> owners were superseded by schema 1.2 layer-owned `CAPRMADIO-*` truth, so this file
...
- Roadmap invariants: `CAPRMADIO-INVARIANT-TOOL-001..002`, `CAPRMADIO-INVARIANT-GOV-001..004`, `CAPRMADIO-INVARIANT-SKILL-001..002`, and `CAPRMADIO-INVARIANT-META-001`
- Candidate change requirements: `CAPRMADIO-REQUIREMENT-TOOL-006..007`, `CAPRMADIO-REQUIREMENT-GOV-007..010`, `CAPRMADIO-REQUIREMENT-SKILL-002..003`, and `CAPRMADIO-REQUIREMENT-META-005`
- Candidate deterministic proof: `CAPRMADIO-TEST-CASE-TOOL-009..011`, `CAPRMADIO-TEST-CASE-GOV-009..011`, `CAPRMADIO-TEST-CASE-SKILL-002..003`, and `CAPRMADIO-TEST-CASE-META-004`
- Candidate qualitative proof: `CAPRMADIO-EVALUATION-CASE-TOOL-001..002`, `CAPRMADIO-EVALUATION-CASE-SKILL-002`, and `CAPRMADIO-EVALUATION-CASE-GOV-009`
...
- Candidate accepted qualitative proof: `METH-EVALUATION-CASE-015`–`METH-EVALUATION-CASE-018`
...
The invariant contract is internally consistent and ready to govern later 0.2 implementation batches. `CAPRMADIO-TEST-CASE-TOOL-009..011`, `CAPRMADIO-TEST-CASE-GOV-009..011`, `CAPRMADIO-TEST-CASE-SKILL-002..003`, `CAPRMADIO-TEST-CASE-META-004`, `CAPRMADIO-EVALUATION-CASE-TOOL-001..002`, `CAPRMADIO-EVALUATION-CASE-SKILL-002`, and `CAPRMADIO-EVALUATION-CASE-GOV-009` remain planned proof obligations and must not be marked passing until their corresponding mechanics and fixtures exist.
