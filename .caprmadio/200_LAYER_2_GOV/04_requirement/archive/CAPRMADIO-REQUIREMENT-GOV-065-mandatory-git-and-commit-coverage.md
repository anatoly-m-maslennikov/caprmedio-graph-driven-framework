...
artifact_id: CAPRMADIO-REQUIREMENT-GOV-065
...
Git is mandatory for every CAPRMADIO-managed project.
...
Every CAPRMADIO-managed project uses Git, dset-init requires an existing enclosing repository or initializes one, and every implemented Decision or resolved Problem has at least one committed change that names the governed artifact.
