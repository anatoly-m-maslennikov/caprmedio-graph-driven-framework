...
artifact_id: CAPRMADIO-REQUIREMENT-GOV-112
...
relations:
  replacement_of:
    - CAPRMADIO-REQUIREMENT-GOV-039-artifact-creation-setting
  relates_to:
...
At medium strictness, CAPRMADIO requires accepted authority, one primary claim, one
...
At high strictness, CAPRMADIO stops before emission while any material authority,
