...
|---|---|---|
| Repository rule authority | `CAPRMADIO-REQUIREMENT-GOV-014`, `CAPRMADIO-REQUIREMENT-GOV-017`; `CAPRMADIO-TEST-CASE-GOV-014`, `CAPRMADIO-TEST-CASE-GOV-017`; `CAPRMADIO-EVALUATION-CASE-GOV-007` | Local paths, one editable owner per rule ID, no remote live authority |
| Thin adaptive wrappers | `CAPRMADIO-REQUIREMENT-SKILL-002`, `CAPRMADIO-REQUIREMENT-SKILL-003`; `CAPRMADIO-TEST-CASE-SKILL-002`, `CAPRMADIO-TEST-CASE-SKILL-003`; `CAPRMADIO-EVALUATION-CASE-SKILL-002`, `CAPRMADIO-EVALUATION-CASE-GOV-009` | Same wrapper hash, no embedded normative fallback |
| Bounded self-hosting | `CAPRMADIO-REQUIREMENT-OPS-003`, `CAPRMADIO-REQUIREMENT-TOOL-004`; `CAPRMADIO-TEST-CASE-OPS-003`, `CAPRMADIO-TEST-CASE-TOOL-005` | Terminates, profile-aware, framework before external pilot |
| Honest failure/customization | `CAPRMADIO-REQUIREMENT-GOV-015..016`; `CAPRMADIO-TEST-CASE-GOV-015..016`; `CAPRMADIO-EVALUATION-CASE-GOV-008..009` | Stable diagnostics, justified non-applicability, explicit custom identity |
| Separate proof | `CAPRMADIO-REQUIREMENT-META-007`; `CAPRMADIO-TEST-CASE-META-007`; all evals | Tests and evals remain different artifacts and evidence streams |
| Discoverable skill surface | `CAPRMADIO-REQUIREMENT-SKILL-004`, `CAPRMADIO-REQUIREMENT-SKILL-005`; `CAPRMADIO-TEST-CASE-SKILL-004`, `CAPRMADIO-TEST-CASE-SKILL-005`; `CAPRMADIO-EVALUATION-CASE-SKILL-003` | One catch-all entrypoint, explicit lifecycle shortcuts, no duplicated substantive rules |
| Investigable next-step routing | `CAPRMADIO-REQUIREMENT-SKILL-006`; `CAPRMADIO-TEST-CASE-SKILL-006`; `CAPRMADIO-EVALUATION-CASE-SKILL-005` | Bounded local evidence, redaction, no competing authority |
| Predictable pre-1.0 releases | `CAPRMADIO-REQUIREMENT-OPS-004`, `CAPRMADIO-REQUIREMENT-OPS-007`; `CAPRMADIO-TEST-CASE-OPS-004`, `CAPRMADIO-TEST-CASE-OPS-007`; `CAPRMADIO-EVALUATION-CASE-OPS-002` | Integer version tuple, one bump per main PR, coordinated product/package identity |
| Guarded RC/final publication | `CAPRMADIO-REQUIREMENT-OPS-005..006`; `CAPRMADIO-TEST-CASE-OPS-005..006`; `CAPRMADIO-EVALUATION-CASE-OPS-003` | PR-only main updates, fully working RC, evidence-gated 1.0 |
| Proportional delegation budget | `CAPRMADIO-REQUIREMENT-SKILL-007..008`; `CAPRMADIO-TEST-CASE-SKILL-007..008`; `CAPRMADIO-EVALUATION-CASE-SKILL-005..006` | Main model/effort inheritance, useful medium fan-out, outcome cost rather than nominal price |
| Session continuity | `CAPRMADIO-REQUIREMENT-SKILL-009`; `CAPRMADIO-TEST-CASE-SKILL-009`; `CAPRMADIO-EVALUATION-CASE-SKILL-008` | One public entrypoint, linked internal runs, bounded checkpoint recovery after compaction, and authoritative-state refresh |
| Unambiguous semantic routing | `CAPRMADIO-REQUIREMENT-GOV-018..019`; `CAPRMADIO-DECISION-GOV-034`; `CAPRMADIO-TEST-CASE-GOV-018..019`; `CAPRMADIO-EVALUATION-CASE-GOV-010..011` | Exactly four Types; one direct subtype at most; User Story is a Decision subtype; tasks and Changes remain non-Type structures; current and historical identities use one canonical verbose vocabulary without aliases |
...
| One public skill per lifecycle mode/current target | Repository/project license | Five-skill topology / direct discoverability and trigger overlap | `040_dset-skill-specification-methodology.md`; selected by `CAPRMADIO-DECISION-SKILL-002`; expanded runtime proof pending | degraded | Selected for implementation; host-native usability remains to be evaluated | Larger discovery surface; exact registry and generated checks constrain drift |
...
| Primary orchestrator plus four specialists/absorbed target | Repository/project license | One-skill and per-mode alternatives / discovery, ownership, stop boundaries | `CAPRMADIO-DECISION-SKILL-001-select-the-dset-0-3-operating-shape.md`; five wrappers implemented at the recorded commit | sufficient for historical source claim | Replaced for the public-topology claim by `CAPRMADIO-DECISION-SKILL-002` | Smaller discovery surface but indirect access to most modes |
...
The original operating shape is recorded in `CAPRMADIO-DECISION-SKILL-001`. Its
exact-five topology claim is partially replaced by `CAPRMADIO-DECISION-SKILL-002`;
its other
