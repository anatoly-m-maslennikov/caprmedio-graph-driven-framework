...
- **Decision ID:** `CAPRMADIO-DECISION-SKILL-001`
- **Status:** accepted
- **Decision date:** 2026-07-15
- **Resolves Question:** `CAPRMADIO-QUESTION-SKILL-001`
- **Supersedes:** none
- **Superseded by:** none
- **LLM session IDs:**
...
`CAPRMADIO-CHANGE-SKILL-001` across the repository. Fixed Contracts include local
