+++
artifact_id = "CAPRMADIO-ATOMIC-RECORD-053"
semantic_id = "CAPRMADIO-REQUIREMENT-SKILL-013"
...
claim = "Each project selects lazy or strict dset-implement preparation through workflows.implement.mode in caprmadio_settings.toml, with lazy as the default."
...
[[relations]]
type = "replacement_of"
target = "CAPRMADIO-REQUIREMENT-SKILL-012"
+++

# Requirement — Select implementation preparation in canonical settings

Root `caprmadio_settings.toml` selects `lazy` or `strict` through
