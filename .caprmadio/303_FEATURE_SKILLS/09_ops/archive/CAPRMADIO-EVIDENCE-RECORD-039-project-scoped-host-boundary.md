...
evidence_location = "dset/scopes/skill/changes/make-dset-self-hosting-and-skills-thin/proofs/CAPRMADIO-EVIDENCE-RECORD-039-project-scoped-host-boundary.md"
polarity = "mixed"
currentness = "current"
...
review. `CAPRMADIO-TASK-SKILL-020` and `CAPRMADIO-TASK-GOV-044` remain open.
