...
- **Decision ID:** `CAPRMADIO-DECISION-OPS-001`
- **Status:** accepted
- **Decision date:** 2026-07-20
- **Resolves Question:** `CAPRMADIO-QUESTION-GOV-003`
- **Absorbs:** none
...
- `CAPRMADIO-RULE-RELEASE` must own these role boundaries and stop when a
