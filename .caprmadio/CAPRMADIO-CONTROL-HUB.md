# Project-local CAPRMADIO control plane

## Purpose

Own the target repository's settings, installed methodology, and applied CAPRMADIO
artifacts. Skills search only this `.caprmadio` control root and resolve unique
