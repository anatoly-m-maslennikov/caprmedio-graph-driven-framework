...
- **Intended use:** Support `CAPRMADIO-REQUIREMENT-SKILL-011`,
  `CAPRMADIO-TEST-CASE-SKILL-013`, and `CAPRMADIO-TASK-SKILL-057`.
...
- **Unsupported uses:** this proof does not claim a real authenticated
  Codex/Claude inference, qualitative `CAPRMADIO-EVALUATION-CASE-SKILL-011`, or successful
...
remain separately owned by `CAPRMADIO-TASK-SKILL-020` and
`CAPRMADIO-TASK-TOOL-036`; they are not inferred from these deterministic fixtures.
