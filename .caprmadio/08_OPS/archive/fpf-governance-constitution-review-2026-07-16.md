...
- **Intended use:** Support `CAPRMADIO-DECISION-GOV-002` and review the bounded GOV
...
|---|---|---|
| One canonical authority | Supported | Keep `CAPRMADIO-RULE-ARCHITECTURE` as the sole dependency-free root instead of creating a sibling authority rule. |
