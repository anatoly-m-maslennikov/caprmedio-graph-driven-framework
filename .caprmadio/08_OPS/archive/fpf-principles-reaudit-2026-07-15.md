...
- **Performed work/deviations:** The reviewer found that the active Solution
  ...
  authorized CAPRMADIO-owned governance, template, active-Change, provenance, notice,
...
| Decision lifecycle and discharge | Pass after correction | A neutral template records status/date/evidence/supersession/reopen/retained/withdrawn/successor fields; `CAPRMADIO-DECISION-SKILL-001` self-applies it while normative truth remains with owning artifacts. |
