...
artifact_id: CAPRMADIO-REQUIREMENT-IMPL-010
...
relations:
  - type: child_of
    targets:
      - CAPRMADIO-REQUIREMENT-IMPL-001
  - type: relates_to
    targets:
      - CAPRMADIO-REQUIREMENT-IMPL-002
      - CAPRMADIO-REQUIREMENT-IMPL-003
      - CAPRMADIO-REQUIREMENT-IMPL-004
...
Temporary transaction state belongs to `.caprmadio_runtime`; optional redacted
append-only execution logs belong to `.caprmadio_logs`. Neither location becomes
project authority.
