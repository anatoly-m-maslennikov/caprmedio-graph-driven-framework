...
relations:
  analysis_of:
    ...
    - CAPRMEDIO-REQU-006-CORE-REQUIREMENT--minimal-default-project-model
    - CAPRMEDIO-REQU-007-CORE-REQUIREMENT--full-minimal-traceability
    - CAPRMEDIO-REQU-008-REQUIREMENT--define-project-scope-boundary
    ...
    - CA-R-1051
    - CAPRMEDIO-META-REQU-088-CORE_META_MODEL-CORE-REQUIREMENT--semantics-eligibility-rule
    - CAPRMEDIO-META-REQU-090-CORE_META_MODEL-CORE-REQUIREMENT--propagate-atomic-revision-impact-through-lineage
    - CAPRMEDIO-META-REQU-091-CORE_META_MODEL-CORE-REQUIREMENT--normative-atoms-are-the-caprmedio-specification
    - CAPRMEDIO-META-REQU-092-CORE_META_MODEL-REQUIREMENT--authority-evaluation-and-ops-remain-distinct
    - CAPRMEDIO-META-REQU-093-CORE_META_MODEL-REQUIREMENT--requirement-separate-analysis-from-factual-ops-records
    - CAPRMEDIO-META-REQU-096-CORE_META_MODEL-CORE-REQUIREMENT--propagate-caprmedio-change-forward
    - CAPRMEDIO-META-REQU-098-CORE_META_MODEL-CORE-REQUIREMENT--scope-path-does-not-change-semantic-coordinates
    ...
    - CAPRMEDIO-META-REQU-113-CORE_META_MODEL-CORE-REQUIREMENT--coordinate-artifacts-without-an-81-type-bijection
    ...
    - CAPRMEDIO-META-REQU-124-CORE_META_MODEL-CORE-REQUIREMENT--make-requirement-the-only-universally-mandatory-atom
    ...
    - CAPRMEDIO-META-REQU-129-CORE_META_MODEL-CORE-REQUIREMENT--separate-authority-applicability-and-currentness
    ...
    - CAPRMEDIO-META-REQU-153-CORE_META_MODEL-CORE-REQUIREMENT--preserve-bounded-meaning-across-structural-scales
