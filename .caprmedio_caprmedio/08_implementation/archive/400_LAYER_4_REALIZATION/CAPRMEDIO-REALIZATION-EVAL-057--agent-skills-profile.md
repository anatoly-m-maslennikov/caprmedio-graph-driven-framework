+++
semantic_id = "CAPRMEDIO-REALIZATION-EVAL-057--agent-skills-profile"
...
[[relations]]
type = "check_of"
target = "CAPRMEDIO-REALIZATION-REQU-585--agent-skills-profile"

[[relations]]
type = "check_of"
target = "CAPRMEDIO-SPEC-REQU-496--keep-llm-operation-provider-neutral"
+++

# Evaluation Case — Assess the Agent Skills profile
