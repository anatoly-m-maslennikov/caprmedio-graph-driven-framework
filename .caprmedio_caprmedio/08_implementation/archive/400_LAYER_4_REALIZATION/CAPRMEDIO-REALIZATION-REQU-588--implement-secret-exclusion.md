+++
semantic_id = "CAPRMEDIO-REALIZATION-REQU-588--implement-secret-exclusion"
...
rationale = "A prose prohibition is insufficient unless implementations constrain every ingress, execution, diagnostic, build, evaluation, and incident boundary through which secret material can be copied."
...
[[relations]]
type = "child_of"
target = "CAPRMEDIO-GOV-REQU-290--exclude-secrets-from-dset"
+++
