+++
semantic_id = "CAPRMEDIO-REALIZATION-REQU-598--apply-local-python-tools-profile"
...
claim = "Every Python tool, library module, runner, and Test distributed inside .caprmedio conforms to the selected Local Python Tools profile through its authoritative root source and explicit installed-methodology synchronization."
...
[[relations]]
type = "resolution_of"
target = "CAPRMEDIO-REALIZATION-CONC-084--scope-of-python-application"
+++

# Requirement — Apply the Local Python Tools profile recursively

All Python carriers distributed below `.caprmedio` must derive from authoritative
