...
priority = "high"
child_of = ["CAPRMEDIO-SPEC-SKILLS-REQU-568--shared-skill-runtime"]
version = 1
...
|---|---|---|
| `CAPRMEDIO-GOV-CONC-019--lifecycle-transition-validation` | Validate lifecycle transitions, terminal states, and one absorption successor | `df42c5a` |
| `CAPRMEDIO-GOV-CONC-020--compilation-consequence` | Accept only digest-bound ID-owned claim fragments; keep semantic equivalence in Evaluation | `c0ee76a` |
| `CAPRMEDIO-GOV-CONC-026--legacy-immutability` | Seal legacy Decision carriers and shared-registry selector fragments | `5500d87` |
| `CAPRMEDIO-GOV-CONC-021--artifact-emission-gate` | Make atom sealing repeat repository-backed admission | `14c8331` |
| `CAPRMEDIO-SPEC-TOOLS-CONC-055--runtime-terminalization` | Preserve nested active runs and require wrapper terminalization | `540af58`, `8f85e3e` |
| `CAPRMEDIO-SPEC-SKILLS-CONC-081--installed-launcher-discovery` | Render an exact installed interpreter/runtime launcher | `f71a42f` |
| `CAPRMEDIO-SPEC-SKILLS-CONC-077--llm-session-provenance` | Carry and validate host session provenance through every wrapper | `8f85e3e` |
| `CAPRMEDIO-SPEC-TOOLS-CONC-065--commit-provenance-gate` | Validate Decision-backed commit provenance from a manifest anchor | `f445592` |
| `CAPRMEDIO-FIELD-CONC-085--release-truth` | Align the active Change to one `0.3.1` to `0.4.0` transaction | `507a4e4` |
| `CAPRMEDIO-SPEC-TOOLS-CONC-066--installer-transaction` | Roll back exact-digest transaction-created host destinations | `9680094` |
| `CAPRMEDIO-GOV-CONC-022--stale-verification-claims` | Rebuild current Verification from this fresh closure | this evidence-only reconciliation |
