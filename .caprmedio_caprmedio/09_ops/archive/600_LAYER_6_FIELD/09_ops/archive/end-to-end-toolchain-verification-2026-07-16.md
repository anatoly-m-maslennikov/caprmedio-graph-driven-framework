...
- **Intended use:** Support `CAPRMEDIO-SPEC-SKILLS-METH-055--select-the-dset-0-3-operating-shape`, close the local
  implementation portion of `CAPRMEDIO-TASK-TOOL-010`, and bound the remaining
  evidence work under `CAPRMEDIO-TASK-SKILL-020`, `CAPRMEDIO-TASK-TOOL-036`, and
  `CAPRMEDIO-TASK-OPS-025`.
- **LLM session IDs:**
