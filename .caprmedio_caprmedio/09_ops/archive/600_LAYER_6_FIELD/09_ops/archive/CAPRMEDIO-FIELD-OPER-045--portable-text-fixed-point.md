...
evidence_location = "dset/scopes/skill/changes/make-dset-self-hosting-and-skills-thin/proofs/CAPRMEDIO-FIELD-OPER-045--portable-text-fixed-point.md"
polarity = "supports"
currentness = "current"
...
[subject]
id = "CAPRMEDIO-FIELD-EVAL-060--portable-text-byte-policy-test-case"
...
[[relations]]
type = "evidence_for"
target = "CAPRMEDIO-FIELD-EVAL-060--portable-text-byte-policy-test-case"
+++
...
point. It does not close `CAPRMEDIO-TASK-TOOL-036`: fresh hosted Linux, macOS, native
