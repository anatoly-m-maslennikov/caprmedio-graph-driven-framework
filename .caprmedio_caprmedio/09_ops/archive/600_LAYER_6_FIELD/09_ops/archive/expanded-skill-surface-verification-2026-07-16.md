...
- **Decision:** `CAPRMEDIO-SPEC-SKILLS-METH-056--expose-every-dset-lifecycle-mode-as-a-public-skill`
- **Task:** `CAPRMEDIO-TASK-SKILL-022`
- **LLM session IDs:**
...
release publication. Those remain governed by `CAPRMEDIO-TASK-SKILL-020`,
`CAPRMEDIO-TASK-TOOL-036`, and `CAPRMEDIO-TASK-OPS-025`.
