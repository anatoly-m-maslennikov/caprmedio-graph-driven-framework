...
tests the real Codex installation boundary for `CAPRMEDIO-CONTRACT-SKILL-001` and
`CAPRMEDIO-TEST-CASE-SKILL-011`. It may support only the current blocked disposition; it
