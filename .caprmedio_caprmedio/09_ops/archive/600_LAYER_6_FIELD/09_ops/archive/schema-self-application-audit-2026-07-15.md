...
- Active Change deltas connect to current layer-owned accepted IDs and retain
  only genuinely unaccepted additions. `CAPRMEDIO-GOV-CONC-029--active-deltas-and-accepted-truth-reuse-ids-inconsistently` is resolved.
...
| Generated temporary adopter | Partial pass | Candidate materializes and validates one bounded schema 1.1 compatibility adopter. A second generated current-schema 1.2 adopter remains `CAPRMEDIO-SPEC-TOOLS-CONC-070--generated-adopter-does-not-exercise-current-schema-1-2`. |
...
- `CAPRMEDIO-SPEC-TOOLS-CONC-069--released-validator-cannot-parse-schema-1-2`: published-validator evaluation remains a declared
  degraded schema-transition boundary.
- `CAPRMEDIO-SPEC-TOOLS-CONC-070--generated-adopter-does-not-exercise-current-schema-1-2`: no generated current-schema adopter.
- `CAPRMEDIO-SPEC-SKILLS-CONC-076--core-skill-runtime-is-incomplete`: `dset`, `dset-release`, run writer, checkpoint, and
  resume runtime are incomplete.
- `CAPRMEDIO-FIELD-CONC-089--current-exact-head-hosted-proof-is-missing`: no exact-current-head GitHub proof.
