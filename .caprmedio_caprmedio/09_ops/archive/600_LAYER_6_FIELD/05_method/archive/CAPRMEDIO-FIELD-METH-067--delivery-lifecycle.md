+++
semantic_id = "CAPRMEDIO-FIELD-METH-067--delivery-lifecycle"
...
[[relations]]
type = "replacement_of"
target = "CAPRMEDIO-FIELD-METH-066--use-five-flat-release-lifecycle-artifacts"

[[relations]]
type = "child_of"
target = "CAPRMEDIO-GOV-METH-021--delivery-artifact-type"
+++
...
immutable. Verification supplies evaluation but never substitutes for the
...
This Decision absorbs `CAPRMEDIO-FIELD-METH-066--use-five-flat-release-lifecycle-artifacts`. It carries forward that
...
`CAPRMEDIO-GOV-METH-021--delivery-artifact-type`.
