...
- **Decision ID:** `CAPRMEDIO-FIELD-METH-064--use-version-scope-as-the-release-lifecycle-root`
- **Status:** accepted
- **Decision date:** 2026-07-20
- **Resolves Question:** follow-up operator clarification of
  `CAPRMEDIO-GOV-CONC-040--should-dset-generate-roadmap-and-release-views`
- **Absorbs:** `CAPRMEDIO-FIELD-METH-063--govern-releases-through-version-targets-and-a-next-minor-roadmap` in full
...
`CAPRMEDIO-FIELD-METH-063--govern-releases-through-version-targets-and-a-next-minor-roadmap`, now as Version Scopes:
...
- **Known counter-evidence:** schema, initializer, validator, overview, and
  release CLI enforcement remain open under `CAPRMEDIO-FIELD-CONC-090--release-planning-enforcement-is-not-implemented`
