...
- Carrier: `.caprmedio_caprmedio/102_LAYER_2_FRAMEWORK_ENGINE/07_delivery/drafts/CA-D--DELIVERY-FR_ENGN--provide-bounded-python-source-and-external-assets.md`.
