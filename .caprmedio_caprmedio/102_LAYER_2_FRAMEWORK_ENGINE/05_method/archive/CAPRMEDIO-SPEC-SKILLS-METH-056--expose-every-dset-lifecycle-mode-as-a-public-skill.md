...
- **Decision ID:** `CAPRMEDIO-SPEC-SKILLS-METH-056--expose-every-dset-lifecycle-mode-as-a-public-skill`
- **Status:** accepted
- **Decision date:** 2026-07-16
- **Resolves Question:** direct operator request to create all remaining DSET
  lifecycle skills
- **Absorbs:** none
- **Replaces claims:** the `CAPRMEDIO-SPEC-SKILLS-METH-055--select-the-dset-0-3-operating-shape` claim that the public
