...
- retain available declared Atom Revisions as observed values. ordinary files **and** folders use logger-owned operational Revisions; an operational Revision **must not** be presented as a missing **or** invalid declared Atom Version.
