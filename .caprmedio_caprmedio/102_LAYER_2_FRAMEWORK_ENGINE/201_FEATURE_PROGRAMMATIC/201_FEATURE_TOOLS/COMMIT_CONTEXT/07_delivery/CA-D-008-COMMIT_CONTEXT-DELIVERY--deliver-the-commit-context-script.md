...
COMMIT_CONTEXT **must** be delivered through the canonical source script `102_FRAMEWORK_ENGINE/201_PROGRAMMATIC/201_TOOLS/COMMIT_CONTEXT/commit_context.py` **and** its content-identical Carrier **in** the selected `.caprmedio_runtime/tools` release.
