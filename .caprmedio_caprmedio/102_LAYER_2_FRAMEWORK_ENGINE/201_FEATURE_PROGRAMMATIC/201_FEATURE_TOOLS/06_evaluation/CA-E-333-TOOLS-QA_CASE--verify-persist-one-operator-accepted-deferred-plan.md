...
the suggestion creates no Plan; the accepted case creates **=1** Plan with the stated deferred work **and** **all** provenance **and** reopening fields; it **contains** no implementation, active-work, **or** completion claim.
