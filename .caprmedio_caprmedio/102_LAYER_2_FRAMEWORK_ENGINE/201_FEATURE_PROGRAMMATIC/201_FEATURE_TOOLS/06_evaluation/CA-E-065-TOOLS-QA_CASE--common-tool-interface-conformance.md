---
subjects:
  governs: "Tool/common CLI interface"
  depends_on:
    - "Tool"
    - "Artifact/Carrier"
    - "Projection"
    ...
    - "Atom/Type"
version: 16
updated_at: "2026-09-17 20:52:30 +0000"
llm_session_ids:
...
3. resolve targets independently from Structural Unit, Content Role, **and** Type filters **and** from explicit Atom filenames, **and** require the same stable target set **before** execution.
4. snapshot the fixture's authoritative Carriers, derived outputs, **and** observable persistent state. run **every** Finder fixture, including its registered Checker specialization, **and** require no creation, deletion, rename, byte change, metadata change, Relation change, lifecycle change, **or** other mutation. a write **to** a non-authoritative Projection **or** runtime output is still a mutation **and** fails the Finder boundary under CA-R-1066.
