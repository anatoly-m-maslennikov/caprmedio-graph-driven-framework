...
from an independent exact before-state, inject a failure **after** **>=1** planned Carrier **or** reference change **and** **before** the migration completes. also exercise a Journal append failure **after** the planned mutations succeed, under CA-M-247's declared recovery boundary.
