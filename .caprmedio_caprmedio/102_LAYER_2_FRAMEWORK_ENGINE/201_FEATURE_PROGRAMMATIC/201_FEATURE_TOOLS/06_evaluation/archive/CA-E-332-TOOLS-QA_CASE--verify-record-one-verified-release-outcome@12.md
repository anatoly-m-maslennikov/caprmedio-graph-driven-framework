...
the incomplete attempt records no release success **and** creates exactly one Journal Record of a failed non-release attempt binding its attempted version, exact revision, checks, **and** Work Journal event. the complete attempt produces exactly one immutable Journal Record of verified release success binding **every** required identity, revision, check, evidence, Work Journal event, **and** Git fact.
