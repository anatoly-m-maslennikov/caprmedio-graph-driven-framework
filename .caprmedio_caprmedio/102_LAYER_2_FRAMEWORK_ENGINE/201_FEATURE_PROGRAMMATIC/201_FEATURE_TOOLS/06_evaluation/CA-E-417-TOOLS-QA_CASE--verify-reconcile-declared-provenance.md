...
the result assigns **every** case exactly its corresponding classification with attributable source evidence. no selected Artifact changes, no link is repaired, **and** no adoption decision is created.
