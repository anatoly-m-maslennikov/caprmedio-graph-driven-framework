...
- reject destination collisions **and** reused assigned Atom IDs, including IDs retained **only** **in** historical authority. identity admission follows CA-D-450; an unassigned Draft does **not** acquire an invented ID.
