...
- an assigned Project Atom ID follows CA-R-732 **and** CA-D-378. an unassigned Draft uses the applicable Draft Carrier grammar **without** inventing an Atom ID.
