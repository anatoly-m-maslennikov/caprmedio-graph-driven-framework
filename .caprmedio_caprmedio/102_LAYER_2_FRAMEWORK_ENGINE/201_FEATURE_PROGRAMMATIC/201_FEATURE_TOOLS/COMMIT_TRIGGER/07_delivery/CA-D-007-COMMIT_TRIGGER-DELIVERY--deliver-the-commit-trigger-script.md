...
Realize COMMIT_TRIGGER through 102_FRAMEWORK_ENGINE/201_PROGRAMMATIC/201_TOOLS/COMMIT_TRIGGER/commit_trigger.py **and** its content-identical carrier **in** the selected installed release. INSTALL_TOOLS, **not** COMMIT_TRIGGER, owns Tool **and** Hook installation.
