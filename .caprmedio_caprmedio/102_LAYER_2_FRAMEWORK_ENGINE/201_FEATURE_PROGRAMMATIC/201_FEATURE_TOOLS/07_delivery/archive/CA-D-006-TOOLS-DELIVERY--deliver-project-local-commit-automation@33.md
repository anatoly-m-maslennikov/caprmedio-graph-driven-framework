...
the operational envelope check is the Action CA-O-037 under CA-R-1385. its implementation does **not** extend the `delivery_for` Relation's admitted target roles.
