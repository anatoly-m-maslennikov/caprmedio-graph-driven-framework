...
cce_form: obligation
version: 10
updated_at: "2026-09-17 22:54:12 +0000"
llm_session_ids:
  - codex:01a02650-eff7-7453-8c37-0699b36773c6
---
# Project Initiative into real-change commit messages

**every** real-change Git commit message **must** begin with the sealed Initiative's concise summary of its human input **before** the first ` | `. the summary comes from the human instruction retained by the sealed Initiative through its persisted Plan **or** Task **or** its ephemeral session task under CA-R-1094; the author of a Task Carrier does **not** replace that instruction **or** supply independent authorization; it **must not** be derived from a process, thread, adapter, queue, relation list, **or** other technical parent. the remaining fields identify the governed change class **and** affected subject:
