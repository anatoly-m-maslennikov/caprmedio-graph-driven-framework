...
subjects:
  ...
  depends_on:
    ...
    - "Journal/Record"
version: 1
updated_at: "2026-09-17 03:01:25 +0000"
llm_session_ids:
...
5. invoke the canonical Atom lifecycle operation for the predecessor archive effect; pass the complete explicit predecessor **and** successor IDs for Journal evidence under CA-R-807. retain the approved all-or-nothing boundary **without** independently implementing creation, Relation patching, **or** archival.
6. obtain durable COMMIT_TRIGGER intake acknowledgment **before** MCP reports successful completion. a missing acknowledgment is **not** success **and** does **not** authorize blind repetition of an effect whose outcome needs reconciliation.
