...
The persisted Projection is suitable for strictly read-only consumption by `GRAPH_APP`, but it has no authority of its own: current Atoms, Journals, authoritative Settings Artifacts, and any other authority admitted by the applicable methodology remain authoritative independently of the Projection.
