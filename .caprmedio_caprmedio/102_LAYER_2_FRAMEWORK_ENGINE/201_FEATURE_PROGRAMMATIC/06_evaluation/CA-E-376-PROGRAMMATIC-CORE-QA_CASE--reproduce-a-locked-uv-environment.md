...
version: 8
updated_at: "2026-09-17 19:28:22 +0000"
relations:
  evaluation_for:
    - CA-M-221
  derived_from:
...
`pyproject.toml` **or** `uv.lock`, the observed interpreter satisfies the
Method-selected Python boundary, **and** the command uses **only** Method-selected
dependencies.
