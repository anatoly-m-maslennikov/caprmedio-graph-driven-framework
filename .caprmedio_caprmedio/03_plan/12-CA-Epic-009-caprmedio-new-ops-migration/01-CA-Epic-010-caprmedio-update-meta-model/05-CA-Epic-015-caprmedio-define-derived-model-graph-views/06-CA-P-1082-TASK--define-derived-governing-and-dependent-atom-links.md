...
consume the completed CA-Epic-016 handoff from CA-P-1091, including the source-versus-Projection correction from CA-P-1086 **before** selecting graph ownership **or** governing Subjects. the graph itself **and** its further views are Projections; none is an independent source of its represented facts. re-review the unexecuted CA-P-1082 proposal against that correction. the earlier CA-M-232 commit-order exception remains unresolved; this Task update does **not** grant it.
