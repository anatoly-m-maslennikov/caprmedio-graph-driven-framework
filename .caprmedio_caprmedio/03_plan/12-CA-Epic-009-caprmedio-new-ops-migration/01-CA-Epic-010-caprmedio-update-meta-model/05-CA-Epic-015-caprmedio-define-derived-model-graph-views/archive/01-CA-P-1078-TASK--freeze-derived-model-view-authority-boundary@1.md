...
the Task is **not** Done **if** (a relevant existing definition, graph Relation Kind, Subject link rule, Projection rule, **or** competing planned change is unaccounted for **or** the selected source identities **and** revisions are unresolved **or** an existing authority is assigned **to** multiple following Tasks).

## Details

use CA-R-1318, CA-R-1319, CA-R-1320, CA-R-1335, CA-R-1438, CA-R-1281, CA-R-1246, **and** CA-R-806 as starting points, **not** an exhaustive list. read their current Claims. distinguish the Terms Graph, Entities Graph, direct Atom relations, **and** Subjects-based navigation. preserve the completed CA-P-980 direct-Subjects stage; its remaining Operation-specific schema is **not** a prerequisite for this inventory. identify reuse, gaps, proposed replacements, deferred work, **and** ownership **for** **every** following Task. record evidence outside authority sources; this Task changes no source Atoms.
