...
relations:
  depends_on:
    - CA-P-988
---
# Reconcile project principle content

the Assignee **must** align the selected project Principle Claims with the new Operations model.

## Scope

(selected project-root RMEDO Atoms at Local Tier Principle **and** Global Tier 0 **in** `.caprmedio_caprmedio`, plus CA-P-032 **and** CA-P-033); the source **and** lifecycle admission boundary established by CA-P-976 applies; historical versions, generated copies, runtime, Implementation code, **and** other CAP Atoms are excluded.
