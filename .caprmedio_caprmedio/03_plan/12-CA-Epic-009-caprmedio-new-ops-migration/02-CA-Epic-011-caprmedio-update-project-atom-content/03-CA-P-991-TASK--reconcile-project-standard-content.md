...
relations:
  depends_on:
    - CA-P-990
---
# Reconcile project standard content

the Assignee **must** align the selected project Standard Claims with the new Operations model.

## Scope

(selected project-root RMEDO Atoms at Local Tier Standard **and** Global Tier 3 **in** `.caprmedio_caprmedio`); the source **and** lifecycle admission boundary established by CA-P-976 applies; historical versions, generated copies, runtime, Implementation code, **and** other CAP Atoms are excluded.
