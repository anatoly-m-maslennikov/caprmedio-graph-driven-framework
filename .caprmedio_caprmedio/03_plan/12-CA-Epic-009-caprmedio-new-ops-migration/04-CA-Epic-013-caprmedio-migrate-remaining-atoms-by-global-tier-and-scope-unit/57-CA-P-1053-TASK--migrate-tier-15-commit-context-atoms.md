...
relations:
  depends_on:
    - CA-P-1052
---
# Migrate tier 15 commit context atoms

the Assignee **must** align this Global Tier 15 batch **in** COMMIT_CONTEXT with the updated model.

## Scope

(selected directly owned RMEDO Atoms at Global Tier 15, Local Tier Standard, **in** `.caprmedio_caprmedio/102_LAYER_2_FRAMEWORK_ENGINE/201_FEATURE_PROGRAMMATIC/201_FEATURE_TOOLS/COMMIT_CONTEXT`; child Scope Units are excluded); the source **and** lifecycle admission boundary established by CA-P-976 applies; historical versions, generated copies, runtime, Implementation code, **and** other CAP Atoms are excluded.
