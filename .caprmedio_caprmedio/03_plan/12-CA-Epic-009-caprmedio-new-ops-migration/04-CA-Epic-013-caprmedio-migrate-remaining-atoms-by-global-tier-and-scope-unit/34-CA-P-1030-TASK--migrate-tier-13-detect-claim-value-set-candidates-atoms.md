...
relations:
  depends_on:
    - CA-P-1029
---
# Migrate tier 13 detect claim value set candidates atoms

the Assignee **must** align this Global Tier 13 batch **in** DETECT_CLAIM_VALUE_SET_CANDIDATES with the updated model.

## Scope

(selected directly owned RMEDO Atoms at Global Tier 13, Local Tier Core, **in** `.caprmedio_caprmedio/102_LAYER_2_FRAMEWORK_ENGINE/201_FEATURE_PROGRAMMATIC/201_FEATURE_TOOLS/DETECT_CLAIM_VALUE_SET_CANDIDATES`; child Scope Units are excluded); the source **and** lifecycle admission boundary established by CA-P-976 applies; historical versions, generated copies, runtime, Implementation code, **and** other CAP Atoms are excluded.
