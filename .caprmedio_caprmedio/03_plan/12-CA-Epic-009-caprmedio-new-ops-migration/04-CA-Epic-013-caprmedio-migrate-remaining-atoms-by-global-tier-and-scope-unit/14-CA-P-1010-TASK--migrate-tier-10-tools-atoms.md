...
relations:
  depends_on:
    - CA-P-1009
---
# Migrate tier 10 tools atoms

the Assignee **must** align this Global Tier 10 batch **in** TOOLS with the updated model.
