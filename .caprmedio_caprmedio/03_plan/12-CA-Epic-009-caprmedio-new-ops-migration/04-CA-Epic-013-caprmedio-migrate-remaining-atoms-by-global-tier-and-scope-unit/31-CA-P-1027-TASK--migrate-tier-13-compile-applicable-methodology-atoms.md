...
relations:
  depends_on:
    - CA-P-1026
---
# Migrate tier 13 compile applicable methodology atoms

the Assignee **must** align this Global Tier 13 batch **in** COMPILE_APPLICABLE_METHODOLOGY with the updated model.
