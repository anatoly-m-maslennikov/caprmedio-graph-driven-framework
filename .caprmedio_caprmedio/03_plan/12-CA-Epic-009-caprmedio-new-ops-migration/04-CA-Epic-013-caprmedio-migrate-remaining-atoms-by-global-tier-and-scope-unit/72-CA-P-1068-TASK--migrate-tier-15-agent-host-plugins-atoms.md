...
relations:
  depends_on:
    - CA-P-1067
---
# Migrate tier 15 agent host plugins atoms

the Assignee **must** align this Global Tier 15 batch **in** AGENT_HOST_PLUGINS with the updated model.

## Scope

(selected directly owned RMEDO Atoms at Global Tier 15, Local Tier Standard, **in** `.caprmedio_caprmedio/102_LAYER_2_FRAMEWORK_ENGINE/201_FEATURE_PROGRAMMATIC/203_FEATURE_APPS/AGENT_HOST_PLUGINS`; child Scope Units are excluded); the source **and** lifecycle admission boundary established by CA-P-976 applies; historical versions, generated copies, runtime, Implementation code, **and** other CAP Atoms are excluded.
