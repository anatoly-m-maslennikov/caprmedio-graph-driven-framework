...
relations:
  depends_on:
    - CA-P-1002
---
# Migrate tier 6 core extensions atoms

the Assignee **must** align this Global Tier 6 batch **in** CORE_EXTENSIONS with the updated model.

## Scope

(selected directly owned RMEDO Atoms at Global Tier 6, Local Tier Standard, **in** `.caprmedio_caprmedio/104_LAYER_4_CORE_EXTENSIONS`; child Scope Units are excluded); the source **and** lifecycle admission boundary established by CA-P-976 applies; historical versions, generated copies, runtime, Implementation code, **and** other CAP Atoms are excluded.
