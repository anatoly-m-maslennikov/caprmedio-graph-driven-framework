...
relations:
  depends_on:
    - CA-P-1035
---
# Migrate tier 13 retrieve applicable methodology atoms

the Assignee **must** align this Global Tier 13 batch **in** RETRIEVE_APPLICABLE_METHODOLOGY with the updated model.
