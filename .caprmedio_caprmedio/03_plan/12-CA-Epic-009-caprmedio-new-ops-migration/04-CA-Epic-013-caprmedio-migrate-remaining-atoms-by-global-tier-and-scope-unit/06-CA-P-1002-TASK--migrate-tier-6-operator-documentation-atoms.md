...
relations:
  depends_on:
    - CA-P-1001
---
# Migrate tier 6 operator documentation atoms

the Assignee **must** align this Global Tier 6 batch **in** OPERATOR_DOCUMENTATION with the updated model.

## Scope

(selected directly owned RMEDO Atoms at Global Tier 6, Local Tier Standard, **in** `.caprmedio_caprmedio/103_LAYER_3_OPERATOR_DOCUMENTATION`; child Scope Units are excluded); the source **and** lifecycle admission boundary established by CA-P-976 applies; historical versions, generated copies, runtime, Implementation code, **and** other CAP Atoms are excluded.
