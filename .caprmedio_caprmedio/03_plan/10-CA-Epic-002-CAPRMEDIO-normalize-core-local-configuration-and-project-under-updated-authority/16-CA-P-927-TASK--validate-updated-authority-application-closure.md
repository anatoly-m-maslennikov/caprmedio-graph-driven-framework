...
`((all CA-P-917 frontier entries) union (all authoritative or derived Carriers created, revised, replaced, archived, generated, or rebuilt by CA-P-918 through CA-P-932) union (all direct Task outputs and completion evidence for CA-P-917 through CA-P-932))`
