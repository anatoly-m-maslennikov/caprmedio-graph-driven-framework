...
**when** CA-P-103 is Done, **then** the Assignee **must** reconcile 001_CORE_META_MODEL so it provides the minimal self-applicable canonical model necessary and sufficient to represent, govern, validate, and compile CAPRMEDIO Methodology authority.
