...
subjects:
  ...
  depends_on:
    occurrent:
      - CA-P-115
version: 18
updated_at: 2026-08-27 21:24:00 +0400
...
PASS. CA-P-107 v8 supersedes the v5 filename-blocked projection prediction with a governed generated RMEDO Atom Carrier tree. the map records current revisions and archive chains for CA-R-1229, CA-R-1230, CA-M-224, CA-M-225, CA-E-379, and CA-D-253, then selects only active current R, M, E, D, and O Source Carriers from CORE_META_MODEL and LOCAL_CONFIGURATION. it records the deterministic `COMPILE_APPLICABLE_METHODOLOGY` dry-run conflict report and exact Local Configuration Operator-approval gate: any unresolved or unapproved conflict leaves generated output unchanged. the map does not materialize output. map schema `v13` has SHA-256 `2f6725e26c589df6b27bb521d5d36fa310f264eda001ef5a1766b8b5325c5dbc`.
