...
subjects:
  ...
  depends_on:
    occurrent:
      - CA-P-115
version: 17
updated_at: 2026-08-27 20:45:00 +0400
...
## Control-Currentness Repair

PASS. the map now explicitly reconciles all 13 frozen CA-P-102 direct Task rows and the accepted CA-P-115 successor control Task with their exact lifecycle successor paths and digests. it records the frozen CA-P-102 control-manifest self-record (`29,258` bytes; `fab6316007e7c061ca9ccdb4c36d53d922aeeec830d6103ec9969cfbd2be8c2c`) and the exact current manifest (`29,501` bytes; `5bce3eb443a5a5d456696fc299b40bfc7bf26e2e829a7946d668ed43a69c0821`), as named by the completed CA-P-102 Task. it preserves this Task revision as `archive/09-CA-P-108-META_MTHD-TASK--freeze-the-bootstrap-to-methodology-migration-map@8.md` (`8,244` bytes; `09f544c5ff5b70d1608c70b365e39d0e0f547e7745e7255cd014c6e6ebb4c0d4`) and uses a lifecycle-selected successor rule for this revision, so the map does not carry a self-invalidating fixed digest for its own current Task Carrier.

## Descendant-Coverage Repair

PASS. the map explicitly covers each live Carrier beneath a mapped move or retirement directory. it retains two non-source Analysis Carriers in place and maps 25 archived Requirement or Delivery revisions byte-preservingly to their exact final lifecycle-archive paths. affected source directories now map only their exact descendants and remain as source shells until CA-P-114 verifies safe retirement.

## Executable Currentness-Coverage Repair

PASS. the map separately records all 21 accepted live current revisions that supersede frozen bytes: eight Core Meta-Model Carriers and 13 Project Delivery Carriers. each record has its exact live digest, lifecycle, accepted Task provenance, executable byte-preserving disposition, and final target. frozen predecessors and archived revisions remain separate. the map now proves that every non-retained live current Carrier acknowledged by reconciliation has exactly one executable mapping and target.

## CA-M-162 Governed-Current Repair

PASS. the map records CA-M-162 version 2 as an accepted governed commit with its exact live digest and final Project-authority target. its version 1 frozen predecessor remains separate. the currentness assertion includes CA-M-162 without pinning this Task revision's own digest.

## Direct PROGRAMMATIC Frontier Refresh

PASS. the map refreshes every changed or new direct PROGRAMMATIC Method and Evaluation Carrier: 14 drifted active Methods, 23 drifted active Evaluations, 24 new active Carriers including CA-M-221 and CA-E-356 through CA-E-378, and archived CA-M-194 and CA-E-312. all active current Carriers map byte-preservingly to the accepted fully labelled Project-authority target; archived revisions map separately to their final lifecycle archives. CA-M-162 version 4 supersedes its recorded version 2 live current state while retaining the frozen version 1 predecessor and commit provenance.

## PROGRAMMATIC Child-Scope Frontier Refresh

PASS. the map reconciles the 12 related frozen PROGRAMMATIC child-scope Carriers without treating them as a 12-to-9 replacement. CA-M-161 and the two archived unidentified Method predecessors remain live and retain their existing direct or archive mappings. the nine missing unidentified APPS or TOOLS drafts each have one exact active successor: CA-M-222; CA-E-349 through CA-E-352; CA-M-223; and CA-E-353 through CA-E-355. each one-to-one promotion record preserves the frozen predecessor path, bytes, digest, Claim title, Claim alignment, relations, and successor Atom ID, version, digest, lifecycle, and fully labelled Project-authority target. a promoted draft has no byte-preserving final predecessor Carrier; its active successor is the sole executable migration Carrier. all nine active successors have unique targets, and no source Carrier migration or CA-P-109 execution occurred.

## Direct PROGRAMMATIC Lifecycle-Dispositions Repair

PASS. the map closes the three lifecycle links reported by CA-P-109. frozen active CA-M-194 and CA-E-312 each have the same Atom ID, version, bytes, and digest as their exact current `archive/@1` successor; only those archive Carriers are executable migration inputs. frozen unidentified UV draft `CA-M--IMPL_METHOD-PROGRAMMATIC--use-uv-as-the-default-python-workflow-frontend` has the title-, Claim-, procedure-, outcome-, stop-condition-, and source-aligned active successor CA-M-221; only CA-M-221 is executable. each frozen predecessor has one explicit supersession disposition and its successor has one exact fully labelled Project-authority target. no Carrier migration or CA-P-109 execution occurred.

## Re-Frozen CA-P-107 Authority Frontier

PASS. CA-P-107 v5 supersedes the invalid compiler-authority identities CA-M-125, CA-M-126, CA-E-300, and CA-D-251 only in their invalid identity records; valid unrelated Atoms with those IDs remain separately mapped. the map adds byte-preserving executable Core Meta-Model mappings for CA-M-224, CA-M-225, CA-E-379, and CA-D-253 from the old `.caprmedio` source area. it reconciles current CA-P-103 v8, CA-P-107 v5, and CA-P-110 v5 control Carriers and the associated P103/P107 evidence without treating historical control evidence as methodology authority. its direct-Task current rows now select those exact live revisions while preserving their immediate archive predecessors. it retains the one-byte `002_INSTALLED_EXTENSIONS/.gitkeep` as durable empty Source-Layer topology. map schema `v12` has SHA-256 `0bc92f7d5220d3f6c8133ea990ad6d286c13ebfb5af837c35728e11c29550238`. the map now predicts exactly one logical Applicable Methodology Projection containing both indexes, with `carrier_filename: null`; no output is materialized and CA-P-110 remains blocked until an exact output-carrier filename is governed.
