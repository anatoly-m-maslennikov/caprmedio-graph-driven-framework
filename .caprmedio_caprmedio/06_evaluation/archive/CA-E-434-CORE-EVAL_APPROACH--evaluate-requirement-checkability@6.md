...
cce_form: evaluation
version: 6
updated_at: "2026-09-17 16:54:22 +0000"
...
**when** an accepted Requirement is used **to** govern work **or** evaluate a result, its checkability Evaluation **must** return `pass` **only** **if** the available evidence identifies:
