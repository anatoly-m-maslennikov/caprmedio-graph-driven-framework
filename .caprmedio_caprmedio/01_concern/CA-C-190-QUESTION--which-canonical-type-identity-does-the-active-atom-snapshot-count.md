...
priority: medium
version: 3
updated_at: "2026-09-17 20:53:46 +0000"
llm_session_ids:
...
- `CA-R-1060@12`: `.caprmedio_caprmedio/102_LAYER_2_FRAMEWORK_ENGINE/201_FEATURE_PROGRAMMATIC/201_FEATURE_TOOLS/04_requirement/CA-R-1060-TOOLS-REQUIREMENT--generate-current-active-atom-snapshot.md`; SHA-256 `a79f18cb419fc5d9ebe917b90a54b39fc98c11f5504d13f474f09eee335ce711`.
...
- `CA-E-070@10`: `.caprmedio_caprmedio/102_LAYER_2_FRAMEWORK_ENGINE/201_FEATURE_PROGRAMMATIC/201_FEATURE_TOOLS/06_evaluation/CA-E-070-TOOLS-QA_CASE--current-active-atom-snapshot-correctness.md`; SHA-256 `2a34036838f2c787ae18d67b8f435e1642ba8f5a6b0c6190989a04fe835b99f2`.
...
## Historical snapshot consumer

R-1069/M-148/E-071 reuse the same Type dimension for daily history. preserve interpretation against **every** historical revision's actual registry, topology, **and** lifecycle rules, explicit compatibility failures, configured calendar timezone, last-authoritative-revision selection, carry-forward on empty dates, **and** zero-inclusive reconciling totals. using today's Type labels **or** filesystem times would lose the required historical meaning. C-180 separately retains the selected Git integration boundary; resolving the count key does **not** authorize replacing the history source **or** rewriting historical facts.

## Additional inspected source Revisions

- `CA-R-1069@9`: `.caprmedio_caprmedio/102_LAYER_2_FRAMEWORK_ENGINE/201_FEATURE_PROGRAMMATIC/201_FEATURE_TOOLS/04_requirement/CA-R-1069-TOOLS-REQUIREMENT--generate-active-atom-history.md`; SHA-256 `87837749ca77b709cda5cceaef8b16807928ca12c98d481f03db1091fba5534e`.
...
## Current and historical Evaluation consumers

E-070 **and** E-071 require complete zero-inclusive reconciling Type, structural-level **and** unit rollups. preserve these checks while resolving qualified Type keys **and** current versus historical structural declarations. E-071's exact Git frontier, timezone **and** no-commit carry-forward remain source-specific under C-180; filesystem timestamps are **not** history authority. previous Projection bytes **may** be retained **without** being claimed current. no historical dataset **or** current snapshot is generated by this review.

## Additional inspected source Revisions

- `CA-E-070@11`: `.caprmedio_caprmedio/102_LAYER_2_FRAMEWORK_ENGINE/201_FEATURE_PROGRAMMATIC/201_FEATURE_TOOLS/06_evaluation/CA-E-070-TOOLS-QA_CASE--current-active-atom-snapshot-correctness.md`; SHA-256 `ad8119665624abc1ef4d7524bdac11b99bd28b63c114e5d9b7f569d8caba1c91`.
- `CA-E-071@12`: `.caprmedio_caprmedio/102_LAYER_2_FRAMEWORK_ENGINE/201_FEATURE_PROGRAMMATIC/201_FEATURE_TOOLS/06_evaluation/CA-E-071-TOOLS-QA_CASE--active-atom-history-correctness.md`; SHA-256 `429371d5c23049f6132d62b54b90a1f17db5931243d6a2bb49733bb8cb46890a`.
