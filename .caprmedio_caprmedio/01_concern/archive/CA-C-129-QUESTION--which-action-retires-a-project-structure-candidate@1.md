...
priority: medium
version: 1
updated_at: "2026-09-17 12:11:01 +0000"
llm_session_ids:
...
CA-M-002 favors those existing Actions over a duplicate migration Process. CA-M-005 requires a justified new Action boundary; CA-M-006 requires Carrier eligibility **and** operational effects **to** agree; CA-R-1490 requires old source bytes **and** failure evidence **to** remain recoverable. CA-R-1342 gives Carrier representation **to** D; CA-R-1344 gives reusable behavior **to** O. these rules establish ownership categories but **not** the missing rejection **and** partial-failure transition.
