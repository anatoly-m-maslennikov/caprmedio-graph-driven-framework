...
**every** Atom resolves **`=1`** Atom Scope, **`=1`** Governed Subject Set, **and** one atomic **or** composite Claim Scope with **`=1`** Claim Scope Unit Set **without** making a referenced Entity bearer-dependent.
...
**every** valid fixture resolves **`=1`** Atom Scope, **`=1`** Claim Scope, **and** canonical component equality independent of authored Subject order. **every** invalid fixture fails with the incorrect reference, ownership, Subject set, **or** relational fact identified.
