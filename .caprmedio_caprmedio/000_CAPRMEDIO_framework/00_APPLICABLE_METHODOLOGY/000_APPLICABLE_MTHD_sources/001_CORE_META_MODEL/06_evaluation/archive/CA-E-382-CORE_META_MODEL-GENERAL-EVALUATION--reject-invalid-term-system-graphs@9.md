...
the Evaluation **must** reject a Term-System Graph **if** it admits another primitive Relation Kind, admits a value **without** governing authority for its qualified Property context, **contains** a NARROWER_THAN cycle, **or** uses a Term-System Relation outside its registered graph.
