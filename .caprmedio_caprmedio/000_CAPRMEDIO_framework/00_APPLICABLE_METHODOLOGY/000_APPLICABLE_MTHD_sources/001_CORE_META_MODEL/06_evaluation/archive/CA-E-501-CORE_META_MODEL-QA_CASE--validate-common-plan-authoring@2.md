...
- default an omitted Claim Target Scope Unit **to** the owning Scope Unit regardless of Hub nesting; preserve a permitted explicit target **and** narrower Claim restrictions. reject an ancestor target **or** **any** Hub substituted as a Scope Unit target.
