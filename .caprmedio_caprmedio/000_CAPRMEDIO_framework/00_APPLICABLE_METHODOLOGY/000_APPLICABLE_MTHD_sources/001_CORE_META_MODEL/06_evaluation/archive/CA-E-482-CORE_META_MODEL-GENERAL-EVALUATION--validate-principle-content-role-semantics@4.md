...
- Operations covers its operational model, reusable rules, **or** specific Action, Workflow, **or** Actor participation/authorization behavior under CA-R-1530, **not** a Claim merely mentioning an Actor **or** Operation.
...
- Method covers an Implementation choice **or** convention, **not** the authoritative operational Action **or** Workflow definition.
