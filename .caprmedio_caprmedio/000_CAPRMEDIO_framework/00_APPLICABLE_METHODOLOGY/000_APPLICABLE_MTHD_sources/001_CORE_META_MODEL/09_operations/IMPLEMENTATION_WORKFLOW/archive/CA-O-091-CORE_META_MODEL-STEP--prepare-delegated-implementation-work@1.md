...
- bind inputs from the Workflow inputs, bounded request **and** current P/Plan **when** supplied, active Method Projection, selected R/E/D, permissions, selected mode, complete runtime inputs, retained work/evidence, assigned subagent references, remaining retry state, **and** latest returned results.
