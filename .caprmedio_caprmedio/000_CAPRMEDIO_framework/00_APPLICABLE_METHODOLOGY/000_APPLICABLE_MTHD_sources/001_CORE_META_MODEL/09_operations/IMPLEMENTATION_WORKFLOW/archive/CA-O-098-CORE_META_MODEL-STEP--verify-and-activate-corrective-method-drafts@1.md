...
- bind inputs from the pending Draft references retained from CA-O-097, current-candidate passing checks from CA-O-094, diagnosis **and** actual fix evidence, baseline **and** Author bindings, selected P/Plan, existing Method authority, **and** current confidence **and** permission gates.
