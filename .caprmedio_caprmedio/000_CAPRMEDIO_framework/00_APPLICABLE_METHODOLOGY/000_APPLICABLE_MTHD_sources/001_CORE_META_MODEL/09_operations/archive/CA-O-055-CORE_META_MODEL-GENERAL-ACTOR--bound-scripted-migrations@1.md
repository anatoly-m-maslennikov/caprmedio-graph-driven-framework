...
subjects:
  ...
  depends_on:
    ...
    - "Target Set"
version: 1
updated_at: "2026-09-17 05:09:03 +0000"
llm_session_ids:
...
these conditions constrain the AI Agent's participation; they do **not** define the migration's Action nodes **or** Process flow **or** grant additional mutation authority.
