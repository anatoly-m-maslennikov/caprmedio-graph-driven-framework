...
relations:
  - type: replacement_of
    targets:
      - CAPRMEDIO-META-REQU-216--three-revision-modes
  - type: relates_to
    targets:
...
`evergreen` is not part of the CAPRMEDIO artifact model. Current specifications,
...
append-only record sequences, or mutable maintained artifacts. CAPRMEDIO does not
