...
Root `caprmedio_settings.toml` selects `medium` or `high` through
...
Atomic-artifact admission uses medium or high strictness selected by artifacts.creation_strictness in caprmedio_settings.toml.
