...
The repository already identifies the current project. Repeating that identity in every artifact adds no scope information and implies a cross-project address that CAPRMEDIO does not support.
