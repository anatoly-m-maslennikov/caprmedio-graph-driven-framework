...
`.caprmedio/caprmedio_settings.toml` exposes exactly two conflict-selection modes:
...
stale projection routing, evidence affecting evaluation, or implementation
