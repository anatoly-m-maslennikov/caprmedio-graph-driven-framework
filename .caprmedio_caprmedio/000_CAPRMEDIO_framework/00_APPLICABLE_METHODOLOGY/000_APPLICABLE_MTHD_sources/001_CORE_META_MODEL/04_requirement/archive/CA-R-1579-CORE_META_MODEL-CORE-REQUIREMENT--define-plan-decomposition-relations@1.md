...
relations: {"relates_to": ["CA-R-1574", "CA-R-1583", "CA-D-474"]}
---
...
- both directions are derived under CA-D-474, **not** independently authored facts.
...
- cardinality: **>=0** outgoing direct targets **and** **<=1** direct inverse source per Plan under the folder-derived Carrier model.
