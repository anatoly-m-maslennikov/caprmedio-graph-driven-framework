...
How should the Embedded/address agreement draft be reconciled?
...
- archived Carrier: `.caprmedio_caprmedio/000_CAPRMEDIO_framework/00_APPLICABLE_METHODOLOGY/000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/archive/CA-R--MMODEL-CORE-REQUIREMENT--require-embedded-metadata-and-carrier-address-to-agree@1.md`.
- inspected SHA-256: `243880ce3c0befdd9636d7446bef9534c11aad8616de97a4e709539d535f18c4`.
- review point: 13 of 79; campaign `draft-review-8afeac79`.

### Prior review finding

> **Revise** — Preserve its conditional equality rule; replace the Self-description dependency with admitted representation/migration authority. It does not itself require duplication.
>
> Basis: `CA-D-267`; I3. Reviewer confidence: 99%.
