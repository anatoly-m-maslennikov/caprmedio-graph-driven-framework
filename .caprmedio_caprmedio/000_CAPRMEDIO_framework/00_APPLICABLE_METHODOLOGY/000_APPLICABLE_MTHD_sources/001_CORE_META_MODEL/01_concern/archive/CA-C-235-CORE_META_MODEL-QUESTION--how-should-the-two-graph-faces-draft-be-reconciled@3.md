...
- Carrier: `.caprmedio_caprmedio/000_CAPRMEDIO_framework/00_APPLICABLE_METHODOLOGY/000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/drafts/CA-R--MMODEL-REQUIREMENT--require-two-realization-graph-faces.md`.
...
the reverse-engineering job is accepted, but this Question remains open: the job alone does **not** prove that **every** graph needs **`=1`** Carrier Face **and** **`=1`** Dependency Face. the Carrier Face purpose **and** the necessity of this universal pair still require a decision. the two-face Draft is unchanged **and** unpromoted.
