...
How should the Two graph faces draft be reconciled?
...
- Carrier: `.caprmedio_caprmedio/000_CAPRMEDIO_framework/00_APPLICABLE_METHODOLOGY/000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/archive/CA-R--MMODEL-REQUIREMENT--require-two-realization-graph-faces@4.md`.
- inspected SHA-256: `bbe0715a3cee8f5446c48a5bf7f47cd6cd3745bb28db481cc3ec409b9df2e5c6`.
- review point: 26 of 79; campaign `draft-review-8afeac79`.

### Historical review finding

> **Unresolved** — No Carrier Face definition found in the active source or 79 drafts; define its purpose and prove both faces necessary.
>
> Basis: `CA-M-005`; I5. Reviewer confidence: 99%.
...
- Retire the universal two-view requirement: no accepted outcome requires both, and Carrier Face is undefined. Preserve the exact historical proposal; the optional dependency view does not require a counterpart.
- exact prior Carrier: `.caprmedio_caprmedio/000_CAPRMEDIO_framework/00_APPLICABLE_METHODOLOGY/000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/archive/CA-R--MMODEL-REQUIREMENT--require-two-realization-graph-faces@4.md`; SHA-256 `bbe0715a3cee8f5446c48a5bf7f47cd6cd3745bb28db481cc3ec409b9df2e5c6`.
