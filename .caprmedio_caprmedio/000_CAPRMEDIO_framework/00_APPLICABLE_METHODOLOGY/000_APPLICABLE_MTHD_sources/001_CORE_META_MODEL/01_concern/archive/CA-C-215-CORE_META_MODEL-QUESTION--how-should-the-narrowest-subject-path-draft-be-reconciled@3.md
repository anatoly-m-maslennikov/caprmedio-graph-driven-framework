...
relations: {}
---
# How should the Narrowest Subject Path draft be reconciled?
...
- archived proposal Carrier: `.caprmedio_caprmedio/000_CAPRMEDIO_framework/00_APPLICABLE_METHODOLOGY/000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/archive/CA-R--MMODEL-CORE-REQUIREMENT--end-every-subject-path-at-the-exact-semantic-locus@2.md`.
- inspected SHA-256: `293cd042037190c6f4f9ef94ca8e0c771212bde58e511fcc85b53a3b7a13ae3c`.
- review point: 6 of 79; campaign `draft-review-8afeac79`.

## Prior review finding

> **Consolidate** — Already required by Subject assignment; keep any missing endpoint example in that authority.
>
> Basis: `CA-M-125`, `CA-R-1194`; I2. Reviewer confidence: 99%.
...
- `CA-R-1194@10`: `.caprmedio_caprmedio/000_CAPRMEDIO_framework/00_APPLICABLE_METHODOLOGY/000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/CA-R-1194-CORE_META_MODEL-CORE-REQUIREMENT--define-subject-path.md`; SHA-256 `2f6f26c3c8c4ecae99f477fd00c7e5db86d88a2de98518c3c6e1c9c3d71b0de9`.
...
the narrowest exact target rule is preserved in CA-M-125 for GOVERNS and DEPENDS_ON. full canonical paths resolve the Entity without adding a new target identity. the draft supplies no separate outcome after this reconciliation.

- surviving active authority: CA-M-125, CA-R-1194, CA-R-1202.
