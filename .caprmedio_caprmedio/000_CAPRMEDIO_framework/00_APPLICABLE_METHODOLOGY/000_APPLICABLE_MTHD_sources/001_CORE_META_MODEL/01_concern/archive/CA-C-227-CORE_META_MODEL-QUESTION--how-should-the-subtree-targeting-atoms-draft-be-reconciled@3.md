...
relations: {}
---
# How should the Subtree-targeting Atoms draft be reconciled?
...
- archived Carrier: `.caprmedio_caprmedio/000_CAPRMEDIO_framework/00_APPLICABLE_METHODOLOGY/000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/archive/CA-R--MMODEL-GENERAL-REQUIREMENT--define-subtree-targeting-atoms@1.md`.
- inspected SHA-256: `1513534b7f6e4b62fc25753a3602245013979a9e38390a8b2ab6429d5983e994`.
- review point: 18 of 79; campaign `draft-review-8afeac79`.

## Prior review finding

> **Retire** — Same union is already active.
>
> Basis: `CA-R-1449`; I2. Reviewer confidence: 99%.
