...
How should the Dependency Face draft be reconciled?
...
- Carrier: `.caprmedio_caprmedio/000_CAPRMEDIO_framework/00_APPLICABLE_METHODOLOGY/000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/archive/CA-R--MMODEL-REQUIREMENT--define-realization-graph-dependency-face@4.md`.
- inspected SHA-256: `c6d878270833793f7f267134eed25c63c553ebe1b9b419fca376412397fd37cd`.
- review point: 23 of 79; campaign `draft-review-8afeac79`.

### Historical review finding

> **Revise** — Bound the selected dependency population and completeness claim; pair with a defined Carrier Face.
>
> Basis: `CAPRMEDIO-META-REQU-657`; I5. Reviewer confidence: 96%.
...
- exact prior Carrier: `.caprmedio_caprmedio/000_CAPRMEDIO_framework/00_APPLICABLE_METHODOLOGY/000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/archive/CA-R--MMODEL-REQUIREMENT--define-realization-graph-dependency-face@4.md`; SHA-256 `c6d878270833793f7f267134eed25c63c553ebe1b9b419fca376412397fd37cd`.
- current repaired Draft: `.caprmedio_caprmedio/000_CAPRMEDIO_framework/00_APPLICABLE_METHODOLOGY/000_APPLICABLE_MTHD_sources/003_PROJECT_CONFIGURATION/04_requirement/drafts/CA-R--PROJECT_CONFIGURATION-REQUIREMENT--define-the-realization-graph-dependency-view.md`.
