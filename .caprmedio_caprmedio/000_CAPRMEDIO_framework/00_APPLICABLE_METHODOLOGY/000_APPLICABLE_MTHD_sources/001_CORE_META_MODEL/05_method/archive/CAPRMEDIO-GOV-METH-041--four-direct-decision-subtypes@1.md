...
relations:
  - type: replacement_of
    targets:
      - CAPRMEDIO-GOV-METH-040--separate-requirements-from-decisions
  - type: resolution_of
    targets:
      - CAPRMEDIO-GOV-CONC-046--which-direct-decision-subtypes
---
...
This Decision completely replaces `CAPRMEDIO-GOV-METH-040--separate-requirements-from-decisions`; the predecessor is
