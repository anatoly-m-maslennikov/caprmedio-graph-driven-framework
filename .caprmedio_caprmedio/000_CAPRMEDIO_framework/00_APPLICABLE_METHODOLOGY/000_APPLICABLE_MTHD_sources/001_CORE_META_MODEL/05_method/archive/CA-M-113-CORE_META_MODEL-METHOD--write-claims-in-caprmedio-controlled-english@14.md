...
- resolve the effective CCE Role Profile under CA-M-308 **and** satisfy that profile under CA-M-315.
- choose wording under CA-M-294.
- exclude ambiguous pronouns, anaphora, ellipsis, unstated defaults, **and** mixed logical groupings.
- make the content understandable under CA-M-301 **and** render Terms **and** CCE Operators under CA-M-229.
