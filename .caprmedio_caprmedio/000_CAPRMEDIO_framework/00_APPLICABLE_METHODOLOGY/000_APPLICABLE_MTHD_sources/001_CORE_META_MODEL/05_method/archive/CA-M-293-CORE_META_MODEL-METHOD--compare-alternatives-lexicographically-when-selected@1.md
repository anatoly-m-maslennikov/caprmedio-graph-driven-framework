...
cce_form: method
---
# Compare alternatives lexicographically when selected

**when** the Operator selects lexicographic comparison, the comparison of admissible alternatives **must** use the resolved order of active, applicable criteria as follows:
