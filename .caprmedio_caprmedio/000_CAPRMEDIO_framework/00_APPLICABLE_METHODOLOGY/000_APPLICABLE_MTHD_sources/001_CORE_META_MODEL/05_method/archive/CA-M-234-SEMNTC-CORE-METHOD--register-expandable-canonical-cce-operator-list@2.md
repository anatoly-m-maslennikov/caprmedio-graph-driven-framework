...
subjects:
  ...
  depends_on:
    continuant:
      ...
      - CCE Method
version: 2
updated_at: 2026-08-29 00:36:03 +0400
relations: {}
---
...
4. quantification: **all**, **every**, **any**, **none**.
5. logical/set: **and**, **or**, **not**, **without**, **where**.
6. restriction: **only**.
7. predicate: **in**, **not in**, **is empty**, **is not empty**, **contains**, **starts with**, **ends with**.
8. comparison: **`=`**, **`!=`**, **`<`**, **`<=`**, **`>`**, **`>=`**.
