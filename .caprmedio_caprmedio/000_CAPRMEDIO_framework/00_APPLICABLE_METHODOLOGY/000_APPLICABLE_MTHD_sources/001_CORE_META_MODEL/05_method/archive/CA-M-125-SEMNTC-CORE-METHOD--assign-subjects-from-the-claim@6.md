...
7. retain at least one and at most two GOVERNS relations, with at most one GOVERNS relation for each Temporal Form.
...
10. record each distinct Claim-Subject Relation exactly once.
