...
relations:
  - type: resolution_of
    targets:
      - CAPRMEDIO-GOV-CONC-041--should-traceability-use-typed-relation-edges
...
evaluation, precedence, or lifecycle meaning and does not satisfy implementation
or QA coverage.
...
This Decision completely replaces `CAPRMEDIO-GOV-REQU-391--artifact-inheritance` and
`CAPRMEDIO-GOV-REQU-392--artifact-lineage`, and resolves `CAPRMEDIO-GOV-CONC-041--should-traceability-use-typed-relation-edges`.

## Rationale

The former neutral lineage edge could not distinguish refinement,
implementation, evaluation, evidence, resolution, scoped exception, and full
