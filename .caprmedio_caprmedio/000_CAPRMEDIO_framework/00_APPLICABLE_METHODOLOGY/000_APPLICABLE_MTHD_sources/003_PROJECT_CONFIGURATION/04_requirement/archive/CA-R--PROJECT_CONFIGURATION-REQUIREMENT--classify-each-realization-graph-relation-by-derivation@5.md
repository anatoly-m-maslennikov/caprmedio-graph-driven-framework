...
relations: {"relates_to": ["CAPRMEDIO-META-REQU-097", "CAPRMEDIO-META-REQU-657"]}
---
# Summary
...
- missing **or** conflicting derivation evidence remains an explicit unresolved diagnostic; do **not** invent a class **or** present an unsupported Relation as established.
