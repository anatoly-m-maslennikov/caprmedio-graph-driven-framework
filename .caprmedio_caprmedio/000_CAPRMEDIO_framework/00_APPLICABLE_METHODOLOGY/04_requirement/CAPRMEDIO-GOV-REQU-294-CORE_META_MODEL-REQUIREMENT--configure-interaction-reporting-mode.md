...
relations:
  relates_to:
    - CAPRMEDIO-META-REQU-087-CORE_META_MODEL-REQUIREMENT--requirement-route-uncertain-input-through-exploration-mode
  child_of:
    - CA-R-1054
projection:
  source_carrier_path: ../000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/CAPRMEDIO-GOV-REQU-294-CORE_META_MODEL-REQUIREMENT--configure-interaction-reporting-mode.md
---
