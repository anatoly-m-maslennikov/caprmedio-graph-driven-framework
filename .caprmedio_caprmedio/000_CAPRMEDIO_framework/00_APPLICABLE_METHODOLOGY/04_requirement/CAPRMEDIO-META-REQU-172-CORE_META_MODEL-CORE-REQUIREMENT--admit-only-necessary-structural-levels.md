...
relations:
  replacement_of:
    - CAPRMEDIO-META-REQU-206--layer-extension-rule
  child_of:
...
projection:
  source_carrier_path: ../000_APPLICABLE_MTHD_sources/001_CORE_META_MODEL/04_requirement/CAPRMEDIO-META-REQU-172-CORE_META_MODEL-CORE-REQUIREMENT--admit-only-necessary-structural-levels.md
---
