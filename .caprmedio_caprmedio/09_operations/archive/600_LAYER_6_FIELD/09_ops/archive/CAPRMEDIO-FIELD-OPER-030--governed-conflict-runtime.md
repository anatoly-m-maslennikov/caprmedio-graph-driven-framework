...
- **Intended use:** Support `CAPRMEDIO-GOV-METH-013--immutable-atoms-and-role-aware-conflict-handling`,
  `CAPRMEDIO-GOV-METH-020--priority-profile`, `CAPRMEDIO-REQUIREMENT-GOV-020`,
  `CAPRMEDIO-REQUIREMENT-GOV-026`, `CAPRMEDIO-REQUIREMENT-TOOL-019`,
  `CAPRMEDIO-TEST-CASE-GOV-026`, and `CAPRMEDIO-TEST-CASE-TOOL-019`.
...
| False Conflicts | Source/projection drift, evaluation changes, implementation nonconformance/ownership, evidence adjudication, generated staleness, and inapplicable contexts do not emit Conflict atoms | Pass |
...
usefulness remains owned by the existing Evaluation case and its current
evidence boundary.
