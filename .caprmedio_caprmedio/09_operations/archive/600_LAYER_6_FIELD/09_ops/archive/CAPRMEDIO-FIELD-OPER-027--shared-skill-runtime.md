...
- **Intended use:** Support `CAPRMEDIO-SPEC-SKILLS-REQU-568--shared-skill-runtime`,
  `CAPRMEDIO-TEST-CASE-SKILL-013`, and `CAPRMEDIO-TASK-SKILL-057`.
...
- **Unsupported uses:** this proof does not claim a real authenticated
  Codex/Claude inference, qualitative `CAPRMEDIO-EVALUATION-CASE-SKILL-011`, or successful
...
remain separately owned by `CAPRMEDIO-TASK-SKILL-020` and
`CAPRMEDIO-TASK-TOOL-036`; they are not inferred from these deterministic fixtures.
