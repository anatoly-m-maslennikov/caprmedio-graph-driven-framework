...
child_of = ["CAPRMEDIO-GOV-REQU-393--artifact-creation-strictness"]
version = 1
...
- **Intended use:** Support `CAPRMEDIO-GOV-REQU-393--artifact-creation-strictness`,
  `CAPRMEDIO-TEST-CASE-GOV-035`, and `CAPRMEDIO-TASK-GOV-058`.
...
- **Unsupported uses:** this proof does not claim the independent qualitative
  `CAPRMEDIO-EVALUATION-CASE-GOV-025`, operator acceptance of any proposed promotion, or that a
