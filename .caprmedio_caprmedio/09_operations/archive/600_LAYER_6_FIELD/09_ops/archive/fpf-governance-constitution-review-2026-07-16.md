...
- **Claim:** DSET's governance constitution independently adapts the useful FPF
  ...
  and risk-proportionate evaluation without importing FPF ontology or making FPF
  a live DSET authority.
- **Intended use:** Support `CAPRMEDIO-GOV-METH-012--governance-constitution-and-rule-evaluation` and review the bounded GOV
...
- **Reopen when:** a cited FPF source/revision, DSET Architecture rule,
  governance registry relation, Decision discharge rule, or evaluation boundary
  changes.
...
|---|---|---|
| One canonical authority | Supported | Keep `CAPRMEDIO-RULE-ARCHITECTURE` as the sole dependency-free root instead of creating a sibling authority rule. |
...
| Missing or stale proof | Corrected | Stale evaluation blocks the relying claim or gate and triggers bounded reopening; it does not silently erase valid authority. |
...
declare. The qualitative authority-versus-evaluation eval therefore remains
