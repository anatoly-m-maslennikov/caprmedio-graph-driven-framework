...
- **Intended use:** Support `CAPRMEDIO-SPEC-SKILLS-REQU-567--entry-criteria-skill-chains`,
  `CAPRMEDIO-INVARIANT-SKILL-009`, `CAPRMEDIO-SPEC-SKILLS-EVAL-051--lazy-implementation-preparation`, and
  `CAPRMEDIO-TASK-SKILL-024`.
...
- **Unsupported uses:** this proof does not claim that every host exposes full
  ...
  `CAPRMEDIO-SPEC-SKILLS-EVAL-049--implementation-preparation-modes` has run.
...
The prior `CAPRMEDIO-SPEC-SKILLS-METH-056--expose-every-dset-lifecycle-mode-as-a-public-skill` remains immutable historical authority for
the public 16-skill topology. `CAPRMEDIO-SPEC-SKILLS-REQU-567--entry-criteria-skill-chains` explicitly replaces
