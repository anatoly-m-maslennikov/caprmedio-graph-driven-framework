...
- **Intended use:** Support `CAPRMEDIO-GOV-METH-019--classify-artifact-role-separately-from-semantic-type`,
  `CAPRMEDIO-FIELD-METH-066--use-five-flat-release-lifecycle-artifacts`, `CAPRMEDIO-REQUIREMENT-GOV-029..031`,
  `CAPRMEDIO-REQUIREMENT-OPS-013`, and `CAPRMEDIO-TASK-GOV-051..053`.
...
The qualitative `CAPRMEDIO-GOV-EVAL-011--mece-artifact-classification..021` and `CAPRMEDIO-FIELD-EVAL-058--delivery-artifact-boundaries` runs remain
...
event. `CAPRMEDIO-TASK-GOV-049` remains open for the broader four-Type runtime and
