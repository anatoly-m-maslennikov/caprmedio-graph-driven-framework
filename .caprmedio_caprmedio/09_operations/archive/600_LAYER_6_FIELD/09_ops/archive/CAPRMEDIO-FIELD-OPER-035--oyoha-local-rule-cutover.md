...
evidence for `CAPRMEDIO-SPEC-SKILLS-REQU-568--shared-skill-runtime`; the accepted compatibility Test
mappings remain `CAPRMEDIO-TEST-CASE-SKILL-010` and `CAPRMEDIO-TEST-CASE-GOV-017`.
