...
- **Decision ID:** `CAPRMEDIO-FIELD-METH-063--govern-releases-through-version-targets-and-a-next-minor-roadmap`
- **Status:** accepted
- **Decision date:** 2026-07-20
- **Resolves Question:** `CAPRMEDIO-GOV-CONC-040--should-dset-generate-roadmap-and-release-views`
- **Absorbs:** none
...
- `CAPRMEDIO-RULE-RELEASE` must own these role boundaries and stop when a
