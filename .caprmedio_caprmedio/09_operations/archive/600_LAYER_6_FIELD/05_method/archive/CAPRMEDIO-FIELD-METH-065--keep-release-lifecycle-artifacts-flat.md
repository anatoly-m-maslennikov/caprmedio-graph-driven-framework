...
- **Decision ID:** `CAPRMEDIO-FIELD-METH-065--keep-release-lifecycle-artifacts-flat`
- **Status:** accepted
- **Decision date:** 2026-07-20
- **Absorbs:** `CAPRMEDIO-FIELD-METH-064--use-version-scope-as-the-release-lifecycle-root` in full
